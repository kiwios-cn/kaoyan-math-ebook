const CACHE_VERSION = "20260808-second-derivative-bridge";
...
const SHELL_ASSETS = [
  "./",
  "./index.html",
  "./style.css?v=20260808-second-derivative-bridge",
  "./data.js?v=20260808-second-derivative-bridge",
  "./app.js?v=20260808-second-derivative-bridge",
];

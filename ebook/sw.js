const CACHE_VERSION = "20260805-proof-antiderivative";
...
const SHELL_ASSETS = [
  "./",
  "./index.html",
  "./style.css?v=20260805-proof-antiderivative",
  "./data.js?v=20260805-proof-antiderivative",
  "./app.js?v=20260805-proof-antiderivative",
];

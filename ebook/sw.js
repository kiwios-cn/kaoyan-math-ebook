const CACHE_VERSION = "20260805-higher-order-derivatives";
...
const SHELL_ASSETS = [
  "./",
  "./index.html",
  "./style.css?v=20260805-higher-order-derivatives",
  "./data.js?v=20260805-higher-order-derivatives",
  "./app.js?v=20260805-higher-order-derivatives",
];

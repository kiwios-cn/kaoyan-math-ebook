...
window.BOOK_MANIFEST = {
  ...
  "generatedAt": "2026-08-04T09:27:13+08:00",
  "stats": {
    "documents": 19,
    "pages": 268,
    "renderDpi": 260,
...
window.SEARCH_INDEX = [
  ...
  },
  {
    ...
    "page": 9,
    "heading": "四、连续性与间断点",
    "snippet": "考研数学 · 函数的极限与连续 四、连续性与间断点 1. 连续的定义 函数 𝑓(𝑥) 在 𝑥0 连续，等价于 lim 𝑓(𝑥) = 𝑓(𝑥0 ) 𝑥→𝑥0 也等价于： 1. 𝑓(𝑥0 ) 有定义。 2. lim𝑥→𝑥0 𝑓(𝑥) 存在。 3. 极限值等于函数值。 2. 间断点分类 类型 判断 处理重点 可去间断点 极限存在，但函数值不存在...",
    "text": "Limits and Continuity (函数的极限与连续) Limits and Continuity 函数的极限与连续 微积分 四、连续性与间断点 考研数学 · 函数的极限与连续 四、连续性与间断点 1. 连续的定义 函数 𝑓(𝑥) 在 𝑥0 连续，等价于 lim 𝑓(𝑥) = 𝑓(𝑥0 ) 𝑥→𝑥0 也等价于： 1. 𝑓(𝑥0 ) 有定义。 2. lim𝑥→𝑥0 𝑓(𝑥) 存在。 3. 极限值等于函数值。 2. 间断点分类 类型 判断 处理重点 可去间断点 极限存在，但函数值不存在或不等于极限 补定义使连续 跳跃间断点 左右极限都存在但不相等 分段函数常见 无穷间断点 至少一侧极限为无穷大 检查分母为零处 振荡间断点 极限振荡不存在 如 sin( 𝑥1 ) 类结构 3. 闭区间连续函数性质 若 𝑓(𝑥) 在闭区间 [𝑎, 𝑏] 上连续，则： 1. 有界性：𝑓(𝑥) 在 [𝑎, 𝑏] 上有界。 2. 最值定理：存在最大值和最小值。 3. 介值定理：函数能取到最大值与最小值之间的一切值。 4. 零点定理：若 𝑓(𝑎)𝑓(𝑏) < 0，则存在 𝜉 ∈ (𝑎, 𝑏) 使 𝑓(𝜉) = 0。"
  },
  {

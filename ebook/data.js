...
window.BOOK_MANIFEST = {
  ...
  "generatedAt": "2026-08-04T12:52:02+08:00",
  "stats": {
    "documents": 19,
    "pages": 270,
    "renderDpi": 260,
...
window.SEARCH_INDEX = [
  {
    ...
    "snippet": "考研数学 · 函数的极限与连续 函数的极限与连续 函数极限 · 等价无穷小 · 连续性与间断点 考研数学复习资料 · Typst PDF 复习目标： 函数极限与连续是整个高等数学的入口。考研中常考三件事：会用定义判断极限结构，会用等 价无穷小、洛必达或泰勒展开计算极限，会用连续性处理零点、介值和间断点分类。",
    "text": "Limits and Continuity (函数的极限与连续) Limits and Continuity 函数的极限与连续 微积分 考研数学 · 函数的极限与连续 考研数学 · 函数的极限与连续 函数的极限与连续 函数极限 · 等价无穷小 · 连续性与间断点 考研数学复习资料 · Typst PDF 复习目标： 函数极限与连续是整个高等数学的入口。考研中常考三件事：会用定义判断极限结构，会用等 价无穷小、洛必达或泰勒展开计算极限，会用连续性处理零点、介值和间断点分类。"
  },
  {
  ...
  },
  {
    ...
    "page": 1,
    "heading": "考研数学 · 数列的极限",
    "snippet": "考研数学 · 数列的极限 数列的极限 数列收敛 · 夹逼模型 · 压缩不等式 · 常用极限 考研数学复习资料 · Typst PDF 复习目标： 数列极限的核心是“项数趋于无穷时的稳定值”。考研中常见题型包括代数化简、夹逼定理、单 调有界定理、递推数列求极限，以及把数列极限转化为函数极限。",
    "text": "Sequence Limits (数列的极限) Sequence Limits 数列的极限 微积分 考研数学 · 数列的极限 考研数学 · 数列的极限 数列的极限 数列收敛 · 夹逼模型 · 压缩不等式 · 常用极限 考研数学复习资料 · Typst PDF 复习目标： 数列极限的核心是“项数趋于无穷时的稳定值”。考研中常见题型包括代数化简、夹逼定理、单 调有界定理、递推数列求极限，以及把数列极限转化为函数极限。"
  },
  {
  ...
  },
  {
    ...
    "snippet": "考研数学 · 一元函数微分学的概念和计算 一元函数微分学的概念和计算 导数定义 · 微分 · 求导法则 · 高阶导数 考研数学复习资料 · Typst PDF 复习目标：一元函数微分学的概念部分重在理解“局部线性化”，计算部分重在熟练掌握复合函数、隐函数、 参数方程和高阶导数。考研题常把导数定义、极限和求导法则混合考查。",
    "text": "Differential Calculus Concepts and Computation (一元函数微分学的概念和计算) Differential Calculus Concepts and Computation 一元函数微分学的概念和计算 微积分 考研数学 · 一元函数微分学的概念和计算 考研数学 · 一元函数微分学的概念和计算 一元函数微分学的概念和计算 导数定义 · 微分 · 求导法则 · 高阶导数 考研数学复习资料 · Typst PDF 复习目标：一元函数微分学的概念部分重在理解“局部线性化”，计算部分重在熟练掌握复合函数、隐函数、 参数方程和高阶导数。考研题常把导数定义、极限和求导法则混合考查。"
  },
  {
  ...
  },
  {
    ...
    "snippet": "考研数学 · 一元函数微分学的应用 一元函数微分学的应用 几何应用 · 中值定理 · 等式不等式证明 · 物理应用 考研数学复习资料 · Typst PDF 复习目标： 微分学应用的主线是“用导数描述变化”。几何题看斜率和曲率趋势，证明题看中值定理和辅助 函数，最值题看一阶导数与二阶导数，物理题看瞬时速度、加速度和变化率。",
    "text": "Applications of Differential Calculus (一元函数微分学的应用) Applications of Differential Calculus 一元函数微分学的应用 微积分 考研数学 · 一元函数微分学的应用 考研数学 · 一元函数微分学的应用 一元函数微分学的应用 几何应用 · 中值定理 · 等式不等式证明 · 物理应用 考研数学复习资料 · Typst PDF 复习目标： 微分学应用的主线是“用导数描述变化”。几何题看斜率和曲率趋势，证明题看中值定理和辅助 函数，最值题看一阶导数与二阶导数，物理题看瞬时速度、加速度和变化率。"
  },
  {
  ...
  },
  {
    ...
    "snippet": "考研数学 · 一元函数积分学的概念性质和计算 一元函数积分学的概念性质和计算 不定积分 · 定积分 · 性质 · 换元与分部积分 考研数学复习资料 · Typst PDF 复习目标： 一元积分学的基础是“累加”和“反求导”。不定积分强调原函数，定积分强调区间累积量。考研 中常考换元、分部积分、对称性、积分中值定理和变上限积分函数。",
    "text": "Integral Calculus Concepts Properties and Computation (一元函数积分学的概念性质和计算) Integral Calculus Concepts Properties and Computation 一元函数积分学的概念性质和计算 微积分 考研数学 · 一元函数积分学的概念性质和计算 考研数学 · 一元函数积分学的概念性质和计算 一元函数积分学的概念性质和计算 不定积分 · 定积分 · 性质 · 换元与分部积分 考研数学复习资料 · Typst PDF 复习目标： 一元积分学的基础是“累加”和“反求导”。不定积分强调原函数，定积分强调区间累积量。考研 中常考换元、分部积分、对称性、积分中值定理和变上限积分函数。"
  },
  {
  ...
  },
  {
    ...
    "snippet": "考研数学 · 一元函数积分学的应用 一元函数积分学的应用 几何应用 · 积分等式不等式 · 物理应用 考研数学复习资料 · Typst PDF 复习目标： 积分应用的本质是“把微小量累加起来”。几何应用关注面积、体积、弧长和旋转曲面；证明题 关注对称换元、积分中值定理和估值；物理应用关注变力做功、位移、质量和质心。",
    "text": "Applications of Integral Calculus (一元函数积分学的应用) Applications of Integral Calculus 一元函数积分学的应用 微积分 考研数学 · 一元函数积分学的应用 考研数学 · 一元函数积分学的应用 一元函数积分学的应用 几何应用 · 积分等式不等式 · 物理应用 考研数学复习资料 · Typst PDF 复习目标： 积分应用的本质是“把微小量累加起来”。几何应用关注面积、体积、弧长和旋转曲面；证明题 关注对称换元、积分中值定理和估值；物理应用关注变力做功、位移、质量和质心。"
  },
  {
  ...
  },
  {
    ...
    "snippet": "考研数学 · 多元函数微分学 多元函数微分学 偏导数 · 全微分 · 方向导数 · 极值与拉格朗日乘数 考研数学复习资料 · Typst PDF 复习目标： 多元函数微分学研究多变量函数的局部变化。考研中常见考点包括二元函数极限与连续、偏导 数、全微分、复合函数求导、隐函数求导、方向导数与梯度、无条件极值和条件极值。",
    "text": "Multivariable Differential Calculus (多元函数微分学) Multivariable Differential Calculus 多元函数微分学 微积分 考研数学 · 多元函数微分学 考研数学 · 多元函数微分学 多元函数微分学 偏导数 · 全微分 · 方向导数 · 极值与拉格朗日乘数 考研数学复习资料 · Typst PDF 复习目标： 多元函数微分学研究多变量函数的局部变化。考研中常见考点包括二元函数极限与连续、偏导 数、全微分、复合函数求导、隐函数求导、方向导数与梯度、无条件极值和条件极值。"
  },
  {
  ...
  },
  {
    ...
    "snippet": "考研数学 · 二重积分 二重积分总结讲解 定义 · 积分区域 · 换序 · 极坐标 · 应用题型 考研数学复习资料 · Typst PDF 复习目标： 二重积分的核心不是“算两次定积分”，而是把平面区域 𝐷 看清楚，再选择最方便的坐标和积 分次序。考研常考：积分区域识别、交换积分次序、极坐标变换、利用对称性、面积体积和物理应用。",
    "text": "Double Integral Methods (二重积分计算方法) Double Integral Methods 二重积分计算方法 微积分 定义 · 积分区域 · 换序 · 极坐标 · 应用题型 考研数学 · 二重积分 二重积分总结讲解 定义 · 积分区域 · 换序 · 极坐标 · 应用题型 考研数学复习资料 · Typst PDF 复习目标： 二重积分的核心不是“算两次定积分”，而是把平面区域 𝐷 看清楚，再选择最方便的坐标和积 分次序。考研常考：积分区域识别、交换积分次序、极坐标变换、利用对称性、面积体积和物理应用。"
  },
  {
  ...
  },
  {
    ...
    "snippet": "考研数学 · 三重积分 三重积分计算方法总结 定义 · 公式 · 坐标选择 · 典型例题 考研数学复习资料 · Typst PDF 复习目标： 三重积分的本质是“在空间区域上累加”。考研题通常不难在积分本身，而难在三件事：看清空 间区域、选对坐标系、写对积分限。",
    "text": "Triple Integral Methods (三重积分计算方法) Triple Integral Methods 三重积分计算方法 微积分 定义 · 公式 · 坐标选择 · 典型例题 考研数学 · 三重积分 三重积分计算方法总结 定义 · 公式 · 坐标选择 · 典型例题 考研数学复习资料 · Typst PDF 复习目标： 三重积分的本质是“在空间区域上累加”。考研题通常不难在积分本身，而难在三件事：看清空 间区域、选对坐标系、写对积分限。"
  },
  {
  ...
  },
  {
    ...
    "text": "Multivariable Integral Calculus (多元函数积分学) Multivariable Integral Calculus 多元函数积分学 微积分 考研数学 · 多元函数积分学 考研数学 · 多元函数积分学 多元函数积分学总结 重积分 · 曲线积分 · 曲面积分 · 格林高斯斯托克斯 考研数学复习资料 · Typst PDF 复习目标： 多元函数积分学的主线是“在几何对象上累加”：二重积分在平面区域上累加，三重积分在空间 区域上累加，曲线积分在曲线上累加，曲面积分在曲面上累加。三大公式把边界积分与区域积分联系起来， 是考研中最容易综合考察的部分。"
  },
  {
  ...
  },
  {
    ...
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 考研数学 · 微分方程 考研数学 · 微分方程 微分方程求解总结讲解 常微分方程 · 线性方程 · 齐次非齐次 · 特解通解 考研数学复习资料 · Typst PDF 复习目标：微分方程题的关键不是死记形式，而是先识别类型，再套对应解法。考研常见主线是：一阶方程 的分离变量、齐次方程、一阶线性方程、可降阶高阶方程、二阶线性常系数齐次与非齐次方程，以及特解、 通解和初值条件的关系。"
  },
  {
  ...
  },
  {
    ...
    "page": 1,
    "heading": "考研数学 · 无穷级数",
    "snippet": "考研数学 · 无穷级数 无穷级数专项总结 数项级数 · 判别法 · 幂级数 · 泰勒展开 · 傅里叶级数 考研数学复习资料 · Typst PDF 复习目标： 无穷级数的核心是“看部分和是否有极限”。考研常考两条线：数项级数判断敛散性，幂级数求 收敛半径、收敛域与展开式。做题时先分类，再选判别法，最后单独检查端点和特殊项。",
    "text": "Infinite Series (无穷级数) Infinite Series 无穷级数 微积分 考研数学 · 无穷级数 考研数学 · 无穷级数 无穷级数专项总结 数项级数 · 判别法 · 幂级数 · 泰勒展开 · 傅里叶级数 考研数学复习资料 · Typst PDF 复习目标： 无穷级数的核心是“看部分和是否有极限”。考研常考两条线：数项级数判断敛散性，幂级数求 收敛半径、收敛域与展开式。做题时先分类，再选判别法，最后单独检查端点和特殊项。"
  },
  {
  ...
  },
  {
    ...
    "text": "Determinants (行列式) Determinants 行列式 线性代数 定义 · 性质 · 展开 · 计算 · 应用 考研数学 · Linear Algebra · Determinants (行列式) Determinants (行列式) 定义 · 性质 · 展开 · 计算 · 应用 考研数学复习资料 · Typst PDF 复习目标： 行列式的核心是把矩阵是否可逆、线性方程组是否有唯一解、向量是否线性相关、几何面积体 积以及特征值和二次型判定等问题转化为一个数。复习时先理解有向面积、有向体积和伸缩倍数，再掌握性 质并选择化三角、按行列展开或利用特殊结构计算。"
  },
  {
  ...
  },
  {
    ...
    "text": "Matrices (矩阵) Matrices 矩阵 线性代数 考研数学 · Linear Algebra · Matrices (矩阵) 考研数学 · Linear Algebra · Matrices (矩阵) Matrices (矩阵) 运算 · 逆矩阵 · 初等变换 · 秩 · 分块 考研数学复习资料 · Typst PDF 复习目标：矩阵是线性代数的语言。考研中矩阵章节常用于表达线性方程组、向量组、特征值和二次型。复 习重点是矩阵运算规则、可逆判定、初等变换、矩阵秩、Gram 矩阵和分块矩阵。"
  },
  {
  ...
  },
  {
    ...
    "text": "Vector Groups (向量组) Vector Groups 向量组 线性代数 考研数学 · Linear Algebra · Vector Groups (向量组) 考研数学 · Linear Algebra · Vector Groups (向量组) Vector Groups (向量组) 线性组合 · 相关无关 · 秩 · 极大无关组 · 等价 考研数学复习资料 · Typst PDF 复习目标： 向量组章节把矩阵秩、方程组解的结构和线性空间思想连接起来。考研常考线性表示、线性相 关性、极大线性无关组、向量组秩与等价。"
  },
  {
  ...
  },
  {
    ...
    "text": "Linear Equations (线性方程组) Linear Equations 线性方程组 线性代数 考研数学 · Linear Algebra · Linear Equations (线性方程组) 考研数学 · Linear Algebra · Linear Equations (线性方程组) Linear Equations (线性方程组) 齐次 · 非齐次 · 秩判定 · 解结构 · 参数讨论 考研数学复习资料 · Typst PDF 复习目标： 线性方程组的核心是“有没有解、解是否唯一、通解怎么写”。所有判断都围绕系数矩阵秩、增 广矩阵秩和未知数个数展开。"
  },
  {
  ...
  },
  {
    ...
    "text": "Eigenvalues and Eigenvectors (特征值与特征向量) Eigenvalues and Eigenvectors 特征值与特征向量 线性代数 Eigenvalues and Eigenvectors (特征值与特征向量) 考研数学 · Linear Algebra · Eigenvalues and Eigenvectors (特征值与特征向量) Eigenvalues and Eigenvectors (特征值与特征向量) 特征方程 · 相似 · 对角化 · 实对称矩阵 考研数学复习资料 · Typst PDF 复习目标： 特征值与特征向量描述矩阵在线性变换下保持方向不变的向量，是相似对角化和二次型正交化 的基础。考研重点是求特征值、求特征向量、判断能否对角化以及实对称矩阵性质。"
  },
  {
  ...
  },
  {
    ...
    "text": "Quadratic Forms (二次型) Quadratic Forms 二次型 线性代数 考研数学 · Linear Algebra · Quadratic Forms (二次型) 考研数学 · Linear Algebra · Quadratic Forms (二次型) Quadratic Forms (二次型) 矩阵表示 · 合同变换 · 标准形 · 正定判定 考研数学复习资料 · Typst PDF 复习目标： 二次型是线性代数后半部分的综合章节，主要研究二次齐次多项式如何通过可逆线性变换化为 标准形，以及如何判断正定、负定和惯性指数。"
  },
  {
  ...
  },
  {
    ...
    "snippet": "概率论与数理统计 · 知识总结 概率论与数理统计 核心知识点、公式与解题框架总结 Generated by Codex · Typst Pipeline",
    "text": "Probability and Mathematical Statistics (概率论与数理统计) Probability and Mathematical Statistics 概率论与数理统计 概率论 概率论与数理统计 · 知识总结 概率论与数理统计 · 知识总结 概率论与数理统计 核心知识点、公式与解题框架总结 Generated by Codex · Typst Pipeline"
  },
  {

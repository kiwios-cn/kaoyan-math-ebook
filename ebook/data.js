...
window.BOOK_MANIFEST = {
  ...
  "generatedAt": "2026-08-04T11:46:59+08:00",
  "stats": {
    "documents": 19,
    "pages": 270,
    "renderDpi": 260,
...
window.SEARCH_INDEX = [
  ...
  },
  {
    ...
    "page": 8,
    "heading": "4. 泰勒展开",
    "snippet": "考研数学 · 函数的极限与连续 再对 ln 𝑦 的极限使用代数变形或洛必达。 4. 泰勒展开 当加减结构中主项相消时，泰勒展开最稳。常用展开为： 𝑥2 𝑒𝑥 = 1 + 𝑥 + + 𝑜(𝑥2 ) 2 𝑥2 ln(1 + 𝑥) = 𝑥 − + 𝑜(𝑥2 ) 2 𝑥3 𝑥2 sin 𝑥 = 𝑥 − + 𝑜(𝑥3 ), cos 𝑥 = 1 − ...",
    "text": "Limits and Continuity (函数的极限与连续) Limits and Continuity 函数的极限与连续 微积分 4. 泰勒展开 考研数学 · 函数的极限与连续 再对 ln 𝑦 的极限使用代数变形或洛必达。 4. 泰勒展开 当加减结构中主项相消时，泰勒展开最稳。常用展开为： 𝑥2 𝑒𝑥 = 1 + 𝑥 + + 𝑜(𝑥2 ) 2 𝑥2 ln(1 + 𝑥) = 𝑥 − + 𝑜(𝑥2 ) 2 𝑥3 𝑥2 sin 𝑥 = 𝑥 − + 𝑜(𝑥3 ), cos 𝑥 = 1 − + 𝑜(𝑥2 ) 6 2 5. 变限积分型极限 变限积分型极限的关键，是把积分看成由上限或下限决定的函数，再判断这个函数的主阶。常见形式为 𝑥 ∫ 𝑓(𝑡)𝑑𝑡 𝑎 lim 𝑥→𝑎 𝑔(𝑥) 若分子、分母同趋于 0，且满足洛必达法则条件，则可利用变限积分求导： ′ 𝑥 (∫ 𝑓(𝑡)𝑑𝑡) = 𝑓(𝑥) 𝑎 因此 𝑥 ∫ 𝑓(𝑡)𝑑𝑡 𝑓(𝑥) 𝑎 lim = lim 𝑥→𝑎 𝑔(𝑥) 𝑥→𝑎 𝑔 ′ (𝑥) 例如 𝑥 ∫ sin 𝑡𝑑𝑡 sin 𝑥 1 0 lim = lim = 𝑥→0 𝑥2 𝑥→0 2𝑥 2 等价积分法： 若 𝑡 → 0 时 𝑓(𝑡) ≃ 𝐶𝑡𝑘 ，则 𝑥 𝑥 𝐶 𝑘+1 ∫ 𝑓(𝑡)𝑑𝑡 ≃ ∫ 𝐶𝑡𝑘 𝑑𝑡 = 𝑥 0 0 𝑘+1 也就是说，积分会把被积函数的无穷小阶数提高一阶。 若上下限都是函数，例如 𝛽(𝑥) ∫ 𝑓(𝑡)𝑑𝑡 𝛼(𝑥) 且 𝛼(𝑥) → 𝑎, 𝛽(𝑥) → 𝑎，可令 𝐹 ′ (𝑡) = 𝑓(𝑡)，转化为 𝐹 (𝛽(𝑥)) − 𝐹 (𝛼(𝑥)) 若 𝑓 在 𝑎 连续且 𝑓(𝑎) ≠ 0，则 𝛽(𝑥) ∫ 𝑓(𝑡)𝑑𝑡 ≃ 𝑓(𝑎)(𝛽(𝑥) − 𝛼(𝑥)) 𝛼(𝑥)"
  },
  {
  ...
  },
  {
    ...
    "page": 10,
    "heading": "考研数学 · 函数的极限与连续",
    "snippet": "考研数学 · 函数的极限与连续 1 1 𝑒𝑥𝑡 − 1 1 lim ∫ 𝑑𝑡 = ∫ 𝑡𝑑𝑡 = 𝑥→0 0 𝑥 0 2 第三类：𝑥 同时出现在上下限和被积函数中。 𝛽(𝑥) 𝐼(𝑥) = ∫ 𝑓(𝑥, 𝑡)𝑑𝑡 𝛼(𝑥) 这类题要把“区间变化”和“被积函数变化”分开看。若 𝛼(𝑥) → 𝑎, 𝛽(𝑥) → 𝑎, 𝑓(𝑥, 𝑡) → 𝐿 ...",
    "text": "Limits and Continuity (函数的极限与连续) Limits and Continuity 函数的极限与连续 微积分 考研数学 · 函数的极限与连续 考研数学 · 函数的极限与连续 1 1 𝑒𝑥𝑡 − 1 1 lim ∫ 𝑑𝑡 = ∫ 𝑡𝑑𝑡 = 𝑥→0 0 𝑥 0 2 第三类：𝑥 同时出现在上下限和被积函数中。 𝛽(𝑥) 𝐼(𝑥) = ∫ 𝑓(𝑥, 𝑡)𝑑𝑡 𝛼(𝑥) 这类题要把“区间变化”和“被积函数变化”分开看。若 𝛼(𝑥) → 𝑎, 𝛽(𝑥) → 𝑎, 𝑓(𝑥, 𝑡) → 𝐿 且 𝐿 为有限非零常数，则 𝐼(𝑥) ≃ 𝐿(𝛽(𝑥) − 𝛼(𝑥)) 若 𝐿 = 0，则要对 𝑓(𝑥, 𝑡) 在 (𝑥0 , 𝑎) 附近作联合展开，再对 𝑡 积分。例如 𝑒𝑥𝑡 − 1 ≃ 𝑥𝑡 因此 𝑥 𝑥 𝑥3 ∫ (𝑒𝑥𝑡 − 1)𝑑𝑡 ≃ ∫ 𝑥𝑡𝑑𝑡 = 0 0 2 所以 𝑥 ∫ (𝑒𝑥𝑡 − 1)𝑑𝑡 1 0 lim = 𝑥→0 𝑥3 2 若使用洛必达，需要用含参变量的莱布尼茨公式： 𝛽(𝑥) 𝜕𝑓(𝑥, 𝑡) 𝐼 ′ (𝑥) = 𝑓(𝑥, 𝛽(𝑥))𝛽 ′ (𝑥) − 𝑓(𝑥, 𝛼(𝑥))𝛼′ (𝑥) + ∫ 𝑑𝑡 𝛼(𝑥) 𝜕𝑥 易错点：若 𝑓(𝑎) = 0，不能直接用 𝑓(𝑎)(𝛽 − 𝛼)，因为主项会被压成 0。此时必须展开被积函数，例如 𝑓(𝑡) ≃ 𝐶(𝑡 − 𝑎)𝑘 ，再积分得到高一阶主项。 处理流程： 1. 先判断 𝑥 出现在上下限、被积函数，还是二者同时出现。 2. 只在上下限中：用原函数差、区间长度近似或变限积分求导。 3. 只在被积函数中：区间固定时优先考虑极限进积分；未定式则对被积函数关于 𝑥 展开。 4. 二者同时出现：先看区间是否收缩，再看被积函数主项；必要时用莱布尼茨公式。 5. 被积函数在收缩端点处主项为 0 时，必须继续展开主项。"
  },
  {
    ...
    "text": "Limits and Continuity (函数的极限与连续) Limits and Continuity 函数的极限与连续 微积分 四、连续性与间断点 考研数学 · 函数的极限与连续 四、连续性与间断点 1. 连续的定义 函数 𝑓(𝑥) 在 𝑥0 连续，等价于 lim 𝑓(𝑥) = 𝑓(𝑥0 ) 𝑥→𝑥0 也等价于： 1. 𝑓(𝑥0 ) 有定义。 2. lim𝑥→𝑥0 𝑓(𝑥) 存在。 3. 极限值等于函数值。 2. 间断点分类 判断间断点时，先看 𝑥0 处是否连续；若不连续，再分别考察左极限和右极限： 𝐴 = lim− 𝑓(𝑥), 𝐵 = lim+ 𝑓(𝑥) 𝑥→𝑥0 𝑥→𝑥0 核心分类： 若左右极限 𝐴, 𝐵 都存在且都是有限数，则称为第一类间断点；若左右极限中至少有一个不存 在或为无穷大，则称为第二类间断点。 大类 具体类型 判断 处理重点 第一类 可去间断点 左右极限存在且相等，但函数值不 可通过补定义或改定义使函数连 存在或不等于该极限 续 第一类 跳跃间断点 左右极限都存在且有限，但二者不 分段函数最常见，重点分别算左右 相等 极限 第二类 无穷间断点 至少一侧极限为无穷大 常见于分母趋零、分子不趋零的 结构 第二类 振荡间断点 至少一侧极限振荡不存在 常见于 sin( 𝑥1 )、cos( 𝑥1 ) 类结构 判定流程： 1. 先判断 𝑓(𝑥0 ) 是否有定义，以及左右极限是否存在。 2. 左右极限都存在且有限，归入第一类；再看相等与否，区分可去和跳跃。 3. 只要有一侧极限不存在或发散为无穷大，归入第二类；再区分无穷间断和振荡间断。 4. 题目问“第几类间断点”时，不能只答可去、跳跃、无穷或振荡，还要写明第一类或第二类。 3. 闭区间连续函数性质 若 𝑓(𝑥) 在闭区间 [𝑎, 𝑏] 上连续，则： 1. 有界性：𝑓(𝑥) 在 [𝑎, 𝑏] 上有界。 2. 最值定理：存在最大值和最小值。 3. 介值定理：函数能取到最大值与最小值之间的一切值。 4. 零点定理：若 𝑓(𝑎)𝑓(𝑏) < 0，则存在 𝜉 ∈ (𝑎, 𝑏) 使 𝑓(𝜉) = 0。"
  },
  {
  ...
  },
  {
    ...
    "page": 4,
    "heading": "三、常用数列极限",
    "snippet": "考研数学 · 数列的极限 三、常用数列极限 数列 极限 条件或说明 𝑛 𝑞 0 |𝑞| < 1 1 𝑛𝛼 0 𝛼>0 1 𝑛 𝑛 1 常用对数化证明 1 𝑎 𝑛 1 𝑎>0 𝑛 (1 + 𝑛1 ) 𝑒 自然常数定义之一 𝑛𝑘 𝑎𝑛 0 𝑎 > 1，指数增长快于幂增长 判断增长速度： 当 𝑛 → ∞ 时，一般有 ln 𝑛 ≪ 𝑛𝛼 ≪ 𝑎𝑛...",
    "text": "Sequence Limits (数列的极限) Sequence Limits 数列的极限 微积分 三、常用数列极限 考研数学 · 数列的极限 三、常用数列极限 数列 极限 条件或说明 𝑛 𝑞 0 |𝑞| < 1 1 𝑛𝛼 0 𝛼>0 1 𝑛 𝑛 1 常用对数化证明 1 𝑎 𝑛 1 𝑎>0 𝑛 (1 + 𝑛1 ) 𝑒 自然常数定义之一 𝑛𝑘 𝑎𝑛 0 𝑎 > 1，指数增长快于幂增长 判断增长速度： 当 𝑛 → ∞ 时，一般有 ln 𝑛 ≪ 𝑛𝛼 ≪ 𝑎𝑛 ≪ 𝑛! ≪ 𝑛𝑛 (𝛼 > 0, 𝑎 > 1) 用于判断无穷大或无穷小阶数。"
  },
  {
  ...
  },
  {
    ...
    "page": 4,
    "heading": "三、基本求导公式",
    "snippet": "考研数学 · 一元函数微分学的概念和计算 三、基本求导公式 函数 导数 说明 𝐶 0 常数导数为零 𝛼 𝛼−1 𝑥 𝛼𝑥 幂函数公式 𝑒𝑥 𝑒𝑥 自然指数函数 𝑥 𝑥 𝑎 𝑎 ln 𝑎 𝑎 > 0, 𝑎 ≠ 1 1 ln 𝑥 𝑥 𝑥>0 sin 𝑥 cos 𝑥 三角函数 cos 𝑥 − sin 𝑥 注意负号 tan 𝑥 sec2 𝑥 1 ...",
    "text": "Differential Calculus Concepts and Computation (一元函数微分学的概念和计算) Differential Calculus Concepts and Computation 一元函数微分学的概念和计算 微积分 三、基本求导公式 考研数学 · 一元函数微分学的概念和计算 三、基本求导公式 函数 导数 说明 𝐶 0 常数导数为零 𝛼 𝛼−1 𝑥 𝛼𝑥 幂函数公式 𝑒𝑥 𝑒𝑥 自然指数函数 𝑥 𝑥 𝑎 𝑎 ln 𝑎 𝑎 > 0, 𝑎 ≠ 1 1 ln 𝑥 𝑥 𝑥>0 sin 𝑥 cos 𝑥 三角函数 cos 𝑥 − sin 𝑥 注意负号 tan 𝑥 sec2 𝑥 1 也可写 cos 2𝑥 1 arctan 𝑥 1+𝑥2 反三角函数常用"
  },
  {
  ...
  },
  {
    ...
    "text": "Triple Integral Methods (三重积分计算方法) Triple Integral Methods 三重积分计算方法 微积分 四、球坐标法 考研数学 · 三重积分 四、球坐标法 球坐标适合球、球冠、球锥组合、与原点距离有关的积分。 1. 坐标变换 本资料采用数学中常见约定： 𝑥 = 𝜌 sin 𝜑 cos 𝜃 𝑦 = 𝜌 sin 𝜑 sin 𝜃 𝑧 = 𝜌 cos 𝜑 其中 𝜌 是点到原点的距离，𝜑 是与正 𝑧 轴的夹角，𝜃 是在 𝑥𝑦 平面内的极角。 范围通常为 𝜌 ≥ 0, 0 ≤ 𝜑 ≤ 𝜋, 0 ≤ 𝜃 ≤ 2𝜋 体积元为 𝑑𝑉 = 𝜌2 sin 𝜑𝑑𝜌𝑑𝜑𝑑𝜃 所以 ∭ 𝑓𝑑𝑉 = ∭ 𝑓(𝜌 sin 𝜑 cos 𝜃, 𝜌 sin 𝜑 sin 𝜃, 𝜌 cos 𝜑)𝜌2 sin 𝜑𝑑𝜌𝑑𝜑𝑑𝜃 Ω Ω′ 2. 常见边界翻译 直角坐标边界 球坐标形式 说明 2 2 2 2 𝑥 +𝑦 +𝑧 =𝑎 𝜌=𝑎 球面 𝑧 = √𝑥2 + 𝑦2 𝜑 = 𝜋4 圆锥面 𝑧=0 𝜑 = 𝜋2 𝑥𝑦 平面 2 2 2 2 𝑥 +𝑦 +𝑧 𝜌 径向函数会大幅简化 易错点： 球坐标最容易错的是角度 𝜑 的含义。本资料中 𝜑 从正 𝑧 轴量起，不是从 𝑥𝑦 平面量起。"
  },
  {
  ...
  },
  {
    ...
    "snippet": "考研数学 · 三重积分 易错点： 斯托克斯公式最常错的是方向。曲线方向和曲面法向必须满足右手法则；如果方向相反，结果取 负号。 4. 三个公式的对比 公式 处理对象 转换结果 关键词 格林公式 平面闭曲线积分 二重积分 平面、闭曲线、逆时针、𝑃 𝑑𝑥 + 𝑄𝑑𝑦 高斯公式 闭曲面通量积分 三重积分 闭曲面、外法向、通量、散度 斯 托 克 ...",
    "text": "Triple Integral Methods (三重积分计算方法) Triple Integral Methods 三重积分计算方法 微积分 易错点： 斯托克斯公式最常错的是方向。曲线方向和曲面法向必须满足右手法则；如果方向相反，结果取 考研数学 · 三重积分 易错点： 斯托克斯公式最常错的是方向。曲线方向和曲面法向必须满足右手法则；如果方向相反，结果取 负号。 4. 三个公式的对比 公式 处理对象 转换结果 关键词 格林公式 平面闭曲线积分 二重积分 平面、闭曲线、逆时针、𝑃 𝑑𝑥 + 𝑄𝑑𝑦 高斯公式 闭曲面通量积分 三重积分 闭曲面、外法向、通量、散度 斯 托 克 斯 公 空间闭曲线积分 曲面积分 空间闭曲线、旋度、右手法则 式 5. 典型例题：格林公式 题目 计算 𝐿 为圆 𝑥2 + 𝑦2 = 𝑎2 的逆时针方向时 𝐼 = ∮ −𝑦𝑑𝑥 + 𝑥𝑑𝑦 𝐿 这里 𝑃 = −𝑦, 𝑄 = 𝑥。由格林公式： 𝑄 𝑃 𝐼 = ∬ (𝜕 𝑥 − 𝜕 𝑦)𝑑𝑥𝑑𝑦 𝐷 𝜕 𝜕 而 𝑄 𝑃 𝜕 𝑥 = 1, 𝜕 𝑦 = −1 𝜕 𝜕 所以 𝐼 = ∬ 2𝑑𝑥𝑑𝑦 = 2𝜋𝑎2 𝐷 6. 典型例题：高斯公式 题目 设 Σ 为球面 𝑥2 + 𝑦2 + 𝑧 2 = 𝑎2 的外侧，求 𝐼 = ∯ 𝑥𝑑𝑦𝑑𝑧 + 𝑦𝑑𝑧𝑑𝑥 + 𝑧𝑑𝑥𝑑𝑦 Σ 令 𝑃 = 𝑥, 𝑄 = 𝑦, 𝑅 = 𝑧 ，则 𝑃 𝑄 𝑅 𝜕 𝑥+𝜕 𝑦+𝜕 𝑧 =3 𝜕 𝜕 𝜕 由高斯公式： 𝑎3 𝐼 = ∭ 3𝑑𝑉 = 3 ⋅ 4𝜋 = 4𝜋𝑎3 Ω 3"
  },
  {
  ...
  },
  {
    ...
    "text": "Infinite Series (无穷级数) Infinite Series 无穷级数 微积分 考研数学 · 无穷级数 考研数学 · 无穷级数 1 𝑥 𝑥3 2𝑥5 𝑥7 cot 𝑥 = − − − − +… 𝑥 3 45 945 4725 ∞ 1 (−1)𝑛 22𝑛 𝐵2𝑛 2𝑛−1 cot 𝑥 = +∑ 𝑥 , 0 < |𝑥| < 𝜋 𝑥 𝑛=1 (2𝑛)! 反三角函数： ∞ (2𝑛)! arcsin 𝑥 = ∑ 𝑥2𝑛+1 𝑛=0 4𝑛 (𝑛!)2 (2𝑛 + 1) ∞ 𝑥2𝑛+1 arctan 𝑥 = ∑ (−1)𝑛 𝑛=0 2𝑛 + 1 ∞ 𝜋 (2𝑛)! arccos 𝑥 = −∑ 𝑛 𝑥2𝑛+1 2 𝑛=0 4 (𝑛!)2 (2𝑛 + 1) 函数类型 通项形式 幂函数 (1 + 𝑥)𝛼 = ∑∞ 𝐶 𝑛 𝑥𝑛 𝑛=0 𝛼 𝑒 𝑥 = ∑∞ 𝑛 𝑥 指数函数 𝑛=0 𝑛! ln(1 + 𝑥) = ∑∞ 𝑛 对数函数 𝑛=1 (−1)𝑛−1 𝑥𝑛 ∞ 𝑥 2𝑛+1 正弦函数 sin 𝑥 = ∑𝑛=0 (−1)𝑛 (2𝑛+1)! cos 𝑥 = ∑∞ 2𝑛 𝑥 余弦函数 𝑛=0 (−1)𝑛 (2𝑛)! ∞ (−1)𝑛−1 22𝑛 (22𝑛 −1)𝐵2𝑛 2𝑛−1 正切函数 tan 𝑥 = ∑𝑛=1 (2𝑛)! 𝑥 ∞ (−1)𝑛 𝐸2𝑛 2𝑛 正割函数 sec 𝑥 = ∑𝑛=0 (2𝑛)! 𝑥 (−1)𝑛−1 2(22𝑛−1 −1)𝐵2𝑛 2𝑛−1 余割函数 csc 𝑥 = 𝑥1 + ∑∞ 𝑛=1 (2𝑛)! 𝑥 𝑛 2𝑛 ∞ (−1) 2 𝐵 余切函数 cot 𝑥 = 𝑥1 + ∑𝑛=1 (2𝑛)! 2𝑛 2𝑛−1 𝑥 ∞ (2𝑛)! 反正弦 arcsin 𝑥 = ∑𝑛=0 𝑛(𝑛!)2 𝑥2𝑛+1 4 (2𝑛+1) ∞ 2𝑛+1 反正切 arctan 𝑥 = ∑𝑛=0 (−1)𝑛 𝑥2𝑛+1 易错点： 只记一阶等价不够。若出现 𝑥 − sin 𝑥、tan 𝑥 − 𝑥、ln(1 + 𝑥) − 𝑥 这类低阶抵消结构，必须继续 展开到第一项非零高阶项。 4. 展开函数的常用方法 1. 直接用泰勒公式求导。 2. 从常用展开式替换变量。 3. 通过逐项求导或逐项积分得到新展开式。 4. 先作代数变形，再展开。 例如 1 1 2 = 1+𝑥 1 − (−𝑥2 ) 所以 ∞ 1 = ∑ (−1)𝑛 𝑥2𝑛 , |𝑥| < 1 1 + 𝑥2 𝑛=0"
  },
  {
    ...
    "page": 15,
    "heading": "考研数学 · 无穷级数",
    "snippet": "考研数学 · 无穷级数 逐项积分： ∞ 𝑥2𝑛+1 arctan 𝑥 = ∑ (−1)𝑛 , |𝑥| ≤ 1 𝑛=0 2𝑛 + 1",
    "text": "Infinite Series (无穷级数) Infinite Series 无穷级数 微积分 考研数学 · 无穷级数 考研数学 · 无穷级数 逐项积分： ∞ 𝑥2𝑛+1 arctan 𝑥 = ∑ (−1)𝑛 , |𝑥| ≤ 1 𝑛=0 2𝑛 + 1"
  },
  {
  ...
  },
  {
    ...
    "text": "Determinants (行列式) Determinants 行列式 线性代数 五、常用计算方法 考研数学 · Linear Algebra · Determinants (行列式) 五、常用计算方法 方法 适用场景 关键动作 化三角 一般数字型行列式 用倍加不变制造零，最后乘主对角线 按行列展开 某行或某列零较多 选择零最多的位置展开 提取公因子 一行或一列有公共因子 先提出公共因子，再计算剩余行列式 特殊结构 主对角线、副对角线、分块三角 识别零元素位置，直接套结构结论 拉普拉斯展开 分块零较多或某几行列有规律 按若干行列的子式整体展开 范德蒙德 幂次按列或按行排列 识别差积 ∏𝑖<𝑗 (𝑥𝑗 − 𝑥𝑖 ) 1. 主对角线行列式 若行列式只有主对角线上元素非零，即 𝑎1 0 … 0 0 𝑎2 … 0 𝐷 = det … … … … ( 0 0 … 𝑎𝑛 ) 则按逆序数法看，非零项只能从第 𝑖 行取第 𝑖 列元素。对应排列为 12…𝑛 其逆序数为 0，符号为正。因此 𝐷 = 𝑎1 𝑎2 …𝑎𝑛 上三角或下三角行列式同理。因为除主对角线排列外，其他排列至少会取到非零区域外的零元素，所以非零项 仍只剩主对角线乘积： det(𝐴) = 𝑎11 𝑎22 …𝑎𝑛𝑛 2 1 3 示例 若 𝐴 = (0 −1 4)，则 𝐴 为上三角矩阵， 0 0 5 det(𝐴) = 2 ⋅ (−1) ⋅ 5 = −10 2. 副对角线行列式 若行列式只有副对角线上元素非零： 0 0 … 𝑏1 0 0 … 0 𝐷 = det … … … … (𝑏𝑛 0 … 0 ) 更清楚地说，第 𝑖 行的非零元素在第 𝑛 + 1 − 𝑖 列。唯一可能非零的排列为 𝑛, 𝑛 − 1, …, 2, 1 这个排列的逆序数为 𝑛(𝑛 − 1) 2"
  },
  {
  ...
  },
  {
    ...
    "page": 3,
    "heading": "二、特殊矩阵",
    "snippet": "考研数学 · Linear Algebra · Matrices (矩阵) 二、特殊矩阵 类型 条件 说明 零矩阵 所有元素为零 加法零元 单位矩阵 主对角线为 1，其余为 0 𝐴𝐼 = 𝐼𝐴 = 𝐴 对角矩阵 非主对角线元素为 0 运算和特征值较简单 上三角矩阵 主对角线下方元素为 0 行列式为主对角线乘积 𝑇 对称矩阵 𝐴 =𝐴 二次...",
    "text": "Matrices (矩阵) Matrices 矩阵 线性代数 二、特殊矩阵 考研数学 · Linear Algebra · Matrices (矩阵) 二、特殊矩阵 类型 条件 说明 零矩阵 所有元素为零 加法零元 单位矩阵 主对角线为 1，其余为 0 𝐴𝐼 = 𝐼𝐴 = 𝐴 对角矩阵 非主对角线元素为 0 运算和特征值较简单 上三角矩阵 主对角线下方元素为 0 行列式为主对角线乘积 𝑇 对称矩阵 𝐴 =𝐴 二次型和正交对角化常用 正交矩阵 𝐴𝑇 𝐴 = 𝐼 𝐴−1 = 𝐴𝑇"
  },
  {
  ...
  },
  {
    ...
    "page": 5,
    "heading": "三、常见离散分布",
    "snippet": "概率论与数理统计 · 知识总结 三、常见离散分布 分布 适用场景 分布律 期望与方差 两点分布 一次试验成败 𝑃 (𝑋 = 1) = 𝑝, 𝑃 (𝑋 = 0) = 𝐸(𝑋) = 𝑝, Var(𝑋) = 1−𝑝 𝑝(1 − 𝑝) 𝑘 𝑘 𝑛−𝑘 二项分布 𝑛 次独立重复试验成功 𝑃 (𝑋 = 𝑘) = 𝐶𝑛 𝑝 (1 − 𝑝) 𝐸(𝑋) =...",
    "text": "Probability and Mathematical Statistics (概率论与数理统计) Probability and Mathematical Statistics 概率论与数理统计 概率论 三、常见离散分布 概率论与数理统计 · 知识总结 三、常见离散分布 分布 适用场景 分布律 期望与方差 两点分布 一次试验成败 𝑃 (𝑋 = 1) = 𝑝, 𝑃 (𝑋 = 0) = 𝐸(𝑋) = 𝑝, Var(𝑋) = 1−𝑝 𝑝(1 − 𝑝) 𝑘 𝑘 𝑛−𝑘 二项分布 𝑛 次独立重复试验成功 𝑃 (𝑋 = 𝑘) = 𝐶𝑛 𝑝 (1 − 𝑝) 𝐸(𝑋) = 𝑛𝑝, Var(𝑋) = 次数 𝑛𝑝(1 − 𝑝) −𝜆 泊松分布 稀有事件计数 𝑃 (𝑋 = 𝑘) = 𝜆𝑘 𝑒𝑘! 𝐸(𝑋) = 𝜆, Var(𝑋) = 𝜆 几何分布 首次成功所需试验次数 𝑃 (𝑋 = 𝑘) = (1 − 𝑝) 𝑘−1 𝑝 𝐸(𝑋) = 𝑝1 , Var(𝑋) = 1−𝑝 𝑝2 二项分布写作 𝑋 ~ 𝐵(𝑛, 𝑝)，泊松分布写作 𝑋 ~ 𝑃 (𝜆)。当 𝑛 很大、𝑝 很小且 𝑛𝑝 = 𝜆 适中时，二项分布可 用泊松分布近似： 𝐵(𝑛, 𝑝) ≈ 𝑃 (𝜆), 𝜆 = 𝑛𝑝 判断口诀： 固定次数看成功个数用二项分布；单位时间或区域内的随机次数用泊松分布；问“第一次 成功在第几次”用几何分布。"
  },
  {
  ...
  },
  {
    ...
    "text": "Probability and Mathematical Statistics (概率论与数理统计) Probability and Mathematical Statistics 概率论与数理统计 概率论 八、数理统计基础 概率论与数理统计 · 知识总结 八、数理统计基础 总体、样本与统计量 总体是研究对象的全体，样本是从总体中抽取的观测值。若 𝑋1 , 𝑋2 , …, 𝑋𝑛 独立同分布且与总体分布相同， 则称为简单随机样本。 不含未知参数的样本函数称为统计量，例如样本均值、样本方差： 1 𝑛 |(𝑋) = ∑ 𝑋𝑖 𝑛 𝑖=1 𝑛 1 𝑆2 = ∑ (𝑋𝑖 − |(𝑋))2 𝑛 − 1 𝑖=1 其中分母取 𝑛 − 1 是为了让 𝑆 2 成为总体方差 𝜎2 的无偏估计。 三大抽样分布 分布 构造 典型用途 𝜒2 分布 若 𝑍𝑖 ~ 𝑁 (0, 1) 独立，则 ∑ 𝑍𝑖2 ~ 𝜒2 (𝑛) 总体方差区间估计与检验 𝑍 𝑡 分布 𝑇 = ，其中 𝑍 ~ 𝑁 (0, 1)，𝑌 ~ 𝜒2 (𝑛) 总体方差未知时的均值推断 √𝑌𝑛 独立 𝑌1 𝐹 分布 𝐹 = 𝑛𝑌21 ，其中 𝑌1 , 𝑌2 为独立卡方变量 两个方差比较与方差分析 𝑛2"
  },
  {

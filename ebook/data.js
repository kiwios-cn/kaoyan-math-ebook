...
window.SEARCH_INDEX = [
  {
    ...
    "snippet": "考研数学 · 函数的极限与连续 函数的极限与连续 函数极限 · 等价无穷小 · 连续性与间断点 考研数学复习资料 · Typst PDF 首页速览 𝑥 • 核心公式：lim𝑥→0 sin𝑥 𝑥 = 1，lim𝑥→∞ (1 + 𝑥 1 ) = 𝑒，𝑒𝑥 − 1 ≃ 𝑥，ln(1 + 𝑥) ≃ 𝑥。 • 关键定理：左右极限相等才有极限；连续函...",
    "text": "Limits and Continuity (函数的极限与连续) Limits and Continuity 函数的极限与连续 微积分 考研数学 · 函数的极限与连续 考研数学 · 函数的极限与连续 函数的极限与连续 函数极限 · 等价无穷小 · 连续性与间断点 考研数学复习资料 · Typst PDF 首页速览 𝑥 • 核心公式：lim𝑥→0 sin𝑥 𝑥 = 1，lim𝑥→∞ (1 + 𝑥 1 ) = 𝑒，𝑒𝑥 − 1 ≃ 𝑥，ln(1 + 𝑥) ≃ 𝑥。 • 关键定理：左右极限相等才有极限；连续函数满足零点定理、介值定理；间断点分第一类与第二类。 • 方法抓手：先判型，再在等价无穷小、洛必达、泰勒展开、变限积分求导之间选择；加减相消时优先保留高阶项。 复习目标： 函数极限与连续是整个高等数学的入口。考研中常考三件事：会用定义判断极限结构，会用等 价无穷小、洛必达或泰勒展开计算极限，会用连续性处理零点、介值和间断点分类。"
  },
  {
    ...
    "page": 2,
    "heading": "一、函数极限的基本概念",
    "snippet": "考研数学 · 函数的极限与连续 一、函数极限的基本概念 1. 极限的含义 设函数 𝑓(𝑥) 在 𝑥0 的某去心邻域内有定义。如果当 𝑥 无限接近 𝑥0 时，𝑓(𝑥) 无限接近常数 𝐴，则称 lim 𝑓(𝑥) = 𝐴 𝑥→𝑥0 这里要求 𝑥 接近 𝑥0 ，但不要求 𝑥 = 𝑥0 。因此函数在 𝑥0 是否有定义、函数值是否等于 𝐴，并不直接决...",
    "text": "Limits and Continuity (函数的极限与连续) Limits and Continuity 函数的极限与连续 微积分 一、函数极限的基本概念 考研数学 · 函数的极限与连续 一、函数极限的基本概念 1. 极限的含义 设函数 𝑓(𝑥) 在 𝑥0 的某去心邻域内有定义。如果当 𝑥 无限接近 𝑥0 时，𝑓(𝑥) 无限接近常数 𝐴，则称 lim 𝑓(𝑥) = 𝐴 𝑥→𝑥0 这里要求 𝑥 接近 𝑥0 ，但不要求 𝑥 = 𝑥0 。因此函数在 𝑥0 是否有定义、函数值是否等于 𝐴，并不直接决定极限 是否存在。 2. 左右极限 函数在一点的极限存在，当且仅当左极限和右极限都存在且相等： lim 𝑓(𝑥) = lim+ 𝑓(𝑥) = 𝐴 𝑥→𝑥− 0 𝑥→𝑥0 若左右极限不相等，则 lim𝑥→𝑥0 𝑓(𝑥) 不存在。 易错点： 分段函数、含 |𝑥| 的函数和含取整函数的题，第一反应应当是分别考察左右极限。 3. 无穷小与无穷大 若 lim 𝑓(𝑥) = 0 则称 𝑓(𝑥) 是该过程下的无穷小。若 lim|𝑓(𝑥)| = ∞ 则称 𝑓(𝑥) 是该过程下的无穷大。无穷小的阶数比较常用： 关系 定义 含义 𝑓 = 𝑜(𝑔) 𝑓 高阶无穷小 𝑔 → 0，𝑓 比 𝑔 小得多 𝑓 同阶无穷小 𝑔 →𝑐 ≠0 二者衰减速度同阶 𝑓 ≃𝑔 𝑓 等价无穷小 𝑔 → 1，可在乘除结构中替换"
  },
  {
  ...
  },
  {
    ...
    "snippet": "考研数学 · 函数的极限与连续 变量指数中乱替换 把 𝐴(𝑥)𝐵(𝑥) 的底数 𝐴(𝑥) 替成等价量 1∞ 型先取对数，求 𝐵(𝑥) ln 𝐴(𝑥) 的极限。 后直接求值。 2 (2𝑥)2 忽略常数因子 把 1 − cos 2𝑥 写成 𝑥2 。 先代入内层：1 − cos 2𝑥 ≃ 2 = 2𝑥2 。 √ √ 忽略高阶项 在 1 + 2𝑥...",
    "text": "Limits and Continuity (函数的极限与连续) Limits and Continuity 函数的极限与连续 微积分 易错点： 最常见的错误不是“不会背等价无穷小”，而是没有判断表达式结构。先看它在乘除中，还是在加 考研数学 · 函数的极限与连续 变量指数中乱替换 把 𝐴(𝑥)𝐵(𝑥) 的底数 𝐴(𝑥) 替成等价量 1∞ 型先取对数，求 𝐵(𝑥) ln 𝐴(𝑥) 的极限。 后直接求值。 2 (2𝑥)2 忽略常数因子 把 1 − cos 2𝑥 写成 𝑥2 。 先代入内层：1 − cos 2𝑥 ≃ 2 = 2𝑥2 。 √ √ 忽略高阶项 在 1 + 2𝑥 − 3 1 + 3𝑥 中只展开到一 若一阶相消，继续展开到二阶或三阶。 阶。 小 𝑜 关系误推 由 𝑓 = 𝑜(𝑔) 误推出 𝑓 = 𝑜(𝑔2 )。 𝑓 = 𝑜(𝑔) 只说明 𝑓𝑔 → 0，不能自动比较 𝑓 与 𝑔2 。 易错点： 最常见的错误不是“不会背等价无穷小”，而是没有判断表达式结构。先看它在乘除中，还是在加 减中；再看加减中的最低阶主项是否相消。"
  },
  {
    ...
    "page": 7,
    "heading": "三、极限计算方法",
    "snippet": "考研数学 · 函数的极限与连续 三、极限计算方法 1. 直接代入与代数变形 若函数在代入点连续，直接代入即可。若出现 00 、∞ ∞ 、0 ⋅ ∞ 等未定式，应先通过通分、有理化、提取主因子等 方法化简。 2. 等价无穷小替换 当极限过程明确且表达式为乘除结构时，可把复杂函数替换为等价无穷小。例如 sin 3𝑥 3𝑥 3 lim = li...",
    "text": "Limits and Continuity (函数的极限与连续) Limits and Continuity 函数的极限与连续 微积分 三、极限计算方法 考研数学 · 函数的极限与连续 三、极限计算方法 1. 直接代入与代数变形 若函数在代入点连续，直接代入即可。若出现 00 、∞ ∞ 、0 ⋅ ∞ 等未定式，应先通过通分、有理化、提取主因子等 方法化简。 2. 等价无穷小替换 当极限过程明确且表达式为乘除结构时，可把复杂函数替换为等价无穷小。例如 sin 3𝑥 3𝑥 3 lim = lim = 𝑥→0 ln(1 + 2𝑥) 𝑥→0 2𝑥 2 3. 洛必达法则 若极限是 00 或 ∞ ∞ 型，且分子分母满足可导条件，可以使用洛必达法则： 𝑓(𝑥) 𝑓 ′ (𝑥) lim = lim ′ 𝑥→𝑎 𝑔(𝑥) 𝑥→𝑎 𝑔 (𝑥) 前提是右端极限存在或为无穷大。 使用洛必达必须满足的条件： 𝑓(𝑥) 1. 原式必须先化成商的形式 𝑔(𝑥) 。 2. 极限类型必须是 00 或 ∞ ∞ 型，即 𝑓(𝑥), 𝑔(𝑥) 同趋于 0，或二者的绝对值同趋于无穷大。 3. 在去心邻域内，𝑓(𝑥) 与 𝑔(𝑥) 可导，且 𝑔′ (𝑥) ≠ 0。若是单侧极限，就只要求对应单侧邻域满足。 𝑓 ′ (𝑥) 4. 导数商 lim𝑥→𝑎 𝑔′ (𝑥) 必须存在，或为 +∞、−∞。此时原极限才等于导数商极限。 检查项 要求 常见错误 𝑓(𝑥) 形式 必须是分式 𝑔(𝑥) 0 ⋅ ∞、∞ − ∞、1∞ 等不能直接套，要 先变形成商或取对数 未定型 只能直接用于 00 、 ∞ ∞ 0 ∞ ∞ 、 0 、常数除以 0 不是洛必达对象 可导性 去心邻域内分子分母可导，且 𝑔′ (𝑥) ≠ 0 只看代入点可导不够；端点处常要用单 侧条件 ′ 导数商 lim𝑥→𝑎 𝑓𝑔′ (𝑥) (𝑥) 存在或为无穷大 导数商不存在时，不能反推原极限不存 在 易错点： 连续使用洛必达时，每用一次都要重新检查新分式是否仍为 00 或 ∞ ∞ 型。若中途已经不是未定式， 就应停止，不能机械地一直求导。 其他未定式通常先转化： 𝑓(𝑥) 𝑔(𝑥) 0⋅∞→ 1 或 1 𝑔(𝑥) 𝑓(𝑥) ∞ − ∞ → 通分、有理化或提取主项 1∞ , 00 , ∞0 → 先取对数，转为乘积型极限 例如 𝑦 = 𝑢(𝑥)𝑣(𝑥) ，可先取"
  },
  {
    ...
    "page": 8,
    "heading": "4. 泰勒展开",
    "snippet": "考研数学 · 函数的极限与连续 ln 𝑦 = 𝑣(𝑥) ln 𝑢(𝑥) 再对 ln 𝑦 的极限使用代数变形或洛必达。 4. 泰勒展开 当加减结构中主项相消时，泰勒展开最稳。常用展开为： 𝑥2 𝑒𝑥 = 1 + 𝑥 + + 𝑜(𝑥2 ) 2 𝑥2 ln(1 + 𝑥) = 𝑥 − + 𝑜(𝑥2 ) 2 𝑥3 𝑥2 sin 𝑥 = 𝑥 − + ...",
    "text": "Limits and Continuity (函数的极限与连续) Limits and Continuity 函数的极限与连续 微积分 4. 泰勒展开 考研数学 · 函数的极限与连续 ln 𝑦 = 𝑣(𝑥) ln 𝑢(𝑥) 再对 ln 𝑦 的极限使用代数变形或洛必达。 4. 泰勒展开 当加减结构中主项相消时，泰勒展开最稳。常用展开为： 𝑥2 𝑒𝑥 = 1 + 𝑥 + + 𝑜(𝑥2 ) 2 𝑥2 ln(1 + 𝑥) = 𝑥 − + 𝑜(𝑥2 ) 2 𝑥3 𝑥2 sin 𝑥 = 𝑥 − + 𝑜(𝑥3 ), cos 𝑥 = 1 − + 𝑜(𝑥2 ) 6 2 5. 变限积分型极限 变限积分型极限的关键，是把积分看成由上限或下限决定的函数，再判断这个函数的主阶。常见形式为 𝑥 ∫ 𝑓(𝑡)𝑑𝑡 𝑎 lim 𝑥→𝑎 𝑔(𝑥) 若分子、分母同趋于 0，且满足洛必达法则条件，则可利用变限积分求导： ′ 𝑥 (∫ 𝑓(𝑡)𝑑𝑡) = 𝑓(𝑥) 𝑎 因此 𝑥 ∫ 𝑓(𝑡)𝑑𝑡 𝑓(𝑥) 𝑎 lim = lim 𝑥→𝑎 𝑔(𝑥) 𝑥→𝑎 𝑔 ′ (𝑥) 例如 𝑥 ∫ sin 𝑡𝑑𝑡 sin 𝑥 1 0 lim = lim = 𝑥→0 𝑥2 𝑥→0 2𝑥 2 等价积分法： 若 𝑡 → 0 时 𝑓(𝑡) ≃ 𝐶𝑡𝑘 ，则 𝑥 𝑥 𝐶 𝑘+1 ∫ 𝑓(𝑡)𝑑𝑡 ≃ ∫ 𝐶𝑡𝑘 𝑑𝑡 = 𝑥 0 0 𝑘+1 也就是说，积分会把被积函数的无穷小阶数提高一阶。 若上下限都是函数，例如 𝛽(𝑥) ∫ 𝑓(𝑡)𝑑𝑡 𝛼(𝑥) 且 𝛼(𝑥) → 𝑎, 𝛽(𝑥) → 𝑎，可令 𝐹 ′ (𝑡) = 𝑓(𝑡)，转化为 𝐹 (𝛽(𝑥)) − 𝐹 (𝛼(𝑥)) 若 𝑓 在 𝑎 连续且 𝑓(𝑎) ≠ 0，则"
  },
  {
    ...
    "category": "微积分",
    "page": 9,
    "heading": "6. 变限积分中 𝑥 出现位置的分类处理",
    "snippet": "考研数学 · 函数的极限与连续 𝛽(𝑥) ∫ 𝑓(𝑡)𝑑𝑡 ≃ 𝑓(𝑎)(𝛽(𝑥) − 𝛼(𝑥)) 𝛼(𝑥) 例如 𝑥 2 ∫ 𝑒𝑡 𝑑𝑡 sin 𝑥 lim =1 𝑥→0 𝑥 − sin 𝑥 2 因为 sin 𝑥 → 0, 𝑥 → 0，且 𝑒𝑡 → 1，所以积分主项就是区间长度 𝑥 − sin 𝑥。 6. 变限积分中 𝑥 出现位置的分类...",
    "text": "Limits and Continuity (函数的极限与连续) Limits and Continuity 函数的极限与连续 微积分 6. 变限积分中 𝑥 出现位置的分类处理 考研数学 · 函数的极限与连续 𝛽(𝑥) ∫ 𝑓(𝑡)𝑑𝑡 ≃ 𝑓(𝑎)(𝛽(𝑥) − 𝛼(𝑥)) 𝛼(𝑥) 例如 𝑥 2 ∫ 𝑒𝑡 𝑑𝑡 sin 𝑥 lim =1 𝑥→0 𝑥 − sin 𝑥 2 因为 sin 𝑥 → 0, 𝑥 → 0，且 𝑒𝑡 → 1，所以积分主项就是区间长度 𝑥 − sin 𝑥。 6. 变限积分中 𝑥 出现位置的分类处理 求极限时，先看 𝑥 出现在积分的哪一部分。常见有三类： 情形 典型形式 核心处理方法 𝛽(𝑥) 只在上下限中 ∫ 𝑓(𝑡)𝑑𝑡 用原函数差 𝐹 (𝛽(𝑥)) − 𝐹 (𝛼(𝑥))，或对变限积 𝛼(𝑥) 分求导；若上下限趋于同一点，优先用区间长 度近似。 𝑏 只在被积函数中 ∫ 𝑓(𝑥, 𝑡)𝑑𝑡 积分区间固定时，先考虑把极限移入积分；若 𝑎 是未定式，则对 𝑓(𝑥, 𝑡) 关于 𝑥 展开，再逐项 积分。 𝛽(𝑥) 上下限和被积函数中 ∫ 𝑓(𝑥, 𝑡)𝑑𝑡 先看区间是否收缩，再看被积函数主项；必要 𝛼(𝑥) 都有 时使用含参变量积分求导公式。 第一类：𝑥 只在上下限中。 𝛽(𝑥) 𝐼(𝑥) = ∫ 𝑓(𝑡)𝑑𝑡 𝛼(𝑥) 若 𝛼(𝑥) → 𝑎, 𝛽(𝑥) → 𝑎，且 𝑓 在 𝑎 连续，则 𝐼(𝑥) ≃ 𝑓(𝑎)(𝛽(𝑥) − 𝛼(𝑥)) 若 𝑓(𝑎) = 0，需要继续展开。若 𝑓(𝑡) ≃ 𝐶(𝑡 − 𝑎)𝑘 ，则 𝐶 𝐼(𝑥) ≃ [(𝛽(𝑥) − 𝑎)𝑘+1 − (𝛼(𝑥) − 𝑎)𝑘+1 ] 𝑘+1 若放在分式极限中，也可以用洛必达。此时 𝐼 ′ (𝑥) = 𝑓(𝛽(𝑥))𝛽 ′ (𝑥) − 𝑓(𝛼(𝑥))𝛼′ (𝑥) 第二类：𝑥 只在被积函数中。 𝑏 𝐼(𝑥) = ∫ 𝑓(𝑥, 𝑡)𝑑𝑡 𝑎 若 𝑓(𝑥, 𝑡) 在 𝑥 → 𝑥0 时足够连续，且积分区间固定，则通常可以先取极限再积分： 𝑏 𝑏 lim ∫ 𝑓(𝑥, 𝑡)𝑑𝑡 = ∫ lim 𝑓(𝑥, 𝑡)𝑑𝑡 𝑥→𝑥0 𝑥→𝑥0 𝑎 𝑎 若出现 00 型结构，常把被积函数按 𝑥 展开。例如"
  },
  {
    "id": "doc-881c0cac3960-p10",
    "docId": "doc-881c0cac3960",
    "title": "Limits and Continuity (函数的极限与连续)",
    "category": "微积分",
    "page": 10,
    "heading": "考研数学 · 函数的极限与连续",
    "snippet": "考研数学 · 函数的极限与连续 𝑒𝑥𝑡 − 1 𝑥𝑡2 =𝑡+ + 𝑜(𝑥) 𝑥 2 所以 1 1 𝑒𝑥𝑡 − 1 1 lim ∫ 𝑑𝑡 = ∫ 𝑡𝑑𝑡 = 𝑥→0 0 𝑥 0 2 第三类：𝑥 同时出现在上下限和被积函数中。 𝛽(𝑥) 𝐼(𝑥) = ∫ 𝑓(𝑥, 𝑡)𝑑𝑡 𝛼(𝑥) 这类题要把“区间变化”和“被积函数变化”分开看。若 𝛼(...",
    "text": "Limits and Continuity (函数的极限与连续) Limits and Continuity 函数的极限与连续 微积分 考研数学 · 函数的极限与连续 考研数学 · 函数的极限与连续 𝑒𝑥𝑡 − 1 𝑥𝑡2 =𝑡+ + 𝑜(𝑥) 𝑥 2 所以 1 1 𝑒𝑥𝑡 − 1 1 lim ∫ 𝑑𝑡 = ∫ 𝑡𝑑𝑡 = 𝑥→0 0 𝑥 0 2 第三类：𝑥 同时出现在上下限和被积函数中。 𝛽(𝑥) 𝐼(𝑥) = ∫ 𝑓(𝑥, 𝑡)𝑑𝑡 𝛼(𝑥) 这类题要把“区间变化”和“被积函数变化”分开看。若 𝛼(𝑥) → 𝑎, 𝛽(𝑥) → 𝑎, 𝑓(𝑥, 𝑡) → 𝐿 且 𝐿 为有限非零常数，则 𝐼(𝑥) ≃ 𝐿(𝛽(𝑥) − 𝛼(𝑥)) 若 𝐿 = 0，则要对 𝑓(𝑥, 𝑡) 在 (𝑥0 , 𝑎) 附近作联合展开，再对 𝑡 积分。例如 𝑒𝑥𝑡 − 1 ≃ 𝑥𝑡 因此 𝑥 𝑥 𝑥3 ∫ (𝑒𝑥𝑡 − 1)𝑑𝑡 ≃ ∫ 𝑥𝑡𝑑𝑡 = 0 0 2 所以 𝑥 ∫ (𝑒𝑥𝑡 − 1)𝑑𝑡 1 0 lim = 𝑥→0 𝑥3 2 若使用洛必达，需要用含参变量的莱布尼茨公式： 𝛽(𝑥) 𝜕𝑓(𝑥, 𝑡) 𝐼 ′ (𝑥) = 𝑓(𝑥, 𝛽(𝑥))𝛽 ′ (𝑥) − 𝑓(𝑥, 𝛼(𝑥))𝛼′ (𝑥) + ∫ 𝑑𝑡 𝛼(𝑥) 𝜕𝑥 易错点：若 𝑓(𝑎) = 0，不能直接用 𝑓(𝑎)(𝛽 − 𝛼)，因为主项会被压成 0。此时必须展开被积函数，例如 𝑓(𝑡) ≃ 𝐶(𝑡 − 𝑎)𝑘 ，再积分得到高一阶主项。 处理流程： 1. 先判断 𝑥 出现在上下限、被积函数，还是二者同时出现。 2. 只在上下限中：用原函数差、区间长度近似或变限积分求导。 3. 只在被积函数中：区间固定时优先考虑极限进积分；未定式则对被积函数关于 𝑥 展开。 4. 二者同时出现：先看区间是否收缩，再看被积函数主项；必要时用莱布尼茨公式。 5. 被积函数在收缩端点处主项为 0 时，必须继续展开主项。"
  },
  {
    "id": "doc-881c0cac3960-p11",
    "docId": "doc-881c0cac3960",
    "title": "Limits and Continuity (函数的极限与连续)",
    "category": "微积分",
    "page": 11,
    "heading": "四、连续性与间断点",
    "snippet": "考研数学 · 函数的极限与连续 四、连续性与间断点 1. 连续的定义 函数 𝑓(𝑥) 在 𝑥0 连续，等价于 lim 𝑓(𝑥) = 𝑓(𝑥0 ) 𝑥→𝑥0 也等价于： 1. 𝑓(𝑥0 ) 有定义。 2. lim𝑥→𝑥0 𝑓(𝑥) 存在。 3. 极限值等于函数值。 2. 间断点分类 判断间断点时，先看 𝑥0 处是否连续；若不连续，再分别考察...",
    "text": "Limits and Continuity (函数的极限与连续) Limits and Continuity 函数的极限与连续 微积分 四、连续性与间断点 考研数学 · 函数的极限与连续 四、连续性与间断点 1. 连续的定义 函数 𝑓(𝑥) 在 𝑥0 连续，等价于 lim 𝑓(𝑥) = 𝑓(𝑥0 ) 𝑥→𝑥0 也等价于： 1. 𝑓(𝑥0 ) 有定义。 2. lim𝑥→𝑥0 𝑓(𝑥) 存在。 3. 极限值等于函数值。 2. 间断点分类 判断间断点时，先看 𝑥0 处是否连续；若不连续，再分别考察左极限和右极限： 𝐴 = lim− 𝑓(𝑥), 𝐵 = lim+ 𝑓(𝑥) 𝑥→𝑥0 𝑥→𝑥0 核心分类： 若左右极限 𝐴, 𝐵 都存在且都是有限数，则称为第一类间断点；若左右极限中至少有一个不存 在或为无穷大，则称为第二类间断点。 大类 具体类型 判断 处理重点 第一类 可去间断点 左右极限存在且相等，但函数值 可通过补定义或改定义使函数连 不存在或不等于该极限 续 第一类 跳跃间断点 左右极限都存在且有限，但二者 分段函数最常见，重点分别算左 不相等 右极限 第二类 无穷间断点 至少一侧极限为无穷大 常见于分母趋零、分子不趋零的 结构 第二类 振荡间断点 至少一侧极限振荡不存在 常见于 sin( 𝑥1 )、cos( 𝑥1 ) 类结构 判定流程： 1. 先判断 𝑓(𝑥0 ) 是否有定义，以及左右极限是否存在。 2. 左右极限都存在且有限，归入第一类；再看相等与否，区分可去和跳跃。 3. 只要有一侧极限不存在或发散为无穷大，归入第二类；再区分无穷间断和振荡间断。 4. 题目问“第几类间断点”时，不能只答可去、跳跃、无穷或振荡，还要写明第一类或第二类。 3. 闭区间连续函数性质 若 𝑓(𝑥) 在闭区间 [𝑎, 𝑏] 上连续，则： 1. 有界性：𝑓(𝑥) 在 [𝑎, 𝑏] 上有界。 2. 最值定理：存在最大值和最小值。 3. 介值定理：函数能取到最大值与最小值之间的一切值。 4. 零点定理：若 𝑓(𝑎)𝑓(𝑏) < 0，则存在 𝜉 ∈ (𝑎, 𝑏) 使 𝑓(𝜉) = 0。"
  },
  {
    "id": "doc-881c0cac3960-p12",
    "docId": "doc-881c0cac3960",
    "title": "Limits and Continuity (函数的极限与连续)",
    "category": "微积分",
    "page": 12,
    "heading": "五、典型例题",
    "snippet": "考研数学 · 函数的极限与连续 五、典型例题 例题 1：有理化求极限 √ √ 1+𝑥− 1−𝑥 题目 求 lim𝑥→0 𝑥 。 有理化： √ √ 1+𝑥− 1−𝑥 (1 + 𝑥) − (1 − 𝑥) = √ √ 𝑥 𝑥( 1 + 𝑥 + 1 − 𝑥) 2 =√ √ 1+𝑥+ 1−𝑥 所以 √ √ 1+𝑥− 1−𝑥 2 lim = =1 𝑥...",
    "text": "Limits and Continuity (函数的极限与连续) Limits and Continuity 函数的极限与连续 微积分 五、典型例题 考研数学 · 函数的极限与连续 五、典型例题 例题 1：有理化求极限 √ √ 1+𝑥− 1−𝑥 题目 求 lim𝑥→0 𝑥 。 有理化： √ √ 1+𝑥− 1−𝑥 (1 + 𝑥) − (1 − 𝑥) = √ √ 𝑥 𝑥( 1 + 𝑥 + 1 − 𝑥) 2 =√ √ 1+𝑥+ 1−𝑥 所以 √ √ 1+𝑥− 1−𝑥 2 lim = =1 𝑥→0 𝑥 1+1 例题 2：连续性确定参数 题目 设 𝑎𝑥 ( 𝑒 −1 , 𝑥 ≠ 0) 𝑓(𝑥) = { 𝑥 (2, 𝑥 = 0) 求使 𝑓(𝑥) 在 𝑥 = 0 连续的 𝑎。 连续要求 𝑒𝑎𝑥 − 1 lim =2 𝑥→0 𝑥 由 𝑒𝑎𝑥 − 1 ≃ 𝑎𝑥，得极限为 𝑎。因此 𝑎=2 例题 3：零点定理 题目 证明方程 𝑥3 + 𝑥 − 1 = 0 在 (0, 1) 内至少有一个实根。 令 𝑓(𝑥) = 𝑥3 + 𝑥 − 1，则 𝑓(𝑥) 在 [0, 1] 上连续，且 𝑓(0) = −1 < 0, 𝑓(1) = 1 > 0 由零点定理，存在 𝜉 ∈ (0, 1)，使 𝑓(𝜉) = 0 故方程在 (0, 1) 内至少有一个实根。"
  },
  {
    ...
    "page": 1,
    "heading": "考研数学 · 数列的极限",
    "snippet": "考研数学 · 数列的极限 数列的极限 数列收敛 · 夹逼模型 · 压缩不等式 · 常用极限 考研数学复习资料 · Typst PDF 首页速览 𝑛𝑎 √ • 核心公式：lim𝑛→∞ (1 + 𝑛 ) = 𝑒𝑎 ，lim𝑛→∞ 𝑛( 𝑛 𝑥 − 1) = ln 𝑥。 • 关键定理：单调有界必收敛；夹逼定理；若递推极限存在，常由不动点方程 𝐴...",
    "text": "Sequence Limits (数列的极限) Sequence Limits 数列的极限 微积分 考研数学 · 数列的极限 考研数学 · 数列的极限 数列的极限 数列收敛 · 夹逼模型 · 压缩不等式 · 常用极限 考研数学复习资料 · Typst PDF 首页速览 𝑛𝑎 √ • 核心公式：lim𝑛→∞ (1 + 𝑛 ) = 𝑒𝑎 ，lim𝑛→∞ 𝑛( 𝑛 𝑥 − 1) = ln 𝑥。 • 关键定理：单调有界必收敛；夹逼定理；若递推极限存在，常由不动点方程 𝐴 = 𝑓(𝐴) 确定。 • 方法抓手：先看单调有界、夹逼、递推压缩，再考虑 Stolz 定理、取对数和转化为函数极限。 复习目标： 数列极限的核心是“项数趋于无穷时的稳定值”。考研中常见题型包括代数化简、夹逼定理、单 调有界定理、递推数列求极限，以及把数列极限转化为函数极限。"
  },
  {
    ...
    "page": 2,
    "heading": "一、数列极限的定义",
    "snippet": "考研数学 · 数列的极限 一、数列极限的定义 1. 收敛定义 若数列 {𝑎𝑛 } 满足：对任意给定的 𝜀 > 0，总存在正整数 𝑁 ，当 𝑛 > 𝑁 时， |𝑎𝑛 − 𝐴| < 𝜀 则称数列 {𝑎𝑛 } 收敛于 𝐴，记作 lim 𝑎𝑛 = 𝐴 𝑛→∞ 直观理解：从某一项以后，所有项都能落入 𝐴 的任意小邻域内。 2. 收敛数列的基本性质 ...",
    "text": "Sequence Limits (数列的极限) Sequence Limits 数列的极限 微积分 一、数列极限的定义 考研数学 · 数列的极限 一、数列极限的定义 1. 收敛定义 若数列 {𝑎𝑛 } 满足：对任意给定的 𝜀 > 0，总存在正整数 𝑁 ，当 𝑛 > 𝑁 时， |𝑎𝑛 − 𝐴| < 𝜀 则称数列 {𝑎𝑛 } 收敛于 𝐴，记作 lim 𝑎𝑛 = 𝐴 𝑛→∞ 直观理解：从某一项以后，所有项都能落入 𝐴 的任意小邻域内。 2. 收敛数列的基本性质 1. 极限唯一。 2. 收敛数列必有界。 3. 若 lim 𝑎𝑛 = 𝐴，则任意子列也收敛于 𝐴。 4. 若 𝑎𝑛 ≤ 𝑏𝑛 ≤ 𝑐𝑛 ，且 lim 𝑎𝑛 = lim 𝑐𝑛 = 𝐴，则 lim 𝑏𝑛 = 𝐴。 易错点： 有界不一定收敛。例如 𝑎𝑛 = (−1)𝑛 有界，但不收敛。单调加有界才保证收敛。"
  },
  {
    ...
    "page": 3,
    "heading": "二、极限运算法则",
    "snippet": "考研数学 · 数列的极限 二、极限运算法则 若 lim 𝑎𝑛 = 𝐴, lim 𝑏𝑛 = 𝐵 则 lim(𝑎𝑛 + 𝑏𝑛 ) = 𝐴 + 𝐵 lim(𝑎𝑛 𝑏𝑛 ) = 𝐴𝐵 若 𝐵 ≠ 0，则 𝑎𝑛 𝐴 lim = 𝑏𝑛 𝐵 若 𝑎𝑛 ≤ 𝑏𝑛 且二者极限存在，则 𝐴≤𝐵 注意：不等式取极限后通常只能保留非严格不等号。",
    "text": "Sequence Limits (数列的极限) Sequence Limits 数列的极限 微积分 二、极限运算法则 考研数学 · 数列的极限 二、极限运算法则 若 lim 𝑎𝑛 = 𝐴, lim 𝑏𝑛 = 𝐵 则 lim(𝑎𝑛 + 𝑏𝑛 ) = 𝐴 + 𝐵 lim(𝑎𝑛 𝑏𝑛 ) = 𝐴𝐵 若 𝐵 ≠ 0，则 𝑎𝑛 𝐴 lim = 𝑏𝑛 𝐵 若 𝑎𝑛 ≤ 𝑏𝑛 且二者极限存在，则 𝐴≤𝐵 注意：不等式取极限后通常只能保留非严格不等号。"
  },
  {
    ...
    "page": 4,
    "heading": "三、常用数列极限",
    "snippet": "考研数学 · 数列的极限 三、常用数列极限 数列 极限 条件或说明 𝑞𝑛 0 |𝑞| < 1 1 𝑛𝛼 0 𝛼>0 1 𝑛 𝑛 1 常用对数化证明 1 𝑎 𝑛 1 𝑎>0 𝑛 (1 + 𝑛1 ) 𝑒 自然常数定义之一 𝑘 𝑛 𝑎𝑛 0 𝑎 > 1，指数增长快于幂增长 判断增长速度： 当 𝑛 → ∞ 时，一般有 ln 𝑛 ≪ 𝑛𝛼 ≪ 𝑎𝑛...",
    "text": "Sequence Limits (数列的极限) Sequence Limits 数列的极限 微积分 三、常用数列极限 考研数学 · 数列的极限 三、常用数列极限 数列 极限 条件或说明 𝑞𝑛 0 |𝑞| < 1 1 𝑛𝛼 0 𝛼>0 1 𝑛 𝑛 1 常用对数化证明 1 𝑎 𝑛 1 𝑎>0 𝑛 (1 + 𝑛1 ) 𝑒 自然常数定义之一 𝑘 𝑛 𝑎𝑛 0 𝑎 > 1，指数增长快于幂增长 判断增长速度： 当 𝑛 → ∞ 时，一般有 ln 𝑛 ≪ 𝑛𝛼 ≪ 𝑎𝑛 ≪ 𝑛! ≪ 𝑛𝑛 (𝛼 > 0, 𝑎 > 1) 用于判断无穷大或无穷小阶数。"
  },
  {
    ...
    "page": 5,
    "heading": "四、常用求法",
    "snippet": "考研数学 · 数列的极限 四、常用求法 1. 代数化简 含根式的数列常通过有理化或提取最高阶项处理。例如： √𝑛2 + 𝑛 − 𝑛 = √ 𝑛 1 = 𝑛2 + 𝑛 + 𝑛 √1 + 𝑛1 + 1 所以极限为 12 。 2. 夹逼定理 当数列含有振荡因子，如 sin 𝑛、cos 𝑛、(−1)𝑛 时，常利用有界性夹逼。例如： 1 𝑛 1 −...",
    "text": "Sequence Limits (数列的极限) Sequence Limits 数列的极限 微积分 四、常用求法 考研数学 · 数列的极限 四、常用求法 1. 代数化简 含根式的数列常通过有理化或提取最高阶项处理。例如： √𝑛2 + 𝑛 − 𝑛 = √ 𝑛 1 = 𝑛2 + 𝑛 + 𝑛 √1 + 𝑛1 + 1 所以极限为 12 。 2. 夹逼定理 当数列含有振荡因子，如 sin 𝑛、cos 𝑛、(−1)𝑛 时，常利用有界性夹逼。例如： 1 𝑛 1 − ≤ sin ≤ 𝑛 𝑛 𝑛 故 𝑛 lim sin =0 𝑛→∞ 𝑛 3. 单调有界定理 若数列单调递增且有上界，或单调递减且有下界，则数列收敛。递推数列常用这个定理先证明极限存在，再由 递推式求极限。 4. 函数极限转化 若 𝑎𝑛 = 𝑓(𝑛)，且 lim 𝑓(𝑥) = 𝐴 𝑥→∞ 则 lim 𝑎𝑛 = 𝐴 𝑛→∞ 这使洛必达法则、泰勒展开和等价无穷小也能服务数列极限。"
  },
  {
    ...
    "page": 6,
    "heading": "五、递推数列",
    "snippet": "考研数学 · 数列的极限 五、递推数列 递推数列通常形如 𝑎𝑛+1 = 𝜑(𝑎𝑛 ) 常用步骤为： 1. 猜测或求不动点：令 𝐴 = 𝜑(𝐴)。 2. 证明数列有界。 3. 证明数列单调，或证明相邻项差趋于零。 4. 若已知极限存在，则代入递推式求 𝐴。 易错点： 不能只把极限代入递推式就结束。必须先说明极限存在，常用方法就是单调有界定理...",
    "text": "Sequence Limits (数列的极限) Sequence Limits 数列的极限 微积分 五、递推数列 考研数学 · 数列的极限 五、递推数列 递推数列通常形如 𝑎𝑛+1 = 𝜑(𝑎𝑛 ) 常用步骤为： 1. 猜测或求不动点：令 𝐴 = 𝜑(𝐴)。 2. 证明数列有界。 3. 证明数列单调，或证明相邻项差趋于零。 4. 若已知极限存在，则代入递推式求 𝐴。 易错点： 不能只把极限代入递推式就结束。必须先说明极限存在，常用方法就是单调有界定理或压缩映射 思想。"
  },
  {
    ...
    "page": 7,
    "heading": "六、典型例题",
    "snippet": "考研数学 · 数列的极限 六、典型例题 例题 1：根式数列 √ 题目 求 lim𝑛→∞ ( 𝑛2 + 𝑛 − 𝑛)。 有理化： √𝑛2 + 𝑛 − 𝑛 = √ 𝑛 𝑛2 + 𝑛 + 𝑛 上下同除以 𝑛： 𝑛 1 √ = 𝑛2 + 𝑛 + 𝑛 √1 + 𝑛1 + 1 所以 1 lim (√𝑛2 + 𝑛 − 𝑛) = 𝑛→∞ 2 例题 2：递...",
    "text": "Sequence Limits (数列的极限) Sequence Limits 数列的极限 微积分 六、典型例题 考研数学 · 数列的极限 六、典型例题 例题 1：根式数列 √ 题目 求 lim𝑛→∞ ( 𝑛2 + 𝑛 − 𝑛)。 有理化： √𝑛2 + 𝑛 − 𝑛 = √ 𝑛 𝑛2 + 𝑛 + 𝑛 上下同除以 𝑛： 𝑛 1 √ = 𝑛2 + 𝑛 + 𝑛 √1 + 𝑛1 + 1 所以 1 lim (√𝑛2 + 𝑛 − 𝑛) = 𝑛→∞ 2 例题 2：递推数列 √ 题目 设 𝑎1 = 2，𝑎𝑛+1 = √2 + 𝑎𝑛 ，求 lim 𝑎𝑛 。 先猜极限。若极限为 𝐴，则 √ 𝐴= 2+𝐴 解得 𝐴 = 2 或 𝐴 = −1。因 𝑎𝑛 > 0，只可能为 2。 再说明极限存在。由 𝑎1 < 2，若 𝑎𝑛 < 2，则 √ 𝑎𝑛+1 = √2 + 𝑎𝑛 < 4=2 所以 𝑎𝑛 < 2。又 𝑎𝑛+1 ≥ 𝑎𝑛 ⇔ √2 + 𝑎𝑛 ≥ 𝑎𝑛 ⇔ 2 + 𝑎𝑛 ≥ 𝑎2𝑛 当 0 < 𝑎𝑛 < 2 时成立。因此数列单调递增且有上界 2，故收敛，极限为 2 例题 3：指数型极限 𝑏 题目 求 lim𝑛→∞ 𝑛((1 + 𝑛𝑎 ) − 1)。 当 𝑛 → ∞ 时， 𝑛𝑎 → 0。由 (1 + 𝑥)𝑏 − 1 ≃ 𝑏𝑥 得 𝑎 𝑏 𝑎 (1 + ) −1≃𝑏 𝑛 𝑛 所以"
  },
  {
    "id": "doc-d3af775c5a55-p8",
    "docId": "doc-d3af775c5a55",
    "title": "Sequence Limits (数列的极限)",
    "category": "微积分",
    "page": 8,
    "heading": "考研数学 · 数列的极限",
    "snippet": "考研数学 · 数列的极限 𝑎 𝑏 lim 𝑛((1 + ) − 1) = 𝑎𝑏 𝑛→∞ 𝑛",
    "text": "Sequence Limits (数列的极限) Sequence Limits 数列的极限 微积分 考研数学 · 数列的极限 考研数学 · 数列的极限 𝑎 𝑏 lim 𝑛((1 + ) − 1) = 𝑎𝑏 𝑛→∞ 𝑛"
  },
  {
    ...
    "category": "微积分",
    "page": 1,
    "heading": "考研数学 · 一元函数微分学的概念和计算",
    "snippet": "考研数学 · 一元函数微分学的概念和计算 一元函数微分学的概念和计算 导数定义 · 微分 · 求导法则 · 高阶导数 考研数学复习资料 · Typst PDF 首页速览 𝑓(𝑥 +Δ𝑥)−𝑓(𝑥 ) • 核心公式：𝑓 ′ (𝑥0 ) = limΔ𝑥→0 0 Δ𝑥 ′ 0 ，𝑑𝑦 = 𝑓 ′ (𝑥)𝑑𝑥。 • 关键定理：可导必连续；反函数求...",
    "text": "Differential Calculus Concepts and Computation (一元函数微分学的概念和计算) Differential Calculus Concepts and Computation 一元函数微分学的概念和计算 微积分 考研数学 · 一元函数微分学的概念和计算 考研数学 · 一元函数微分学的概念和计算 一元函数微分学的概念和计算 导数定义 · 微分 · 求导法则 · 高阶导数 考研数学复习资料 · Typst PDF 首页速览 𝑓(𝑥 +Δ𝑥)−𝑓(𝑥 ) • 核心公式：𝑓 ′ (𝑥0 ) = limΔ𝑥→0 0 Δ𝑥 ′ 0 ，𝑑𝑦 = 𝑓 ′ (𝑥)𝑑𝑥。 • 关键定理：可导必连续；反函数求导 (𝑓 ) (𝑦) = 𝑓1′ (𝑥)；复合函数按链式法则逐层求导。 −1 𝑑𝑦 • 方法抓手：显函数直接求导，隐函数两边求导，参数方程用 𝑑𝑦 = 𝑑𝑥 𝑑𝑡 。 𝑑𝑥 𝑑𝑡 复习目标：一元函数微分学的概念部分重在理解“局部线性化”，计算部分重在熟练掌握复合函数、隐函数、 参数方程和高阶导数。考研题常把导数定义、极限和求导法则混合考查。"
  },
  {
    ...
    "page": 2,
    "heading": "一、导数的概念",
    "snippet": "考研数学 · 一元函数微分学的概念和计算 一、导数的概念 1. 导数定义 函数 𝑦 = 𝑓(𝑥) 在点 𝑥0 的导数定义为 𝑓(𝑥0 + Δ𝑥) − 𝑓(𝑥0 ) 𝑓 ′ (𝑥0 ) = lim Δ𝑥→0 Δ𝑥 若该极限存在，则称 𝑓(𝑥) 在 𝑥0 可导。导数表示函数图像在该点切线斜率，也表示函数值相对于自变量的瞬时 变化率。 也可写成...",
    "text": "Differential Calculus Concepts and Computation (一元函数微分学的概念和计算) Differential Calculus Concepts and Computation 一元函数微分学的概念和计算 微积分 一、导数的概念 考研数学 · 一元函数微分学的概念和计算 一、导数的概念 1. 导数定义 函数 𝑦 = 𝑓(𝑥) 在点 𝑥0 的导数定义为 𝑓(𝑥0 + Δ𝑥) − 𝑓(𝑥0 ) 𝑓 ′ (𝑥0 ) = lim Δ𝑥→0 Δ𝑥 若该极限存在，则称 𝑓(𝑥) 在 𝑥0 可导。导数表示函数图像在该点切线斜率，也表示函数值相对于自变量的瞬时 变化率。 也可写成 𝑓(𝑥) − 𝑓(𝑥0 ) 𝑓 ′ (𝑥0 ) = lim 𝑥→𝑥0 𝑥 − 𝑥0 2. 左导数与右导数 函数在 𝑥0 可导，当且仅当左导数和右导数都存在且相等： 𝑓−′ (𝑥0 ) = 𝑓+′ (𝑥0 ) 分段函数、绝对值函数和端点处的导数问题，必须分别考察左右导数。 易错点： 可导一定连续，连续不一定可导。例如 𝑓(𝑥) = |𝑥| 在 𝑥 = 0 连续但不可导，因为左右导数分别 为 −1 与 1。"
  },
  {
    ...
    "page": 3,
    "heading": "二、微分与局部线性化",
    "snippet": "考研数学 · 一元函数微分学的概念和计算 二、微分与局部线性化 1. 微分定义 若函数在 𝑥 处可导，则 𝑑𝑦 = 𝑓 ′ (𝑥) 𝑑𝑥 称为函数的微分。它是函数增量 Δ𝑦 = 𝑓(𝑥 + Δ𝑥) − 𝑓(𝑥) 的线性主部： Δ𝑦 = 𝑓 ′ (𝑥)Δ𝑥 + 𝑜(Δ𝑥) 2. 近似计算 当 Δ𝑥 很小时， 𝑓(𝑥 + Δ𝑥) ≈ 𝑓(𝑥)...",
    "text": "Differential Calculus Concepts and Computation (一元函数微分学的概念和计算) Differential Calculus Concepts and Computation 一元函数微分学的概念和计算 微积分 二、微分与局部线性化 考研数学 · 一元函数微分学的概念和计算 二、微分与局部线性化 1. 微分定义 若函数在 𝑥 处可导，则 𝑑𝑦 = 𝑓 ′ (𝑥) 𝑑𝑥 称为函数的微分。它是函数增量 Δ𝑦 = 𝑓(𝑥 + Δ𝑥) − 𝑓(𝑥) 的线性主部： Δ𝑦 = 𝑓 ′ (𝑥)Δ𝑥 + 𝑜(Δ𝑥) 2. 近似计算 当 Δ𝑥 很小时， 𝑓(𝑥 + Δ𝑥) ≈ 𝑓(𝑥) + 𝑓 ′ (𝑥)Δ𝑥 这就是用切线近似曲线。常用于根式、指数和对数的近似估算。"
  },
  {
    ...
    "page": 4,
    "heading": "三、基本求导公式",
    "snippet": "考研数学 · 一元函数微分学的概念和计算 三、基本求导公式 函数 导数 说明 𝐶 0 常数导数为零 𝑥𝛼 𝛼𝑥𝛼−1 幂函数公式 𝑥 𝑥 𝑒 𝑒 自然指数函数 𝑎𝑥 𝑎𝑥 ln 𝑎 𝑎 > 0, 𝑎 ≠ 1 1 ln 𝑥 𝑥 𝑥>0 sin 𝑥 cos 𝑥 三角函数 cos 𝑥 − sin 𝑥 注意负号 tan 𝑥 sec2 𝑥 1 也可...",
    "text": "Differential Calculus Concepts and Computation (一元函数微分学的概念和计算) Differential Calculus Concepts and Computation 一元函数微分学的概念和计算 微积分 三、基本求导公式 考研数学 · 一元函数微分学的概念和计算 三、基本求导公式 函数 导数 说明 𝐶 0 常数导数为零 𝑥𝛼 𝛼𝑥𝛼−1 幂函数公式 𝑥 𝑥 𝑒 𝑒 自然指数函数 𝑎𝑥 𝑎𝑥 ln 𝑎 𝑎 > 0, 𝑎 ≠ 1 1 ln 𝑥 𝑥 𝑥>0 sin 𝑥 cos 𝑥 三角函数 cos 𝑥 − sin 𝑥 注意负号 tan 𝑥 sec2 𝑥 1 也可写 cos 2𝑥 1 arctan 𝑥 1+𝑥2 反三角函数常用"
  },
  {
    "id": "doc-f02190ce156c-p5",
    "docId": "doc-f02190ce156c",
    "title": "Differential Calculus Concepts and Computation (一元函数微分学的概念和计算)",
    "category": "微积分",
    "page": 5,
    "heading": "四、求导法则",
    "snippet": "考研数学 · 一元函数微分学的概念和计算 四、求导法则 1. 四则运算 若 𝑢 = 𝑢(𝑥)，𝑣 = 𝑣(𝑥) 可导，则 (𝑢 + 𝑣)′ = 𝑢′ + 𝑣′ (𝑢𝑣)′ = 𝑢′ 𝑣 + 𝑢𝑣′ 𝑢 ′ 𝑢′ 𝑣 − 𝑢𝑣′ ( ) = (𝑣 ≠ 0) 𝑣 𝑣2 2. 复合函数求导 若 𝑦 = 𝑓(𝑢)，𝑢 = 𝑔(𝑥)，则 𝑦 𝑑𝑦 ...",
    "text": "Differential Calculus Concepts and Computation (一元函数微分学的概念和计算) Differential Calculus Concepts and Computation 一元函数微分学的概念和计算 微积分 四、求导法则 考研数学 · 一元函数微分学的概念和计算 四、求导法则 1. 四则运算 若 𝑢 = 𝑢(𝑥)，𝑣 = 𝑣(𝑥) 可导，则 (𝑢 + 𝑣)′ = 𝑢′ + 𝑣′ (𝑢𝑣)′ = 𝑢′ 𝑣 + 𝑢𝑣′ 𝑢 ′ 𝑢′ 𝑣 − 𝑢𝑣′ ( ) = (𝑣 ≠ 0) 𝑣 𝑣2 2. 复合函数求导 若 𝑦 = 𝑓(𝑢)，𝑢 = 𝑔(𝑥)，则 𝑦 𝑑𝑦 𝑑𝑢 𝑑 𝑥= ⋅ = 𝑓 ′ (𝑔(𝑥))𝑔′ (𝑥) 𝑑 𝑑𝑢 𝑑𝑥 链式法则的关键是从外到内逐层求导，每层都不能漏。 3. 反函数求导 若 𝑦 = 𝑓(𝑥) 单调可导，且 𝑓 ′ (𝑥) ≠ 0，其反函数 𝑥 = 𝜑(𝑦) 满足 𝑑𝑥 1 = 𝑑𝑦 𝑑𝑦 𝑑𝑥 常用于反三角函数和由方程确定的反函数。 4. 隐函数求导 若 𝐹 (𝑥, 𝑦) = 0 确定 𝑦 = 𝑦(𝑥)，则两边对 𝑥 求导，把 𝑦 看成 𝑥 的函数： 𝐹𝑥 + 𝐹𝑦 𝑦′ = 0 若 𝐹𝑦 ≠ 0，则 𝐹 𝑦′ = − 𝑥 𝐹𝑦 5. 参数方程求导 若 𝑥 = 𝑥(𝑡), 𝑦 = 𝑦(𝑡) 且 𝑥′ (𝑡) ≠ 0，则 𝑑𝑦 𝑑𝑦 𝑑𝑡 𝑡 = 𝑑𝑥 = 𝑦′ ′ (𝑡) 𝑑𝑥 𝑑𝑡 𝑥 二阶导数为 𝑑 𝑑𝑦 𝑑2 𝑦 𝑑𝑡 ( 𝑑𝑥 ) = 𝑑𝑥2 𝑑 𝑥𝑑 𝑡 6. 对数求导法 当函数含有乘积、商、幂指函数时，常先取对数再求导。例如"
  },
  {
    "id": "doc-f02190ce156c-p6",
    "docId": "doc-f02190ce156c",
    "title": "Differential Calculus Concepts and Computation (一元函数微分学的概念和计算)",
    "category": "微积分",
    "page": 6,
    "heading": "考研数学 · 一元函数微分学的概念和计算",
    "snippet": "考研数学 · 一元函数微分学的概念和计算 𝑦 = 𝑢(𝑥)𝑣(𝑥) 两边取对数： ln 𝑦 = 𝑣 ln 𝑢 再求导： 𝑦′ 𝑢′ = 𝑣′ ln 𝑢 + 𝑣 𝑦 𝑢",
    "text": "Differential Calculus Concepts and Computation (一元函数微分学的概念和计算) Differential Calculus Concepts and Computation 一元函数微分学的概念和计算 微积分 考研数学 · 一元函数微分学的概念和计算 考研数学 · 一元函数微分学的概念和计算 𝑦 = 𝑢(𝑥)𝑣(𝑥) 两边取对数： ln 𝑦 = 𝑣 ln 𝑢 再求导： 𝑦′ 𝑢′ = 𝑣′ ln 𝑢 + 𝑣 𝑦 𝑢"
  },
  {
    "id": "doc-f02190ce156c-p7",
    "docId": "doc-f02190ce156c",
    "title": "Differential Calculus Concepts and Computation (一元函数微分学的概念和计算)",
    "category": "微积分",
    "page": 7,
    "heading": "五、高阶导数与常见结构",
    "snippet": "考研数学 · 一元函数微分学的概念和计算 五、高阶导数与常见结构 1. 高阶导数 若 𝑓 ′ (𝑥) 仍可导，则称其导数为二阶导数： 𝑓 ″ (𝑥) = (𝑓 ′ (𝑥))′ 依次可定义 𝑛 阶导数 𝑓 (𝑛) (𝑥)。 2. 常见高阶导数 函数 𝑛 阶导数 𝑒𝑎𝑥 𝑎𝑛 𝑒𝑎𝑥 sin 𝑥 按 sin 𝑥, cos 𝑥, − sin 𝑥...",
    "text": "Differential Calculus Concepts and Computation (一元函数微分学的概念和计算) Differential Calculus Concepts and Computation 一元函数微分学的概念和计算 微积分 五、高阶导数与常见结构 考研数学 · 一元函数微分学的概念和计算 五、高阶导数与常见结构 1. 高阶导数 若 𝑓 ′ (𝑥) 仍可导，则称其导数为二阶导数： 𝑓 ″ (𝑥) = (𝑓 ′ (𝑥))′ 依次可定义 𝑛 阶导数 𝑓 (𝑛) (𝑥)。 2. 常见高阶导数 函数 𝑛 阶导数 𝑒𝑎𝑥 𝑎𝑛 𝑒𝑎𝑥 sin 𝑥 按 sin 𝑥, cos 𝑥, − sin 𝑥, − cos 𝑥 循环 (𝑛−1)! ln(1 + 𝑥) (−1)𝑛−1 (1+𝑥) 𝑛 1 𝑛! 1−𝑥 (1−𝑥)𝑛+1"
  },
  {
    "id": "doc-f02190ce156c-p8",
    "docId": "doc-f02190ce156c",
    "title": "Differential Calculus Concepts and Computation (一元函数微分学的概念和计算)",
    "category": "微积分",
    "page": 8,
  ...
  },
  {
    ...
    "category": "微积分",
    "page": 1,
    "heading": "考研数学 · 一元函数微分学的应用",
    "snippet": "考研数学 · 一元函数微分学的应用 一元函数微分学的应用 几何应用 · 中值定理 · 等式不等式证明 · 物理应用 考研数学复习资料 · Typst PDF 首页速览 |𝑦″ | • 核心公式：切线 𝑦 − 𝑦0 = 𝑓 ′ (𝑥0 )(𝑥 − 𝑥0 )；曲率 𝑘 = 3 。 (1+𝑦′2 ) 2 • 关键定理：Rolle 定理、Lagr...",
    "text": "Applications of Differential Calculus (一元函数微分学的应用) Applications of Differential Calculus 一元函数微分学的应用 微积分 考研数学 · 一元函数微分学的应用 考研数学 · 一元函数微分学的应用 一元函数微分学的应用 几何应用 · 中值定理 · 等式不等式证明 · 物理应用 考研数学复习资料 · Typst PDF 首页速览 |𝑦″ | • 核心公式：切线 𝑦 − 𝑦0 = 𝑓 ′ (𝑥0 )(𝑥 − 𝑥0 )；曲率 𝑘 = 3 。 (1+𝑦′2 ) 2 • 关键定理：Rolle 定理、Lagrange 中值定理、Cauchy 中值定理、Taylor 公式是证明题主线。 • 方法抓手：单调性看 𝑓 ′ ，凹凸性看 𝑓 ″ ；等式构造辅助函数，不等式常用单调性、凸性或中值定理。 复习目标： 微分学应用的主线是“用导数描述变化”。几何题看斜率和曲率趋势，证明题看中值定理和辅助 函数，最值题看一阶导数与二阶导数，物理题看瞬时速度、加速度和变化率。"
  },
  {
    ...
    "page": 2,
    "heading": "一、几何应用",
    "snippet": "考研数学 · 一元函数微分学的应用 一、几何应用 1. 切线与法线 曲线 𝑦 = 𝑓(𝑥) 在点 𝑥0 处的切线斜率为 𝑘 = 𝑓 ′ (𝑥0 ) 切线方程为 𝑦 − 𝑓(𝑥0 ) = 𝑓 ′ (𝑥0 )(𝑥 − 𝑥0 ) 若 𝑓 ′ (𝑥0 ) ≠ 0，法线斜率为 1 𝑘𝑛 = − ′ (𝑥0 ) 𝑓 法线方程为 1 𝑦 − 𝑓(𝑥0 ...",
    "text": "Applications of Differential Calculus (一元函数微分学的应用) Applications of Differential Calculus 一元函数微分学的应用 微积分 一、几何应用 考研数学 · 一元函数微分学的应用 一、几何应用 1. 切线与法线 曲线 𝑦 = 𝑓(𝑥) 在点 𝑥0 处的切线斜率为 𝑘 = 𝑓 ′ (𝑥0 ) 切线方程为 𝑦 − 𝑓(𝑥0 ) = 𝑓 ′ (𝑥0 )(𝑥 − 𝑥0 ) 若 𝑓 ′ (𝑥0 ) ≠ 0，法线斜率为 1 𝑘𝑛 = − ′ (𝑥0 ) 𝑓 法线方程为 1 𝑦 − 𝑓(𝑥0 ) = − ′ (𝑥 − 𝑥0 ) 𝑓 (𝑥0 ) 2. 单调性与极值 若在区间内 𝑓 ′ (𝑥) > 0，则 𝑓(𝑥) 单调递增；若 𝑓 ′ (𝑥) < 0，则单调递减。 极值常在以下点出现： 1. 𝑓 ′ (𝑥) = 0 的驻点。 2. 导数不存在但函数连续的点。 3. 闭区间端点。 3. 凹凸性与拐点 若 𝑓 ″ (𝑥) > 0，曲线凹向上；若 𝑓 ″ (𝑥) < 0，曲线凹向下。若 𝑓 ″ (𝑥) 在某点两侧变号，则该点可能为拐点。"
  },
  {
    ...
    "page": 3,
    "heading": "二、中值定理",
    "snippet": "考研数学 · 一元函数微分学的应用 二、中值定理 1. 罗尔定理 若 𝑓(𝑥) 在 [𝑎, 𝑏] 连续，在 (𝑎, 𝑏) 可导，且 𝑓(𝑎) = 𝑓(𝑏)，则存在 𝜉 ∈ (𝑎, 𝑏)，使 𝑓 ′ (𝜉) = 0 2. 拉格朗日中值定理 若 𝑓(𝑥) 在 [𝑎, 𝑏] 连续，在 (𝑎, 𝑏) 可导，则存在 𝜉 ∈ (𝑎, 𝑏)，使 𝑓(𝑏...",
    "text": "Applications of Differential Calculus (一元函数微分学的应用) Applications of Differential Calculus 一元函数微分学的应用 微积分 二、中值定理 考研数学 · 一元函数微分学的应用 二、中值定理 1. 罗尔定理 若 𝑓(𝑥) 在 [𝑎, 𝑏] 连续，在 (𝑎, 𝑏) 可导，且 𝑓(𝑎) = 𝑓(𝑏)，则存在 𝜉 ∈ (𝑎, 𝑏)，使 𝑓 ′ (𝜉) = 0 2. 拉格朗日中值定理 若 𝑓(𝑥) 在 [𝑎, 𝑏] 连续，在 (𝑎, 𝑏) 可导，则存在 𝜉 ∈ (𝑎, 𝑏)，使 𝑓(𝑏) − 𝑓(𝑎) 𝑓 ′ (𝜉) = 𝑏−𝑎 等价于 𝑓(𝑏) − 𝑓(𝑎) = 𝑓 ′ (𝜉)(𝑏 − 𝑎) 它把函数增量转化为某点导数乘以区间长度。 3. 柯西中值定理 若 𝑓(𝑥), 𝑔(𝑥) 在 [𝑎, 𝑏] 连续，在 (𝑎, 𝑏) 可导，且 𝑔′ (𝑥) ≠ 0，则存在 𝜉 ∈ (𝑎, 𝑏)，使 𝑓(𝑏) − 𝑓(𝑎) 𝜉 = 𝑓 ′ ′ (𝜉) 𝑔(𝑏) − 𝑔(𝑎) 𝑔 洛必达法则可以看作柯西中值定理的应用。 4. 泰勒公式 在 𝑥0 附近， 𝑓 ″ (𝑥0 ) 𝑓(𝑥) = 𝑓(𝑥0 ) + 𝑓 ′ (𝑥0 )(𝑥 − 𝑥0 ) + (𝑥 − 𝑥0 )2 + … 2 泰勒公式常用于极限、近似计算、不等式证明和极值判定。 中值定理选用： 出现“至少存在一点使某导数为零”常想罗尔定理；出现函数值差和区间长度常想拉格朗日 中值定理；出现两个函数增量之比常想柯西中值定理；出现高阶估计常想泰勒公式。"
  },
  {
    ...
    "page": 4,
    "heading": "三、等式与不等式证明",
    "snippet": "考研数学 · 一元函数微分学的应用 三、等式与不等式证明 1. 辅助函数法 证明等式或存在性结论时，常把目标式移到一边，构造辅助函数 𝐹 (𝑥)。若能得到端点值相等，就用罗尔定理； 若要比较函数值差，就用拉格朗日中值定理。 2. 单调性法 证明 𝑓(𝑥) ≥ 𝑔(𝑥)，可令 𝐹 (𝑥) = 𝑓(𝑥) − 𝑔(𝑥) 再通过导数判断 𝐹 (𝑥...",
    "text": "Applications of Differential Calculus (一元函数微分学的应用) Applications of Differential Calculus 一元函数微分学的应用 微积分 三、等式与不等式证明 考研数学 · 一元函数微分学的应用 三、等式与不等式证明 1. 辅助函数法 证明等式或存在性结论时，常把目标式移到一边，构造辅助函数 𝐹 (𝑥)。若能得到端点值相等，就用罗尔定理； 若要比较函数值差，就用拉格朗日中值定理。 2. 单调性法 证明 𝑓(𝑥) ≥ 𝑔(𝑥)，可令 𝐹 (𝑥) = 𝑓(𝑥) − 𝑔(𝑥) 再通过导数判断 𝐹 (𝑥) 的单调性和最小值。 3. 凸性法 若 𝑓 ″ (𝑥) ≥ 0，则 𝑓(𝑥) 为凸函数，常有切线不等式： 𝑓(𝑥) ≥ 𝑓(𝑥0 ) + 𝑓 ′ (𝑥0 )(𝑥 − 𝑥0 ) 例如由 𝑓(𝑥) = ln 𝑥 的凹性可得 ln 𝑥 ≤ 𝑥 − 1 (𝑥 > 0)"
  },
  {
    "id": "doc-8d9ed00135c3-p5",
    "docId": "doc-8d9ed00135c3",
    "title": "Applications of Differential Calculus (一元函数微分学的应用)",
    "category": "微积分",
    "page": 5,
    "heading": "四、物理应用",
    "snippet": "考研数学 · 一元函数微分学的应用 四、物理应用 1. 速度与加速度 若质点位置为 𝑠 = 𝑠(𝑡)，则速度和加速度分别为 𝑣(𝑡) = 𝑠′ (𝑡), 𝑎(𝑡) = 𝑣′ (𝑡) = 𝑠″ (𝑡) 速度描述位置变化率，加速度描述速度变化率。 2. 相关变化率 若多个变量之间满足约束关系，先对时间 𝑡 求导，再代入已知瞬时量。典型题包括水...",
    "text": "Applications of Differential Calculus (一元函数微分学的应用) Applications of Differential Calculus 一元函数微分学的应用 微积分 四、物理应用 考研数学 · 一元函数微分学的应用 四、物理应用 1. 速度与加速度 若质点位置为 𝑠 = 𝑠(𝑡)，则速度和加速度分别为 𝑣(𝑡) = 𝑠′ (𝑡), 𝑎(𝑡) = 𝑣′ (𝑡) = 𝑠″ (𝑡) 速度描述位置变化率，加速度描述速度变化率。 2. 相关变化率 若多个变量之间满足约束关系，先对时间 𝑡 求导，再代入已知瞬时量。典型题包括水位变化、影长变化、圆半 径变化等。 3. 最大最小值应用 实际最值题步骤： 1. 选变量，写目标函数。 2. 用条件消元，得到单变量函数。 3. 确定变量范围。 4. 求导并比较驻点与端点。"
  },
  {
    "id": "doc-8d9ed00135c3-p6",
    "docId": "doc-8d9ed00135c3",
    "title": "Applications of Differential Calculus (一元函数微分学的应用)",
    "category": "微积分",
    "page": 6,
    "heading": "五、典型例题",
    "snippet": "考研数学 · 一元函数微分学的应用 五、典型例题 例题 1：切线方程 题目 求曲线 𝑦 = 𝑥3 − 𝑥 在 𝑥 = 1 处的切线方程。 先求导： 𝑦′ = 3𝑥2 − 1 所以 𝑦′ (1) = 2, 𝑦(1) = 0 切线方程为 𝑦 − 0 = 2(𝑥 − 1) 即 𝑦 = 2𝑥 − 2 例题 2：用单调性证明不等式 题目 证明 ln...",
    "text": "Applications of Differential Calculus (一元函数微分学的应用) Applications of Differential Calculus 一元函数微分学的应用 微积分 五、典型例题 考研数学 · 一元函数微分学的应用 五、典型例题 例题 1：切线方程 题目 求曲线 𝑦 = 𝑥3 − 𝑥 在 𝑥 = 1 处的切线方程。 先求导： 𝑦′ = 3𝑥2 − 1 所以 𝑦′ (1) = 2, 𝑦(1) = 0 切线方程为 𝑦 − 0 = 2(𝑥 − 1) 即 𝑦 = 2𝑥 − 2 例题 2：用单调性证明不等式 题目 证明 ln 𝑥 ≤ 𝑥 − 1 (𝑥 > 0)。 令 𝐹 (𝑥) = 𝑥 − 1 − ln 𝑥 则 1 𝑥−1 𝐹 ′ (𝑥) = 1 − = 𝑥 𝑥 当 0 < 𝑥 < 1 时，𝐹 ′ (𝑥) < 0；当 𝑥 > 1 时，𝐹 ′ (𝑥) > 0。所以 𝐹 (𝑥) 在 𝑥 = 1 处取最小值： 𝐹 (1) = 0 因此 𝐹 (𝑥) ≥ 0 即 ln 𝑥 ≤ 𝑥 − 1 例题 3：拉格朗日中值定理 题目 证明对 𝑎, 𝑏 > 0，存在 𝜉 介于 𝑎, 𝑏 之间，使 ln 𝑏 − ln 𝑎 = 𝑏−𝑎 𝜉 。 令 𝑓(𝑥) = ln 𝑥。由拉格朗日中值定理，存在 𝜉 介于 𝑎, 𝑏 之间，使 𝑓(𝑏) − 𝑓(𝑎) = 𝑓 ′ (𝜉)(𝑏 − 𝑎) 而 1 𝑓 ′ (𝜉) = 𝜉"
  },
  {
    "id": "doc-8d9ed00135c3-p7",
    "docId": "doc-8d9ed00135c3",
    "title": "Applications of Differential Calculus (一元函数微分学的应用)",
    "category": "微积分",
    "page": 7,
    "heading": "例题 4：物理变化率",
    "snippet": "考研数学 · 一元函数微分学的应用 所以 𝑏−𝑎 ln 𝑏 − ln 𝑎 = 𝜉 例题 4：物理变化率 题目 质点运动规律为 𝑠 = 𝑡3 − 6𝑡2 + 9𝑡，求速度为零的时刻。 速度为 𝑣 = 𝑠′ = 3𝑡2 − 12𝑡 + 9 = 3(𝑡 − 1)(𝑡 − 3) 令 𝑣 = 0，得 𝑡=1 或 𝑡=3 这两个时刻质点瞬时速度为零。",
    "text": "Applications of Differential Calculus (一元函数微分学的应用) Applications of Differential Calculus 一元函数微分学的应用 微积分 例题 4：物理变化率 考研数学 · 一元函数微分学的应用 所以 𝑏−𝑎 ln 𝑏 − ln 𝑎 = 𝜉 例题 4：物理变化率 题目 质点运动规律为 𝑠 = 𝑡3 − 6𝑡2 + 9𝑡，求速度为零的时刻。 速度为 𝑣 = 𝑠′ = 3𝑡2 − 12𝑡 + 9 = 3(𝑡 − 1)(𝑡 − 3) 令 𝑣 = 0，得 𝑡=1 或 𝑡=3 这两个时刻质点瞬时速度为零。"
  },
  {
    ...
    "snippet": "考研数学 · 一元函数积分学的概念性质和计算 一元函数积分学的概念性质和计算 不定积分 · 定积分 · 性质 · 换元与分部积分 考研数学复习资料 · Typst PDF 首页速览 𝑏 • 核心公式：∫ 𝑓(𝑥)𝑑𝑥 = 𝐹 (𝑏) − 𝐹 (𝑎)，∫ 𝑢𝑑𝑣 = 𝑢𝑣 − ∫ 𝑣𝑑𝑢。 𝑎 𝑥 𝑏 • 关键定理：变上限函数 Φ(𝑥) =...",
    "text": "Integral Calculus Concepts Properties and Computation (一元函数积分学的概念性质和计算) Integral Calculus Concepts Properties and Computation 一元函数积分学的概念性质和计算 微积分 考研数学 · 一元函数积分学的概念性质和计算 考研数学 · 一元函数积分学的概念性质和计算 一元函数积分学的概念性质和计算 不定积分 · 定积分 · 性质 · 换元与分部积分 考研数学复习资料 · Typst PDF 首页速览 𝑏 • 核心公式：∫ 𝑓(𝑥)𝑑𝑥 = 𝐹 (𝑏) − 𝐹 (𝑎)，∫ 𝑢𝑑𝑣 = 𝑢𝑣 − ∫ 𝑣𝑑𝑢。 𝑎 𝑥 𝑏 • 关键定理：变上限函数 Φ(𝑥) = ∫ 𝑓(𝑡)𝑑𝑡 满足 Φ′ (𝑥) = 𝑓(𝑥)；定积分中值定理 ∫ 𝑓(𝑥)𝑑𝑥 = 𝑓(𝜉)(𝑏 − 𝑎)。 𝑎 𝑎 • 方法抓手：先看奇偶性和周期性，再选换元、分部积分、有理化、递推或拆项。 复习目标： 一元积分学的基础是“累加”和“反求导”。不定积分强调原函数，定积分强调区间累积量。考研 中常考换元、分部积分、对称性、积分中值定理和变上限积分函数。"
  },
  {
    ...
    "page": 2,
    "heading": "一、不定积分",
    "snippet": "考研数学 · 一元函数积分学的概念性质和计算 一、不定积分 1. 原函数与不定积分 若 𝐹 ′ (𝑥) = 𝑓(𝑥) 则称 𝐹 (𝑥) 是 𝑓(𝑥) 的一个原函数。𝑓(𝑥) 的不定积分为 ∫ 𝑓(𝑥) 𝑑𝑥 = 𝐹 (𝑥) + 𝐶 其中 𝐶 为任意常数。 易错点： 不定积分结果必须加常数 𝐶 。若题目要求某个特定原函数，则需要利用附加条件...",
    "text": "Integral Calculus Concepts Properties and Computation (一元函数积分学的概念性质和计算) Integral Calculus Concepts Properties and Computation 一元函数积分学的概念性质和计算 微积分 一、不定积分 考研数学 · 一元函数积分学的概念性质和计算 一、不定积分 1. 原函数与不定积分 若 𝐹 ′ (𝑥) = 𝑓(𝑥) 则称 𝐹 (𝑥) 是 𝑓(𝑥) 的一个原函数。𝑓(𝑥) 的不定积分为 ∫ 𝑓(𝑥) 𝑑𝑥 = 𝐹 (𝑥) + 𝐶 其中 𝐶 为任意常数。 易错点： 不定积分结果必须加常数 𝐶 。若题目要求某个特定原函数，则需要利用附加条件确定 𝐶 。 2. 基本积分公式 被积函数 不定积分 𝛼 𝑥𝛼+1 𝑥 𝛼+1 + 𝐶 (𝛼 ≠ −1) 1 𝑥 ln|𝑥| + 𝐶 𝑒𝑥 𝑒𝑥 + 𝐶 𝑎𝑥 𝑎𝑥 ln 𝑎 + 𝐶 sin 𝑥 − cos 𝑥 + 𝐶 cos 𝑥 sin 𝑥 + 𝐶 1 1+𝑥2 arctan 𝑥 + 𝐶 √ 1 arcsin 𝑥 + 𝐶 1−𝑥2"
  },
  {
    ...
    "page": 3,
    "heading": "二、定积分",
    "snippet": "考研数学 · 一元函数积分学的概念性质和计算 二、定积分 1. 定积分定义 定积分 𝑏 ∫ 𝑓(𝑥) 𝑑𝑥 𝑎 表示函数在区间 [𝑎, 𝑏] 上的累积量。若 𝑓(𝑥) ≥ 0，它表示曲线 𝑦 = 𝑓(𝑥) 与 𝑥 轴、直线 𝑥 = 𝑎、𝑥 = 𝑏 围成的 面积。 当上下限交换时： 𝑏 𝑎 ∫ 𝑓(𝑥) 𝑑𝑥 = − ∫ 𝑓(𝑥) 𝑑𝑥 𝑎...",
    "text": "Integral Calculus Concepts Properties and Computation (一元函数积分学的概念性质和计算) Integral Calculus Concepts Properties and Computation 一元函数积分学的概念性质和计算 微积分 二、定积分 考研数学 · 一元函数积分学的概念性质和计算 二、定积分 1. 定积分定义 定积分 𝑏 ∫ 𝑓(𝑥) 𝑑𝑥 𝑎 表示函数在区间 [𝑎, 𝑏] 上的累积量。若 𝑓(𝑥) ≥ 0，它表示曲线 𝑦 = 𝑓(𝑥) 与 𝑥 轴、直线 𝑥 = 𝑎、𝑥 = 𝑏 围成的 面积。 当上下限交换时： 𝑏 𝑎 ∫ 𝑓(𝑥) 𝑑𝑥 = − ∫ 𝑓(𝑥) 𝑑𝑥 𝑎 𝑏 若上下限相同： 𝑎 ∫ 𝑓(𝑥) 𝑑𝑥 = 0 𝑎 2. 牛顿-莱布尼茨公式 若 𝐹 ′ (𝑥) = 𝑓(𝑥)，则 𝑏 ∫ 𝑓(𝑥) 𝑑𝑥 = 𝐹 (𝑏) − 𝐹 (𝑎) 𝑎 这把定积分计算转化为找原函数。 3. 变上限积分 若 𝑥 Φ(𝑥) = ∫ 𝑓(𝑡) 𝑑𝑡 𝑎 且 𝑓 连续，则 Φ′ (𝑥) = 𝑓(𝑥) 若上限是复合函数： 𝑔(𝑥) Φ(𝑥) = ∫ 𝑓(𝑡) 𝑑𝑡 𝑎 则 Φ′ (𝑥) = 𝑓(𝑔(𝑥))𝑔′ (𝑥) 若上下限都含 𝑥： 𝑣(𝑥) Φ(𝑥) = ∫ 𝑓(𝑡) 𝑑𝑡 𝑢(𝑥) 则 Φ′ (𝑥) = 𝑓(𝑣(𝑥))𝑣′ (𝑥) − 𝑓(𝑢(𝑥))𝑢′ (𝑥)"
  },
  {
    ...
    "page": 4,
    "heading": "三、定积分性质",
    "snippet": "考研数学 · 一元函数积分学的概念性质和计算 三、定积分性质 1. 线性与区间可加 𝑏 𝑏 𝑏 ∫ (𝛼𝑓(𝑥) + 𝛽𝑔(𝑥)) 𝑑𝑥 = 𝛼 ∫ 𝑓(𝑥) 𝑑𝑥 + 𝛽 ∫ 𝑔(𝑥) 𝑑𝑥 𝑎 𝑎 𝑎 𝑏 𝑐 𝑏 ∫ 𝑓(𝑥) 𝑑𝑥 = ∫ 𝑓(𝑥) 𝑑𝑥 + ∫ 𝑓(𝑥) 𝑑𝑥 𝑎 𝑎 𝑐 2. 保号性与估值 若 𝑓(𝑥) ≥ 0，...",
    "text": "Integral Calculus Concepts Properties and Computation (一元函数积分学的概念性质和计算) Integral Calculus Concepts Properties and Computation 一元函数积分学的概念性质和计算 微积分 三、定积分性质 考研数学 · 一元函数积分学的概念性质和计算 三、定积分性质 1. 线性与区间可加 𝑏 𝑏 𝑏 ∫ (𝛼𝑓(𝑥) + 𝛽𝑔(𝑥)) 𝑑𝑥 = 𝛼 ∫ 𝑓(𝑥) 𝑑𝑥 + 𝛽 ∫ 𝑔(𝑥) 𝑑𝑥 𝑎 𝑎 𝑎 𝑏 𝑐 𝑏 ∫ 𝑓(𝑥) 𝑑𝑥 = ∫ 𝑓(𝑥) 𝑑𝑥 + ∫ 𝑓(𝑥) 𝑑𝑥 𝑎 𝑎 𝑐 2. 保号性与估值 若 𝑓(𝑥) ≥ 0，则 𝑏 ∫ 𝑓(𝑥) 𝑑𝑥 ≥ 0 𝑎 若 𝑚 ≤ 𝑓(𝑥) ≤ 𝑀 ，则 𝑏 𝑚(𝑏 − 𝑎) ≤ ∫ 𝑓(𝑥) 𝑑𝑥 ≤ 𝑀 (𝑏 − 𝑎) 𝑎 3. 积分中值定理 若 𝑓(𝑥) 在 [𝑎, 𝑏] 上连续，则存在 𝜉 ∈ [𝑎, 𝑏]，使 𝑏 ∫ 𝑓(𝑥) 𝑑𝑥 = 𝑓(𝜉)(𝑏 − 𝑎) 𝑎 这说明连续函数在区间上的积分等于某一点函数值乘以区间长度。 4. 对称性 若 𝑓(𝑥) 为奇函数，则 𝑎 ∫ 𝑓(𝑥) 𝑑𝑥 = 0 −𝑎 若 𝑓(𝑥) 为偶函数，则 𝑎 𝑎 ∫ 𝑓(𝑥) 𝑑𝑥 = 2 ∫ 𝑓(𝑥) 𝑑𝑥 −𝑎 0 对称区间题先判断奇偶性，往往能大幅简化计算。"
  },
  {
    ...
    "page": 5,
    "heading": "四、积分计算方法",
    "snippet": "考研数学 · 一元函数积分学的概念性质和计算 四、积分计算方法 1. 第一类换元法 若被积函数中出现复合结构 𝑓(𝑔(𝑥))𝑔′ (𝑥)，可令 𝑢 = 𝑔(𝑥)： ∫ 𝑓(𝑔(𝑥))𝑔′ (𝑥) 𝑑𝑥 = ∫ 𝑓(𝑢) 𝑑𝑢 2. 第二类换元法 定积分中换元 𝑥 = 𝜑(𝑡) 时，要同步替换上下限： 𝑏 𝛽 ∫ 𝑓(𝑥) 𝑑𝑥 = ∫ 𝑓...",
    "text": "Integral Calculus Concepts Properties and Computation (一元函数积分学的概念性质和计算) Integral Calculus Concepts Properties and Computation 一元函数积分学的概念性质和计算 微积分 四、积分计算方法 考研数学 · 一元函数积分学的概念性质和计算 四、积分计算方法 1. 第一类换元法 若被积函数中出现复合结构 𝑓(𝑔(𝑥))𝑔′ (𝑥)，可令 𝑢 = 𝑔(𝑥)： ∫ 𝑓(𝑔(𝑥))𝑔′ (𝑥) 𝑑𝑥 = ∫ 𝑓(𝑢) 𝑑𝑢 2. 第二类换元法 定积分中换元 𝑥 = 𝜑(𝑡) 时，要同步替换上下限： 𝑏 𝛽 ∫ 𝑓(𝑥) 𝑑𝑥 = ∫ 𝑓(𝜑(𝑡))𝜑′ (𝑡) 𝑑𝑡 𝑎 𝛼 其中 𝜑(𝛼) = 𝑎，𝜑(𝛽) = 𝑏。 3. 分部积分法 由乘积求导公式可得： ∫ 𝑢 𝑑𝑣 = 𝑢𝑣 − ∫ 𝑣 𝑑𝑢 定积分形式为： 𝑏 𝑏 ∫ 𝑢𝑣′ 𝑑𝑥 = [𝑢𝑣]𝑏𝑎 − ∫ 𝑢′ 𝑣 𝑑𝑥 𝑎 𝑎 常用选择顺序可记为：对数、反三角、幂、三角、指数。通常把求导后变简单的函数选作 𝑢。 4. 有理函数积分 有理函数积分常用思路： 1. 若分子次数不低于分母，先作多项式除法。 2. 分母能因式分解时，做部分分式分解。 3. 二次不可约因子常配方转化为反正切或对数。"
  },
  {
    ...
    "page": 6,
    "heading": "五、反常积分与高斯积分",
    "snippet": "考研数学 · 一元函数积分学的概念性质和计算 五、反常积分与高斯积分 1. 反常积分的基本判断 当积分区间无穷或被积函数在区间内有无界点时，定积分需要按反常积分理解。例如： +∞ 𝑏 ∫ 𝑓(𝑥) 𝑑𝑥 = lim ∫ 𝑓(𝑥) 𝑑𝑥 𝑏→+∞ 𝑎 𝑎 若极限存在且有限，则称反常积分收敛；否则发散。 易错点： 必要直觉： 在无穷区间上，若...",
    "text": "Integral Calculus Concepts Properties and Computation (一元函数积分学的概念性质和计算) Integral Calculus Concepts Properties and Computation 一元函数积分学的概念性质和计算 微积分 五、反常积分与高斯积分 考研数学 · 一元函数积分学的概念性质和计算 五、反常积分与高斯积分 1. 反常积分的基本判断 当积分区间无穷或被积函数在区间内有无界点时，定积分需要按反常积分理解。例如： +∞ 𝑏 ∫ 𝑓(𝑥) 𝑑𝑥 = lim ∫ 𝑓(𝑥) 𝑑𝑥 𝑏→+∞ 𝑎 𝑎 若极限存在且有限，则称反常积分收敛；否则发散。 易错点： 必要直觉： 在无穷区间上，若被积函数不趋于 0，反常积分通常不可能收敛。即使趋于 0，也仍 要继续判断衰减速度。 2 2. 𝑒𝑥 在全实轴上的积分 考虑： +∞ 2 ∫ 𝑒𝑥 𝑑𝑥 −∞ 因为对任意实数 𝑥，都有 2 𝑒𝑥 ≥ 1 所以 +∞ +∞ 2 ∫ 𝑒𝑥 𝑑𝑥 ≥ ∫ 1 𝑑𝑥 = +∞ −∞ −∞ 因此该反常积分发散，且发散到 +∞。 2 2 易错点： 常见混淆： 𝑒𝑥 与 𝑒−𝑥 完全不同。前者在无穷远处急剧增大，积分发散；后者在无穷远处快速 衰减，积分收敛。 3. 高斯积分的计算过程 经典高斯积分为： +∞ √ 2 ∫ 𝑒−𝑥 𝑑𝑥 = 𝜋 −∞ 令 +∞ 2 𝐼 =∫ 𝑒−𝑥 𝑑𝑥 −∞ 2 因为 𝑒−𝑥 > 0，所以 𝐼 > 0。两边平方： +∞ +∞ 2 2 𝐼 2 = (∫ 𝑒−𝑥 𝑑𝑥)(∫ 𝑒−𝑦 𝑑𝑦) −∞ −∞ 合成整个平面上的二重积分： 2 2 𝐼 2 = ∫ ∫ 𝑒−(𝑥 +𝑦 ) 𝑑𝑥 𝑑𝑦 ℝ2"
  },
  {
    "id": "doc-eabf82064524-p7",
    "docId": "doc-eabf82064524",
    "title": "Integral Calculus Concepts Properties and Computation (一元函数积分学的概念性质和计算)",
    "category": "微积分",
    "page": 7,
    "heading": "考研数学 · 一元函数积分学的概念性质和计算",
    "snippet": "考研数学 · 一元函数积分学的概念性质和计算 改用极坐标： 𝑥 = 𝑟 cos 𝜃, 𝑦 = 𝑟 sin 𝜃, 𝑑𝑥 𝑑𝑦 = 𝑟 𝑑𝑟 𝑑𝜃 整个平面对应： 0 ≤ 𝑟 < +∞, 0 ≤ 𝜃 ≤ 2𝜋 于是 2𝜋 +∞ 2 𝐼2 = ∫ ∫ 𝑒−𝑟 𝑟 𝑑𝑟 𝑑𝜃 0 0 令 𝑢 = 𝑟2 ，则 𝑟 𝑑𝑟 = 12 𝑑𝑢，因此 +∞ ...",
    "text": "Integral Calculus Concepts Properties and Computation (一元函数积分学的概念性质和计算) Integral Calculus Concepts Properties and Computation 一元函数积分学的概念性质和计算 微积分 考研数学 · 一元函数积分学的概念性质和计算 考研数学 · 一元函数积分学的概念性质和计算 改用极坐标： 𝑥 = 𝑟 cos 𝜃, 𝑦 = 𝑟 sin 𝜃, 𝑑𝑥 𝑑𝑦 = 𝑟 𝑑𝑟 𝑑𝜃 整个平面对应： 0 ≤ 𝑟 < +∞, 0 ≤ 𝜃 ≤ 2𝜋 于是 2𝜋 +∞ 2 𝐼2 = ∫ ∫ 𝑒−𝑟 𝑟 𝑑𝑟 𝑑𝜃 0 0 令 𝑢 = 𝑟2 ，则 𝑟 𝑑𝑟 = 12 𝑑𝑢，因此 +∞ 2 1 +∞ −𝑢 1 ∫ 𝑒−𝑟 𝑟 𝑑𝑟 = ∫ 𝑒 𝑑𝑢 = 0 2 0 2 代回： 2𝜋 1 𝐼2 = ∫ 𝑑𝜃 = 𝜋 0 2 由于 𝐼 > 0，所以 √ 𝐼= 𝜋 记忆路线： 高斯积分的核心路线是：设 𝐼 ，平方成 𝐼 2 ，合并为 ℝ2 上的二重积分，再用极坐标把 𝑥2 + 𝑦2 化为 𝑟2 ，最后利用雅可比因子 𝑟 完成计算。"
  },
  {
    "id": "doc-eabf82064524-p8",
    "docId": "doc-eabf82064524",
    "title": "Integral Calculus Concepts Properties and Computation (一元函数积分学的概念性质和计算)",
    "category": "微积分",
    "page": 8,
    "heading": "六、典型例题",
    "snippet": "考研数学 · 一元函数积分学的概念性质和计算 六、典型例题 例题 1：分部积分 题目 求 ∫ 𝑥𝑒𝑥 𝑑𝑥。 取 𝑢 = 𝑥, 𝑑𝑣 = 𝑒𝑥 𝑑𝑥 则 𝑑𝑢 = 𝑑𝑥, 𝑣 = 𝑒𝑥 由分部积分公式， ∫ 𝑥𝑒𝑥 𝑑𝑥 = 𝑥𝑒𝑥 − ∫ 𝑒𝑥 𝑑𝑥 所以 ∫ 𝑥𝑒𝑥 𝑑𝑥 = 𝑥𝑒𝑥 − 𝑒𝑥 + 𝐶 例题 2：三角函数定积分 𝜋 题...",
    "text": "Integral Calculus Concepts Properties and Computation (一元函数积分学的概念性质和计算) Integral Calculus Concepts Properties and Computation 一元函数积分学的概念性质和计算 微积分 六、典型例题 考研数学 · 一元函数积分学的概念性质和计算 六、典型例题 例题 1：分部积分 题目 求 ∫ 𝑥𝑒𝑥 𝑑𝑥。 取 𝑢 = 𝑥, 𝑑𝑣 = 𝑒𝑥 𝑑𝑥 则 𝑑𝑢 = 𝑑𝑥, 𝑣 = 𝑒𝑥 由分部积分公式， ∫ 𝑥𝑒𝑥 𝑑𝑥 = 𝑥𝑒𝑥 − ∫ 𝑒𝑥 𝑑𝑥 所以 ∫ 𝑥𝑒𝑥 𝑑𝑥 = 𝑥𝑒𝑥 − 𝑒𝑥 + 𝐶 例题 2：三角函数定积分 𝜋 题目 求 ∫ 2 sin3 𝑥 𝑑𝑥。 0 写成 sin3 𝑥 = sin 𝑥(1 − cos2 𝑥) 令 𝑢 = cos 𝑥，则 𝑑𝑢 = − sin 𝑥 𝑑𝑥。当 𝑥 = 0 时 𝑢 = 1，当 𝑥 = 𝜋2 时 𝑢 = 0： 𝜋 2 0 ∫ sin3 𝑥 𝑑𝑥 = ∫ −(1 − 𝑢2 ) 𝑑𝑢 0 1 1 1 𝑢3 2 = ∫ (1 − 𝑢2 ) 𝑑𝑢 = [𝑢 − ] = 0 3 3 0 例题 3：变上限积分求导 sin 𝑥 𝑡2 题目 设 Φ(𝑥) = ∫ 2 𝑒 𝑑𝑡，求 Φ′ (𝑥)。 𝑥 由上下限均含 𝑥 的公式： 2 2 2 Φ′ (𝑥) = 𝑒(sin 𝑥) cos 𝑥 − 𝑒(𝑥 ) ⋅ 2𝑥 即 2 4 Φ′ (𝑥) = 𝑒sin 𝑥 cos 𝑥 − 2𝑥𝑒𝑥"
  },
  {
    ...
    "category": "微积分",
    "page": 1,
    "heading": "考研数学 · 一元函数积分学的应用",
    "snippet": "考研数学 · 一元函数积分学的应用 一元函数积分学的应用 几何应用 · 积分等式不等式 · 物理应用 考研数学复习资料 · Typst PDF 首页速览 𝑏 𝑏 • 核心公式：面积 𝑆 = ∫ |𝑓 − 𝑔|𝑑𝑥；旋转体体积 𝑉 = 𝜋 ∫ (𝑅2 − 𝑟2 )𝑑𝑥。 𝑎 𝑎 • 关键定理：积分中值定理、估值定理和比较性质常用于证明积分等...",
    "text": "Applications of Integral Calculus (一元函数积分学的应用) Applications of Integral Calculus 一元函数积分学的应用 微积分 考研数学 · 一元函数积分学的应用 考研数学 · 一元函数积分学的应用 一元函数积分学的应用 几何应用 · 积分等式不等式 · 物理应用 考研数学复习资料 · Typst PDF 首页速览 𝑏 𝑏 • 核心公式：面积 𝑆 = ∫ |𝑓 − 𝑔|𝑑𝑥；旋转体体积 𝑉 = 𝜋 ∫ (𝑅2 − 𝑟2 )𝑑𝑥。 𝑎 𝑎 • 关键定理：积分中值定理、估值定理和比较性质常用于证明积分等式与不等式。 • 方法抓手：几何题先画区域，物理题先确定微元；证明题常用换元对称、分部积分和构造单调函数。 复习目标： 积分应用的本质是“把微小量累加起来”。几何应用关注面积、体积、弧长和旋转曲面；证明题 关注对称换元、积分中值定理和估值；物理应用关注变力做功、位移、质量和质心。"
  },
  {
    ...
    "page": 2,
    "heading": "一、几何应用",
    "snippet": "考研数学 · 一元函数积分学的应用 一、几何应用 1. 平面图形面积 若 𝑓(𝑥) ≥ 𝑔(𝑥)，则两曲线 𝑦 = 𝑓(𝑥) 与 𝑦 = 𝑔(𝑥) 在 [𝑎, 𝑏] 上围成的面积为 𝑏 𝑆 = ∫ (𝑓(𝑥) − 𝑔(𝑥)) 𝑑𝑥 𝑎 若用 𝑦 作为积分变量，则 𝑑 𝑆 = ∫ (𝑥right (𝑦) − 𝑥left (𝑦)) 𝑑𝑦 𝑐 ...",
    "text": "Applications of Integral Calculus (一元函数积分学的应用) Applications of Integral Calculus 一元函数积分学的应用 微积分 一、几何应用 考研数学 · 一元函数积分学的应用 一、几何应用 1. 平面图形面积 若 𝑓(𝑥) ≥ 𝑔(𝑥)，则两曲线 𝑦 = 𝑓(𝑥) 与 𝑦 = 𝑔(𝑥) 在 [𝑎, 𝑏] 上围成的面积为 𝑏 𝑆 = ∫ (𝑓(𝑥) − 𝑔(𝑥)) 𝑑𝑥 𝑎 若用 𝑦 作为积分变量，则 𝑑 𝑆 = ∫ (𝑥right (𝑦) − 𝑥left (𝑦)) 𝑑𝑦 𝑐 选变量的原则是让上下边界或左右边界表达最简单。 2. 旋转体体积 绕 𝑥 轴旋转，若截面为圆盘或圆环： 𝑏 𝑉 = 𝜋 ∫ (𝑅(𝑥)2 − 𝑟(𝑥)2 ) 𝑑𝑥 𝑎 其中 𝑅(𝑥) 为外半径，𝑟(𝑥) 为内半径。 若使用柱壳法，绕 𝑦 轴旋转时： 𝑏 𝑉 = 2𝜋 ∫ 𝑥𝑓(𝑥) 𝑑𝑥 𝑎 3. 弧长 曲线 𝑦 = 𝑓(𝑥) 在 [𝑎, 𝑏] 上的弧长为 𝑏 𝐿 = ∫ √1 + (𝑓 ′ (𝑥))2 𝑑𝑥 𝑎 参数方程 𝑥 = 𝑥(𝑡), 𝑦 = 𝑦(𝑡) 的弧长为 𝛽 𝐿 = ∫ √(𝑥′ (𝑡))2 + (𝑦′ (𝑡))2 𝑑𝑡 𝛼 4. 旋转曲面面积 曲线 𝑦 = 𝑓(𝑥) ≥ 0 绕 𝑥 轴旋转所得曲面面积为 𝑏 𝑆 = 2𝜋 ∫ 𝑓(𝑥)√1 + (𝑓 ′ (𝑥))2 𝑑𝑥 𝑎 曲线 𝑥 = 𝑔(𝑦) ≥ 0 绕 𝑦 轴旋转所得曲面面积为 𝑑 𝑆 = 2𝜋 ∫ 𝑔(𝑦)√1 + (𝑔′ (𝑦))2 𝑑𝑦 𝑐"
  },
  {
    ...
    "category": "微积分",
    "page": 3,
    "heading": "二、积分等式与不等式证明",
    "snippet": "考研数学 · 一元函数积分学的应用 二、积分等式与不等式证明 1. 对称换元 在 [𝑎, 𝑏] 上常用换元 𝑥=𝑎+𝑏−𝑡 得到 𝑏 𝑏 ∫ 𝑓(𝑥) 𝑑𝑥 = ∫ 𝑓(𝑎 + 𝑏 − 𝑥) 𝑑𝑥 𝑎 𝑎 特别地， 𝑎 𝑎 ∫ 𝑓(𝑥) 𝑑𝑥 = ∫ 𝑓(𝑎 − 𝑥) 𝑑𝑥 0 0 这种方法常用于构造两个积分相加。 2. 周期性与奇偶性 ...",
    "text": "Applications of Integral Calculus (一元函数积分学的应用) Applications of Integral Calculus 一元函数积分学的应用 微积分 二、积分等式与不等式证明 考研数学 · 一元函数积分学的应用 二、积分等式与不等式证明 1. 对称换元 在 [𝑎, 𝑏] 上常用换元 𝑥=𝑎+𝑏−𝑡 得到 𝑏 𝑏 ∫ 𝑓(𝑥) 𝑑𝑥 = ∫ 𝑓(𝑎 + 𝑏 − 𝑥) 𝑑𝑥 𝑎 𝑎 特别地， 𝑎 𝑎 ∫ 𝑓(𝑥) 𝑑𝑥 = ∫ 𝑓(𝑎 − 𝑥) 𝑑𝑥 0 0 这种方法常用于构造两个积分相加。 2. 周期性与奇偶性 若 𝑓(𝑥) 周期为 𝑇 ，则 𝑎+𝑇 𝑇 ∫ 𝑓(𝑥) 𝑑𝑥 = ∫ 𝑓(𝑥) 𝑑𝑥 𝑎 0 若积分区间对称，优先判断奇偶性。 3. 估值不等式 若 𝑚 ≤ 𝑓(𝑥) ≤ 𝑀 ，则 𝑏 𝑚(𝑏 − 𝑎) ≤ ∫ 𝑓(𝑥) 𝑑𝑥 ≤ 𝑀 (𝑏 − 𝑎) 𝑎 若 𝑓(𝑥) ≥ 0 且 𝑔(𝑥) ≥ ℎ(𝑥)，则 𝑏 𝑏 ∫ 𝑓(𝑥)𝑔(𝑥) 𝑑𝑥 ≥ ∫ 𝑓(𝑥)ℎ(𝑥) 𝑑𝑥 𝑎 𝑎 4. 积分中值定理 若 𝑓 连续，𝑔 不变号，则存在 𝜉 ∈ [𝑎, 𝑏]，使 𝑏 𝑏 ∫ 𝑓(𝑥)𝑔(𝑥) 𝑑𝑥 = 𝑓(𝜉) ∫ 𝑔(𝑥) 𝑑𝑥 𝑎 𝑎 它常用于证明某个积分等于区间内某点函数值乘以权重积分。"
  },
  {
    ...
    "page": 4,
    "heading": "三、物理应用",
    "snippet": "考研数学 · 一元函数积分学的应用 三、物理应用 1. 变力做功 若质点沿直线从 𝑥 = 𝑎 移动到 𝑥 = 𝑏，受到变力 𝐹 (𝑥)，则做功为 𝑏 𝑊 = ∫ 𝐹 (𝑥) 𝑑𝑥 𝑎 弹簧力 𝐹 = 𝑘𝑥 从 0 拉到 𝑎 所做功为 𝑎 1 𝑊 = ∫ 𝑘𝑥 𝑑𝑥 = 𝑘𝑎2 0 2 2. 位移与路程 若速度为 𝑣(𝑡)，则位移为 𝑏 𝑠...",
    "text": "Applications of Integral Calculus (一元函数积分学的应用) Applications of Integral Calculus 一元函数积分学的应用 微积分 三、物理应用 考研数学 · 一元函数积分学的应用 三、物理应用 1. 变力做功 若质点沿直线从 𝑥 = 𝑎 移动到 𝑥 = 𝑏，受到变力 𝐹 (𝑥)，则做功为 𝑏 𝑊 = ∫ 𝐹 (𝑥) 𝑑𝑥 𝑎 弹簧力 𝐹 = 𝑘𝑥 从 0 拉到 𝑎 所做功为 𝑎 1 𝑊 = ∫ 𝑘𝑥 𝑑𝑥 = 𝑘𝑎2 0 2 2. 位移与路程 若速度为 𝑣(𝑡)，则位移为 𝑏 𝑠 = ∫ 𝑣(𝑡) 𝑑𝑡 𝑎 路程为 𝑏 𝑙 = ∫ |𝑣(𝑡)| 𝑑𝑡 𝑎 如果速度有正负变化，求路程时必须按零点分段。 3. 质量与质心 一维细杆在线密度 𝜌(𝑥) 下，质量为 𝑏 𝑚 = ∫ 𝜌(𝑥) 𝑑𝑥 𝑎 质心坐标为 𝑏 ∫ 𝑥𝜌(𝑥) 𝑑𝑥 𝑎 𝑥𝑐 = 𝑏 ∫ 𝜌(𝑥) 𝑑𝑥 𝑎 若密度均匀，则 𝜌 可约去。"
  },
  {
    "id": "doc-30e6a86d0f61-p5",
    "docId": "doc-30e6a86d0f61",
    "title": "Applications of Integral Calculus (一元函数积分学的应用)",
    "category": "微积分",
    "page": 5,
    "heading": "四、典型例题",
    "snippet": "考研数学 · 一元函数积分学的应用 四、典型例题 例题 1：两曲线围成面积 题目 求 𝑦 = 𝑥 与 𝑦 = 𝑥2 围成图形的面积。 交点由 𝑥 = 𝑥2 得 𝑥 = 0, 1。在 [0, 1] 上有 𝑥 ≥ 𝑥2 ，所以面积为 1 𝑆 = ∫ (𝑥 − 𝑥2 ) 𝑑𝑥 0 1 𝑥2 𝑥3 1 1 1 =[ − ] = − = 2 3 2...",
    "text": "Applications of Integral Calculus (一元函数积分学的应用) Applications of Integral Calculus 一元函数积分学的应用 微积分 四、典型例题 考研数学 · 一元函数积分学的应用 四、典型例题 例题 1：两曲线围成面积 题目 求 𝑦 = 𝑥 与 𝑦 = 𝑥2 围成图形的面积。 交点由 𝑥 = 𝑥2 得 𝑥 = 0, 1。在 [0, 1] 上有 𝑥 ≥ 𝑥2 ，所以面积为 1 𝑆 = ∫ (𝑥 − 𝑥2 ) 𝑑𝑥 0 1 𝑥2 𝑥3 1 1 1 =[ − ] = − = 2 3 2 3 6 0 例题 2：旋转体体积 √ 题目 求曲线 𝑦 = 𝑥，0 ≤ 𝑥 ≤ 1 与 𝑥 轴围成区域绕 𝑥 轴旋转所得体积。 √ 绕 𝑥 轴用圆盘法，半径为 𝑅(𝑥) = 𝑥： 1 √ 2 𝑉 = 𝜋 ∫ ( 𝑥) 𝑑𝑥 0 1 𝜋 = 𝜋 ∫ 𝑥 𝑑𝑥 = 0 2 例题 3：对称换元证明等式 1 1 题目 证明 ∫ 𝑓(𝑥) 𝑑𝑥 = ∫ 𝑓(1 − 𝑥) 𝑑𝑥。 0 0 右端令 𝑢=1−𝑥 则 𝑑𝑢 = − 𝑑𝑥。当 𝑥 = 0 时 𝑢 = 1，当 𝑥 = 1 时 𝑢 = 0，所以 1 0 ∫ 𝑓(1 − 𝑥) 𝑑𝑥 = ∫ 𝑓(𝑢)(− 𝑑𝑢) 0 1 1 1 = ∫ 𝑓(𝑢) 𝑑𝑢 = ∫ 𝑓(𝑥) 𝑑𝑥 0 0 例题 4：变力做功 题目 弹簧劲度系数为 𝑘，把弹簧从自然长度拉长到 𝑎，求外力做功。 拉长 𝑥 时所需外力为 𝐹 (𝑥) = 𝑘𝑥。做功为"
  },
  {
    "id": "doc-30e6a86d0f61-p6",
    "docId": "doc-30e6a86d0f61",
    "title": "Applications of Integral Calculus (一元函数积分学的应用)",
    "category": "微积分",
    "page": 6,
    "heading": "考研数学 · 一元函数积分学的应用",
    "snippet": "考研数学 · 一元函数积分学的应用 𝑎 𝑊 = ∫ 𝑘𝑥 𝑑𝑥 0 1 = 𝑘𝑎2 2",
    "text": "Applications of Integral Calculus (一元函数积分学的应用) Applications of Integral Calculus 一元函数积分学的应用 微积分 考研数学 · 一元函数积分学的应用 考研数学 · 一元函数积分学的应用 𝑎 𝑊 = ∫ 𝑘𝑥 𝑑𝑥 0 1 = 𝑘𝑎2 2"
  },
  {
    ...
    "snippet": "考研数学 · 多元函数微分学 多元函数微分学 偏导数 · 全微分 · 方向导数 · 极值与拉格朗日乘数 考研数学复习资料 · Typst PDF 首页速览 • 核心公式：𝑑𝑧 = 𝑓𝑥 𝑑𝑥 + 𝑓𝑦 𝑑𝑦 ，𝐷𝑙 𝑓 = ∇𝑓 ⋅ 𝑒𝑙 ，切平面 𝑧 − 𝑧0 = 𝑓𝑥(𝑥0 ,𝑦0 ) (𝑥 − 𝑥0 ) + 𝑓𝑦(𝑥0 ,𝑦0 ) ...",
    "text": "Multivariable Differential Calculus (多元函数微分学) Multivariable Differential Calculus 多元函数微分学 微积分 考研数学 · 多元函数微分学 考研数学 · 多元函数微分学 多元函数微分学 偏导数 · 全微分 · 方向导数 · 极值与拉格朗日乘数 考研数学复习资料 · Typst PDF 首页速览 • 核心公式：𝑑𝑧 = 𝑓𝑥 𝑑𝑥 + 𝑓𝑦 𝑑𝑦 ，𝐷𝑙 𝑓 = ∇𝑓 ⋅ 𝑒𝑙 ，切平面 𝑧 − 𝑧0 = 𝑓𝑥(𝑥0 ,𝑦0 ) (𝑥 − 𝑥0 ) + 𝑓𝑦(𝑥0 ,𝑦0 ) (𝑦 − 𝑦0 )。 • 关键定理：可微推出连续且偏导存在；极值必要条件为 𝑓𝑥 = 𝑓𝑦 = 0；条件极值用 Lagrange 乘数法。 • 方法抓手：先区分偏导存在、连续、可微；极值题按驻点、边界、约束三类检查。 复习目标： 多元函数微分学研究多变量函数的局部变化。考研中常见考点包括二元函数极限与连续、偏导 数、全微分、复合函数求导、隐函数求导、方向导数与梯度、无条件极值和条件极值。"
  },
  {
    ...
    "page": 2,
    "heading": "一、多元函数与极限连续",
    "snippet": "考研数学 · 多元函数微分学 一、多元函数与极限连续 1. 多元函数 二元函数通常写为 𝑧 = 𝑓(𝑥, 𝑦) 其中 (𝑥, 𝑦) 属于定义域 𝐷。定义域常由分母不为零、偶次根号非负、对数真数大于零等条件共同决定。 2. 二元函数极限 若当点 (𝑥, 𝑦) 以任意方式趋于 (𝑥0 , 𝑦0 ) 时，𝑓(𝑥, 𝑦) 都趋于同一常数 𝐴，则 ...",
    "text": "Multivariable Differential Calculus (多元函数微分学) Multivariable Differential Calculus 多元函数微分学 微积分 一、多元函数与极限连续 考研数学 · 多元函数微分学 一、多元函数与极限连续 1. 多元函数 二元函数通常写为 𝑧 = 𝑓(𝑥, 𝑦) 其中 (𝑥, 𝑦) 属于定义域 𝐷。定义域常由分母不为零、偶次根号非负、对数真数大于零等条件共同决定。 2. 二元函数极限 若当点 (𝑥, 𝑦) 以任意方式趋于 (𝑥0 , 𝑦0 ) 时，𝑓(𝑥, 𝑦) 都趋于同一常数 𝐴，则 lim 𝑓(𝑥, 𝑦) = 𝐴 (𝑥,𝑦)→(𝑥0 ,𝑦0 ) 多元极限的难点在于“路径任意”。若沿两条不同路径得到不同极限，则原极限不存在。 3. 常用判定方法 1. 直接代入：若函数在该点连续，直接代入。 2. 路径法：取 𝑦 = 𝑘𝑥、𝑦 = 𝑥2 、极坐标等路径寻找反例。 3. 夹逼法：把表达式估计到只与 𝑟 = √𝑥2 + 𝑦2 有关。 4. 极坐标法：令 𝑥 = 𝑟 cos 𝜃，𝑦 = 𝑟 sin 𝜃，考察 𝑟 → 0 时是否与 𝜃 无关。 易错点： 沿任意直线极限相同，不一定能推出二元极限存在。若怀疑不存在，还要尝试曲线路径；若证明 存在，通常用夹逼或极坐标估计。 4. 连续性 若 lim 𝑓(𝑥, 𝑦) = 𝑓(𝑥0 , 𝑦0 ) (𝑥,𝑦)→(𝑥0 ,𝑦0 ) 则 𝑓 在该点连续。多元初等函数在其定义域内部连续。"
  },
  {
  ...
  },
  {
    ...
    "category": "微积分",
    "page": 4,
    "heading": "三、复合函数与隐函数求导",
    "snippet": "考研数学 · 多元函数微分学 三、复合函数与隐函数求导 1. 复合函数求导 若 𝑧 = 𝑓(𝑢, 𝑣), 𝑢 = 𝑢(𝑥, 𝑦), 𝑣 = 𝑣(𝑥, 𝑦) 则 𝜕𝑧 𝜕𝑢 𝜕𝑣 = 𝑓𝑢 + 𝑓𝑣 𝜕𝑥 𝜕𝑥 𝜕𝑥 𝜕𝑧 𝜕𝑢 𝜕𝑣 = 𝑓𝑢 + 𝑓𝑣 𝜕𝑦 𝜕𝑦 𝜕𝑦 链式法则的本质是沿每一条变量依赖路径求导后相加。 2. 一元参数复合...",
    "text": "Multivariable Differential Calculus (多元函数微分学) Multivariable Differential Calculus 多元函数微分学 微积分 三、复合函数与隐函数求导 考研数学 · 多元函数微分学 三、复合函数与隐函数求导 1. 复合函数求导 若 𝑧 = 𝑓(𝑢, 𝑣), 𝑢 = 𝑢(𝑥, 𝑦), 𝑣 = 𝑣(𝑥, 𝑦) 则 𝜕𝑧 𝜕𝑢 𝜕𝑣 = 𝑓𝑢 + 𝑓𝑣 𝜕𝑥 𝜕𝑥 𝜕𝑥 𝜕𝑧 𝜕𝑢 𝜕𝑣 = 𝑓𝑢 + 𝑓𝑣 𝜕𝑦 𝜕𝑦 𝜕𝑦 链式法则的本质是沿每一条变量依赖路径求导后相加。 2. 一元参数复合 若 𝑧 = 𝑓(𝑥, 𝑦), 𝑥 = 𝑥(𝑡), 𝑦 = 𝑦(𝑡) 则 𝑑𝑧 𝑑𝑥 𝑑𝑦 = 𝑓𝑥 + 𝑓𝑦 𝑑𝑡 𝑑𝑡 𝑑𝑡 3. 隐函数求导 若 𝐹 (𝑥, 𝑦) = 0 确定 𝑦 = 𝑦(𝑥)，则 𝐹 𝑦′ = − 𝑥 (𝐹𝑦 ≠ 0) 𝐹𝑦 若 𝐹 (𝑥, 𝑦, 𝑧) = 0 确定 𝑧 = 𝑧(𝑥, 𝑦)，则 𝐹 𝐹𝑦 𝑧𝑥 = − 𝑥 , 𝑧𝑦 = − (𝐹𝑧 ≠ 0) 𝐹𝑧 𝐹𝑧"
  },
  {
    ...
    "page": 5,
    "heading": "四、方向导数与梯度",
    "snippet": "考研数学 · 多元函数微分学 四、方向导数与梯度 1. 方向导数 设单位方向向量为 𝑒 = (cos 𝛼, cos 𝛽) 函数 𝑓(𝑥, 𝑦) 在点 𝑃 沿方向 𝑒 的方向导数为 𝜕𝑓 = 𝑓𝑥 cos 𝛼 + 𝑓𝑦 cos 𝛽 𝜕𝑒 也可写成 𝜕𝑓 = grad 𝑓 ⋅ 𝑒 𝜕𝑒 2. 梯度 梯度为 grad 𝑓 = (𝑓𝑥 , 𝑓𝑦 ...",
    "text": "Multivariable Differential Calculus (多元函数微分学) Multivariable Differential Calculus 多元函数微分学 微积分 四、方向导数与梯度 考研数学 · 多元函数微分学 四、方向导数与梯度 1. 方向导数 设单位方向向量为 𝑒 = (cos 𝛼, cos 𝛽) 函数 𝑓(𝑥, 𝑦) 在点 𝑃 沿方向 𝑒 的方向导数为 𝜕𝑓 = 𝑓𝑥 cos 𝛼 + 𝑓𝑦 cos 𝛽 𝜕𝑒 也可写成 𝜕𝑓 = grad 𝑓 ⋅ 𝑒 𝜕𝑒 2. 梯度 梯度为 grad 𝑓 = (𝑓𝑥 , 𝑓𝑦 ) 它的方向是函数增长最快的方向，模长为最大方向导数： 𝜕𝑓 max = |grad 𝑓| 𝜕𝑒 若方向与梯度垂直，则方向导数为零。"
  },
  {
    ...
    "page": 6,
    "heading": "五、几何应用",
    "snippet": "考研数学 · 多元函数微分学 五、几何应用 1. 曲面的切平面 若曲面为 𝑧 = 𝑓(𝑥, 𝑦) 在点 (𝑥0 , 𝑦0 , 𝑧0 ) 处的切平面为 𝑧 − 𝑧0 = 𝑓𝑥(𝑥0 ,𝑦0 ) (𝑥 − 𝑥0 ) + 𝑓𝑦(𝑥0 ,𝑦0 ) (𝑦 − 𝑦0 ) 2. 隐式曲面的切平面 若曲面为 𝐹 (𝑥, 𝑦, 𝑧) = 0 则法向量为 𝑛...",
    "text": "Multivariable Differential Calculus (多元函数微分学) Multivariable Differential Calculus 多元函数微分学 微积分 五、几何应用 考研数学 · 多元函数微分学 五、几何应用 1. 曲面的切平面 若曲面为 𝑧 = 𝑓(𝑥, 𝑦) 在点 (𝑥0 , 𝑦0 , 𝑧0 ) 处的切平面为 𝑧 − 𝑧0 = 𝑓𝑥(𝑥0 ,𝑦0 ) (𝑥 − 𝑥0 ) + 𝑓𝑦(𝑥0 ,𝑦0 ) (𝑦 − 𝑦0 ) 2. 隐式曲面的切平面 若曲面为 𝐹 (𝑥, 𝑦, 𝑧) = 0 则法向量为 𝑛 = (𝐹𝑥 , 𝐹𝑦 , 𝐹𝑧 ) 在点 𝑃0 (𝑥0 , 𝑦0 , 𝑧0 ) 处的切平面为 𝐹𝑥(𝑃0 ) (𝑥 − 𝑥0 ) + 𝐹𝑦(𝑃0 ) (𝑦 − 𝑦0 ) + 𝐹𝑧(𝑃0 ) (𝑧 − 𝑧0 ) = 0"
  },
  {
    "id": "doc-87b9b66a0f76-p7",
    "docId": "doc-87b9b66a0f76",
    "title": "Multivariable Differential Calculus (多元函数微分学)",
    "category": "微积分",
    "page": 7,
    "heading": "六、多元函数极值",
    "snippet": "考研数学 · 多元函数微分学 六、多元函数极值 1. 无条件极值 若 𝑧 = 𝑓(𝑥, 𝑦) 在内部点取得极值，且偏导存在，则必要条件为 𝑓𝑥 = 0, 𝑓𝑦 = 0 求出驻点后，用二阶偏导判别。设 𝐴 = 𝑓𝑥𝑥 , 𝐵 = 𝑓𝑥𝑦 , 𝐶 = 𝑓𝑦𝑦 , Δ = 𝐴𝐶 − 𝐵2 则： 条件 结论 Δ > 0, 𝐴 > 0 极小值 Δ ...",
    "text": "Multivariable Differential Calculus (多元函数微分学) Multivariable Differential Calculus 多元函数微分学 微积分 六、多元函数极值 考研数学 · 多元函数微分学 六、多元函数极值 1. 无条件极值 若 𝑧 = 𝑓(𝑥, 𝑦) 在内部点取得极值，且偏导存在，则必要条件为 𝑓𝑥 = 0, 𝑓𝑦 = 0 求出驻点后，用二阶偏导判别。设 𝐴 = 𝑓𝑥𝑥 , 𝐵 = 𝑓𝑥𝑦 , 𝐶 = 𝑓𝑦𝑦 , Δ = 𝐴𝐶 − 𝐵2 则： 条件 结论 Δ > 0, 𝐴 > 0 极小值 Δ > 0, 𝐴 < 0 极大值 Δ<0 不是极值，是鞍点 Δ=0 判别法失效，需要另行讨论 2. 条件极值 在约束 𝜑(𝑥, 𝑦) = 0 下求 𝑓(𝑥, 𝑦) 的极值，常用拉格朗日乘数法： 𝐿(𝑥, 𝑦, 𝜆) = 𝑓(𝑥, 𝑦) + 𝜆𝜑(𝑥, 𝑦) 解方程组 𝐿𝑥 = 0, 𝐿𝑦 = 0, 𝜑(𝑥, 𝑦) = 0 即可得到候选点，再比较函数值。 易错点： 拉格朗日乘数法给出的是候选点。若题目区域有边界或约束曲线有端点，还需要比较边界、端点 或不可导点。"
  },
  {
    "id": "doc-87b9b66a0f76-p8",
    "docId": "doc-87b9b66a0f76",
    "title": "Multivariable Differential Calculus (多元函数微分学)",
    "category": "微积分",
    "page": 8,
    "heading": "七、典型例题",
    "snippet": "考研数学 · 多元函数微分学 七、典型例题 例题 1：二元极限不存在 题目 判断 lim(𝑥,𝑦)→(0,0) 𝑥2𝑥𝑦 +𝑦2 是否存在。 沿路径 𝑦 = 𝑥，有 𝑥𝑦 𝑥2 1 2 2 = 2 = 𝑥 +𝑦 2𝑥 2 沿路径 𝑦 = 0，有 𝑥𝑦 =0 𝑥2 + 𝑦 2 两条路径极限不同，所以原极限不存在。 例题 2：全微分 题目 设...",
    "text": "Multivariable Differential Calculus (多元函数微分学) Multivariable Differential Calculus 多元函数微分学 微积分 七、典型例题 考研数学 · 多元函数微分学 七、典型例题 例题 1：二元极限不存在 题目 判断 lim(𝑥,𝑦)→(0,0) 𝑥2𝑥𝑦 +𝑦2 是否存在。 沿路径 𝑦 = 𝑥，有 𝑥𝑦 𝑥2 1 2 2 = 2 = 𝑥 +𝑦 2𝑥 2 沿路径 𝑦 = 0，有 𝑥𝑦 =0 𝑥2 + 𝑦 2 两条路径极限不同，所以原极限不存在。 例题 2：全微分 题目 设 𝑧 = 𝑥2 𝑦 + 𝑒𝑥𝑦 ，求 𝑑𝑧 。 先求偏导： 𝑧𝑥 = 2𝑥𝑦 + 𝑦𝑒𝑥𝑦 𝑧𝑦 = 𝑥2 + 𝑥𝑒𝑥𝑦 所以 𝑑𝑧 = (2𝑥𝑦 + 𝑦𝑒𝑥𝑦 ) 𝑑𝑥 + (𝑥2 + 𝑥𝑒𝑥𝑦 ) 𝑑𝑦 例题 3：切平面 题目 求曲面 𝑧 = 𝑥2 + 𝑦2 在点 (1, 2, 5) 处的切平面。 有 𝑓𝑥 = 2𝑥, 𝑓𝑦 = 2𝑦 在 (1, 2) 处： 𝑓𝑥 = 2, 𝑓𝑦 = 4 切平面为 𝑧 − 5 = 2(𝑥 − 1) + 4(𝑦 − 2) 即 𝑧 = 2𝑥 + 4𝑦 − 5 例题 4：拉格朗日乘数法 题目 在约束 𝑥2 + 𝑦2 = 1 下，求 𝑓(𝑥, 𝑦) = 𝑥 + 𝑦 的最大值和最小值。 构造"
  },
  {
    "id": "doc-87b9b66a0f76-p9",
    "docId": "doc-87b9b66a0f76",
    "title": "Multivariable Differential Calculus (多元函数微分学)",
    "category": "微积分",
    "page": 9,
    "heading": "考研数学 · 多元函数微分学",
    "snippet": "考研数学 · 多元函数微分学 𝐿 = 𝑥 + 𝑦 + 𝜆(𝑥2 + 𝑦2 − 1) 方程组为 𝐿𝑥 = 1 + 2𝜆𝑥 = 0 𝐿𝑦 = 1 + 2𝜆𝑦 = 0 𝑥2 + 𝑦 2 = 1 由前两式得 𝑥 = 𝑦。代入约束： 2𝑥2 = 1 所以 1 1 𝑥=𝑦= √ 或 𝑥 = 𝑦 = −√ 2 2 对应函数值为 √ √ 2 和 − 2 ...",
    "text": "Multivariable Differential Calculus (多元函数微分学) Multivariable Differential Calculus 多元函数微分学 微积分 考研数学 · 多元函数微分学 考研数学 · 多元函数微分学 𝐿 = 𝑥 + 𝑦 + 𝜆(𝑥2 + 𝑦2 − 1) 方程组为 𝐿𝑥 = 1 + 2𝜆𝑥 = 0 𝐿𝑦 = 1 + 2𝜆𝑦 = 0 𝑥2 + 𝑦 2 = 1 由前两式得 𝑥 = 𝑦。代入约束： 2𝑥2 = 1 所以 1 1 𝑥=𝑦= √ 或 𝑥 = 𝑦 = −√ 2 2 对应函数值为 √ √ 2 和 − 2 √ √ 因此最大值为 2，最小值为 − 2。"
  },
  {
    ...
    "snippet": "考研数学 · 二重积分 二重积分总结讲解 定义 · 积分区域 · 换序 · 极坐标 · 应用题型 考研数学复习资料 · Typst PDF 首页速览 • 核心公式：直角坐标 ∬ 𝑓(𝑥, 𝑦)𝑑𝑥𝑑𝑦 ；极坐标 ∬ 𝑓(𝑟 cos 𝜃, 𝑟 sin 𝜃)𝑟𝑑𝑟𝑑𝜃。 𝐷 𝐷 • 关键定理：对称区域上，奇函数积分为 0；𝑚𝑆 ≤ ∬ 𝑓𝑑𝜎...",
    "text": "Double Integral Methods (二重积分计算方法) Double Integral Methods 二重积分计算方法 微积分 定义 · 积分区域 · 换序 · 极坐标 · 应用题型 考研数学 · 二重积分 二重积分总结讲解 定义 · 积分区域 · 换序 · 极坐标 · 应用题型 考研数学复习资料 · Typst PDF 首页速览 • 核心公式：直角坐标 ∬ 𝑓(𝑥, 𝑦)𝑑𝑥𝑑𝑦 ；极坐标 ∬ 𝑓(𝑟 cos 𝜃, 𝑟 sin 𝜃)𝑟𝑑𝑟𝑑𝜃。 𝐷 𝐷 • 关键定理：对称区域上，奇函数积分为 0；𝑚𝑆 ≤ ∬ 𝑓𝑑𝜎 ≤ 𝑀 𝑆 ；连续时有积分中值定理。 𝐷 • 方法抓手：先画 𝐷，再决定先 𝑥 后 𝑦 、先 𝑦 后 𝑥 或极坐标；边界含圆、扇形优先极坐标。 复习目标： 二重积分的核心不是“算两次定积分”，而是把平面区域 𝐷 看清楚，再选择最方便的坐标和积 分次序。考研常考：积分区域识别、交换积分次序、极坐标变换、利用对称性、面积体积和物理应用。"
  },
  {
  ...
  },
  {
    ...
    "page": 3,
    "heading": "考研数学 · 二重积分",
    "snippet": "考研数学 · 二重积分 𝐼𝑂 = ∬ (𝑥2 + 𝑦2 )𝜌(𝑥, 𝑦)𝑑𝜎 𝐷",
    "text": "Double Integral Methods (二重积分计算方法) Double Integral Methods 二重积分计算方法 微积分 考研数学 · 二重积分 考研数学 · 二重积分 𝐼𝑂 = ∬ (𝑥2 + 𝑦2 )𝜌(𝑥, 𝑦)𝑑𝜎 𝐷"
  },
  {
    ...
    "page": 4,
    "heading": "二、二重积分的基本性质",
    "snippet": "考研数学 · 二重积分 二、二重积分的基本性质 1. 线性性质 ∬ [𝑎𝑓(𝑥, 𝑦) + 𝑏𝑔(𝑥, 𝑦)]𝑑𝜎 = 𝑎 ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 + 𝑏 ∬ 𝑔(𝑥, 𝑦)𝑑𝜎 𝐷 𝐷 𝐷 2. 区域可加性 若 𝐷 = 𝐷1 ∪ 𝐷2 ，且 𝐷1 与 𝐷2 仅在边界上可能相交，则 ∬ 𝑓𝑑𝜎 = ∬ 𝑓𝑑𝜎 + ∬ 𝑓𝑑𝜎 𝐷 𝐷1 𝐷...",
    "text": "Double Integral Methods (二重积分计算方法) Double Integral Methods 二重积分计算方法 微积分 二、二重积分的基本性质 考研数学 · 二重积分 二、二重积分的基本性质 1. 线性性质 ∬ [𝑎𝑓(𝑥, 𝑦) + 𝑏𝑔(𝑥, 𝑦)]𝑑𝜎 = 𝑎 ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 + 𝑏 ∬ 𝑔(𝑥, 𝑦)𝑑𝜎 𝐷 𝐷 𝐷 2. 区域可加性 若 𝐷 = 𝐷1 ∪ 𝐷2 ，且 𝐷1 与 𝐷2 仅在边界上可能相交，则 ∬ 𝑓𝑑𝜎 = ∬ 𝑓𝑑𝜎 + ∬ 𝑓𝑑𝜎 𝐷 𝐷1 𝐷2 这个性质常用于把复杂区域拆成几个简单区域。 3. 保号性与估值 若在 𝐷 上 𝑓(𝑥, 𝑦) ≥ 0，则 ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 ≥ 0 𝐷 若在 𝐷 上 𝑚 ≤ 𝑓(𝑥, 𝑦) ≤ 𝑀 且 𝐷 的面积为 𝑆𝐷 ，则 𝑚𝑆𝐷 ≤ ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 ≤ 𝑀 𝑆𝐷 𝐷 4. 中值定理 若 𝑓(𝑥, 𝑦) 在有界闭区域 𝐷 上连续，且 𝐷 连通，则存在一点 (𝜉, 𝜂) ∈ 𝐷，使得 ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 = 𝑓(𝜉, 𝜂)𝑆𝐷 𝐷 其中 𝑆𝐷 是区域 𝐷 的面积。"
  },
  {
  ...
  },
  {
    ...
    "page": 6,
    "heading": "考研数学 · 二重积分",
    "snippet": "考研数学 · 二重积分 矩形区域 𝑎 ≤ 𝑥 ≤ 𝑏, 𝑐 ≤ 𝑦 ≤ 𝑑 两种次序都简单 复合区域 分成多个简单区域 边界分段、上下关系变化",
    "text": "Double Integral Methods (二重积分计算方法) Double Integral Methods 二重积分计算方法 微积分 考研数学 · 二重积分 考研数学 · 二重积分 矩形区域 𝑎 ≤ 𝑥 ≤ 𝑏, 𝑐 ≤ 𝑦 ≤ 𝑑 两种次序都简单 复合区域 分成多个简单区域 边界分段、上下关系变化"
  },
  {
    ...
    "page": 7,
    "heading": "四、交换积分次序",
    "snippet": "考研数学 · 二重积分 四、交换积分次序 交换积分次序是二重积分的高频题型。它的本质是：原积分给出了区域 𝐷 的一种描述，换序就是把同一个 𝐷 改写成另一种描述。 1. 从 𝑑𝑦 𝑑𝑥 改成 𝑑𝑥 𝑑𝑦 已知 𝑏 𝜑2 (𝑥) ∫ ∫ 𝑓(𝑥, 𝑦)𝑑𝑦 𝑑𝑥 𝑎 𝜑1 (𝑥) 表示区域 𝐷 = {(𝑥, 𝑦) | 𝑎 ≤ 𝑥 ≤ 𝑏, ...",
    "text": "Double Integral Methods (二重积分计算方法) Double Integral Methods 二重积分计算方法 微积分 四、交换积分次序 考研数学 · 二重积分 四、交换积分次序 交换积分次序是二重积分的高频题型。它的本质是：原积分给出了区域 𝐷 的一种描述，换序就是把同一个 𝐷 改写成另一种描述。 1. 从 𝑑𝑦 𝑑𝑥 改成 𝑑𝑥 𝑑𝑦 已知 𝑏 𝜑2 (𝑥) ∫ ∫ 𝑓(𝑥, 𝑦)𝑑𝑦 𝑑𝑥 𝑎 𝜑1 (𝑥) 表示区域 𝐷 = {(𝑥, 𝑦) | 𝑎 ≤ 𝑥 ≤ 𝑏, 𝜑1 (𝑥) ≤ 𝑦 ≤ 𝜑2 (𝑥)} 换序步骤： 1. 先画出 𝑥 = 𝑎、𝑥 = 𝑏、𝑦 = 𝜑1 (𝑥)、𝑦 = 𝜑2 (𝑥) 围成的区域。 2. 求整体 𝑦 的范围 𝑐 ≤ 𝑦 ≤ 𝑑。 3. 固定 𝑦 作水平线，找 𝑥 的左界和右界。 𝑑 𝜓 (𝑦) 4. 写成 ∫ ∫ 2 𝑓(𝑥, 𝑦)𝑑𝑥 𝑑𝑦。 𝑐 𝜓1 (𝑦) 2. 从 𝑑𝑥 𝑑𝑦 改成 𝑑𝑦 𝑑𝑥 已知 𝑑 𝜓2 (𝑦) ∫ ∫ 𝑓(𝑥, 𝑦)𝑑𝑥 𝑑𝑦 𝑐 𝜓1 (𝑦) 表示区域 𝐷 = {(𝑥, 𝑦) | 𝑐 ≤ 𝑦 ≤ 𝑑, 𝜓1 (𝑦) ≤ 𝑥 ≤ 𝜓2 (𝑦)} 换序步骤： 1. 画出 𝑦 = 𝑐、𝑦 = 𝑑、𝑥 = 𝜓1 (𝑦)、𝑥 = 𝜓2 (𝑦)。 2. 求整体 𝑥 的范围 𝑎 ≤ 𝑥 ≤ 𝑏。 3. 固定 𝑥 作竖直线，找 𝑦 的下界和上界。 𝑏 𝜑 (𝑥) 4. 写成 ∫ ∫ 2 𝑓(𝑥, 𝑦)𝑑𝑦 𝑑𝑥。 𝑎 𝜑1 (𝑥) 3. 需要分段的情况 如果换序后，某个方向的切线穿过区域时边界发生变化，就必须分段。例如 𝑦 的范围可以分成 𝑐 ≤ 𝑦 ≤ 𝑦0 , 𝑦0 ≤ 𝑦 ≤ 𝑑 则 𝑦0 𝜓2 (𝑦) 𝑑 𝜓4 (𝑦) ∬ 𝑓𝑑𝜎 = ∫ ∫ 𝑓𝑑𝑥 𝑑𝑦 + ∫ ∫ 𝑓𝑑𝑥 𝑑𝑦 𝐷 𝑐 𝜓1 (𝑦) 𝑦0 𝜓3 (𝑦) 易错点： 交换积分次序时，不能只把 𝑑𝑥 𝑑𝑦 机械换成 𝑑𝑦 𝑑𝑥。上下限必须重新根据同一个区域 𝐷 来写。"
  },
  {
    ...
    "page": 8,
    "heading": "五、极坐标法",
    "snippet": "考研数学 · 二重积分 五、极坐标法 极坐标适合圆、圆环、扇形、与 𝑥2 + 𝑦2 有关的区域和被积函数。 1. 坐标变换 极坐标定义为 𝑥 = 𝑟 cos 𝜃, 𝑦 = 𝑟 sin 𝜃 其中 𝑟≥0 面积元不是 𝑑𝑟 𝑑𝜃，而是 𝑑𝜎 = 𝑟 𝑑𝑟 𝑑𝜃 因此 ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 = ∬ 𝑓(𝑟 cos 𝜃, 𝑟 sin 𝜃)𝑟 𝑑...",
    "text": "Double Integral Methods (二重积分计算方法) Double Integral Methods 二重积分计算方法 微积分 五、极坐标法 考研数学 · 二重积分 五、极坐标法 极坐标适合圆、圆环、扇形、与 𝑥2 + 𝑦2 有关的区域和被积函数。 1. 坐标变换 极坐标定义为 𝑥 = 𝑟 cos 𝜃, 𝑦 = 𝑟 sin 𝜃 其中 𝑟≥0 面积元不是 𝑑𝑟 𝑑𝜃，而是 𝑑𝜎 = 𝑟 𝑑𝑟 𝑑𝜃 因此 ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 = ∬ 𝑓(𝑟 cos 𝜃, 𝑟 sin 𝜃)𝑟 𝑑𝑟 𝑑𝜃 𝐷 𝐷′ 2. 面积元为什么多一个 𝑟 极坐标中，一个小区域由半径方向长度 𝑑𝑟 和角度方向弧长 𝑟 𝑑𝜃 近似围成，所以面积近似为 𝑑𝜎 ≈ 𝑑𝑟 ⋅ 𝑟 𝑑𝜃 = 𝑟 𝑑𝑟 𝑑𝜃 从换元角度看，雅可比行列式为 cos 𝜃 −𝑟 sin 𝜃 𝐽 = |( )| = 𝑟 sin 𝜃 𝑟 cos 𝜃 所以 𝑑𝑥 𝑑𝑦 = |𝐽 |𝑑𝑟 𝑑𝜃 = 𝑟 𝑑𝑟 𝑑𝜃 3. 常见边界翻译 直角坐标 极坐标 说明 𝑥2 + 𝑦2 = 𝑎2 𝑟=𝑎 圆心在原点的圆 𝑥2 + 𝑦2 ≤ 𝑎2 0≤𝑟≤𝑎 原点圆盘 𝑥2 + 𝑦 2 𝑟2 常见被积函数化简 𝑥≥0 − 𝜋2 ≤ 𝜃 ≤ 𝜋2 右半平面 𝑦≥0 0≤𝜃≤𝜋 上半平面 𝑦=𝑥 𝜃 = 𝜋4 过原点直线 𝑥=𝑎 𝑟 cos 𝜃 = 𝑎 不经过原点的直线 4. 极坐标区域的典型形式 若区域为 𝐷′ = {(𝑟, 𝜃) | 𝛼 ≤ 𝜃 ≤ 𝛽, 𝑟1 (𝜃) ≤ 𝑟 ≤ 𝑟2 (𝜃)} 则"
  },
  {
    ...
    "snippet": "考研数学 · 二重积分 𝛽 𝑟2 (𝜃) ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 = ∫ ∫ 𝑓(𝑟 cos 𝜃, 𝑟 sin 𝜃)𝑟 𝑑𝑟 𝑑𝜃 𝐷 𝛼 𝑟1 (𝜃) 如果区域是圆盘 𝑥2 + 𝑦2 ≤ 𝑎2 ，则 0 ≤ 𝑟 ≤ 𝑎, 0 ≤ 𝜃 ≤ 2𝜋 如果区域是第一象限内圆盘 𝑥2 + 𝑦2 ≤ 𝑎2 ，则 𝜋 0 ≤ 𝑟 ≤ 𝑎, 0 ≤ 𝜃...",
    "text": "Double Integral Methods (二重积分计算方法) Double Integral Methods 二重积分计算方法 微积分 易错点： 极坐标换元最容易漏掉面积因子 𝑟。只要从 𝑑𝑥 𝑑𝑦 换成 𝑑𝑟 𝑑𝜃，就必须乘上雅可比 𝑟。 考研数学 · 二重积分 𝛽 𝑟2 (𝜃) ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 = ∫ ∫ 𝑓(𝑟 cos 𝜃, 𝑟 sin 𝜃)𝑟 𝑑𝑟 𝑑𝜃 𝐷 𝛼 𝑟1 (𝜃) 如果区域是圆盘 𝑥2 + 𝑦2 ≤ 𝑎2 ，则 0 ≤ 𝑟 ≤ 𝑎, 0 ≤ 𝜃 ≤ 2𝜋 如果区域是第一象限内圆盘 𝑥2 + 𝑦2 ≤ 𝑎2 ，则 𝜋 0 ≤ 𝑟 ≤ 𝑎, 0 ≤ 𝜃 ≤ 2 易错点： 极坐标换元最容易漏掉面积因子 𝑟。只要从 𝑑𝑥 𝑑𝑦 换成 𝑑𝑟 𝑑𝜃，就必须乘上雅可比 𝑟。"
  },
  {
    ...
    "category": "微积分",
    "page": 10,
    "heading": "六、一般变量替换与雅可比",
    "snippet": "考研数学 · 二重积分 六、一般变量替换与雅可比 除了极坐标，二重积分还可能使用一般变量替换。设 𝑥 = 𝑥(𝑢, 𝑣), 𝑦 = 𝑦(𝑢, 𝑣) 若变换将 𝑢𝑣 平面区域 𝐺 对应到 𝑥𝑦 平面区域 𝐷，且变换满足适当的一一对应与可微条件，则 𝜕(𝑥, 𝑦) ∬ 𝑓(𝑥, 𝑦)𝑑𝑥 𝑑𝑦 = ∬ 𝑓(𝑥(𝑢, 𝑣), 𝑦(𝑢, 𝑣))|...",
    "text": "Double Integral Methods (二重积分计算方法) Double Integral Methods 二重积分计算方法 微积分 六、一般变量替换与雅可比 考研数学 · 二重积分 六、一般变量替换与雅可比 除了极坐标，二重积分还可能使用一般变量替换。设 𝑥 = 𝑥(𝑢, 𝑣), 𝑦 = 𝑦(𝑢, 𝑣) 若变换将 𝑢𝑣 平面区域 𝐺 对应到 𝑥𝑦 平面区域 𝐷，且变换满足适当的一一对应与可微条件，则 𝜕(𝑥, 𝑦) ∬ 𝑓(𝑥, 𝑦)𝑑𝑥 𝑑𝑦 = ∬ 𝑓(𝑥(𝑢, 𝑣), 𝑦(𝑢, 𝑣))| |𝑑𝑢 𝑑𝑣 𝐷 𝐺 𝜕(𝑢, 𝑣) 其中 𝜕(𝑥, 𝑦) 𝜕 𝑥 𝑢 𝜕 𝜕𝑥 𝑣 = ( 𝜕𝑦 ) 𝜕(𝑢, 𝑣) 𝜕 𝜕 𝑢 𝜕 𝜕𝑦 𝑣 它的行列式称为雅可比行列式： 𝜕(𝑥, 𝑦) 𝜕𝑥 𝜕𝑦 𝜕𝑥 𝜕𝑦 𝐽= = − 𝜕(𝑢, 𝑣) 𝜕𝑢 𝜕𝑣 𝜕𝑣 𝜕𝑢 所以面积元变为 𝑑𝑥 𝑑𝑦 = |𝐽 |𝑑𝑢 𝑑𝑣 1. 常见线性变换 若题中出现 𝑥 + 𝑦, 𝑥−𝑦 或区域由斜直线围成，可以令 𝑢 = 𝑥 + 𝑦, 𝑣 = 𝑥 − 𝑦 再反解出 𝑢+𝑣 𝑢−𝑣 𝑥= , 𝑦= 2 2 雅可比为 1 1 𝜕(𝑥, 𝑦) 1 𝐽= = |( 21 21 )| = − 𝜕(𝑢, 𝑣) 2 −2 2 因此 1 𝑑𝑥 𝑑𝑦 = 𝑑𝑢 𝑑𝑣 2 2. 换元注意事项 1. 换元后要把被积函数、区域边界和面积元全部替换。 2. 雅可比要取绝对值。 3. 变量替换最好能把区域变简单，或把被积函数变简单。 4. 若变换不是一一对应，需要分区域处理。"
  },
  {
    ...
    "page": 11,
    "heading": "七、对称性与奇偶性",
    "snippet": "考研数学 · 二重积分 七、对称性与奇偶性 对称性可以显著简化计算，尤其适用于圆、椭圆、矩形、关于坐标轴对称的区域。 1. 关于 𝑦 轴对称 若区域 𝐷 关于 𝑦 轴对称，即 (𝑥, 𝑦) ∈ 𝐷 时 (−𝑥, 𝑦) ∈ 𝐷。 若 𝑓(𝑥, 𝑦) 关于 𝑥 为奇函数： 𝑓(−𝑥, 𝑦) = −𝑓(𝑥, 𝑦) 则 ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 =...",
    "text": "Double Integral Methods (二重积分计算方法) Double Integral Methods 二重积分计算方法 微积分 七、对称性与奇偶性 考研数学 · 二重积分 七、对称性与奇偶性 对称性可以显著简化计算，尤其适用于圆、椭圆、矩形、关于坐标轴对称的区域。 1. 关于 𝑦 轴对称 若区域 𝐷 关于 𝑦 轴对称，即 (𝑥, 𝑦) ∈ 𝐷 时 (−𝑥, 𝑦) ∈ 𝐷。 若 𝑓(𝑥, 𝑦) 关于 𝑥 为奇函数： 𝑓(−𝑥, 𝑦) = −𝑓(𝑥, 𝑦) 则 ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 = 0 𝐷 若 𝑓(𝑥, 𝑦) 关于 𝑥 为偶函数： 𝑓(−𝑥, 𝑦) = 𝑓(𝑥, 𝑦) 则 ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 = 2 ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 𝐷 𝐷+ 其中 𝐷+ 是 𝐷 中 𝑥 ≥ 0 的一半区域。 2. 关于 𝑥 轴对称 若区域 𝐷 关于 𝑥 轴对称。 若 𝑓(𝑥, −𝑦) = −𝑓(𝑥, 𝑦)，则 ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 = 0 𝐷 若 𝑓(𝑥, −𝑦) = 𝑓(𝑥, 𝑦)，则 ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 = 2 ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 𝐷 𝐷+ 其中 𝐷+ 是 𝐷 中 𝑦 ≥ 0 的一半区域。 3. 关于原点对称 若区域 𝐷 关于原点对称。 若 𝑓(−𝑥, −𝑦) = −𝑓(𝑥, 𝑦) 则 ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 = 0 𝐷 4. 轮换对称 若区域 𝐷 关于直线 𝑦 = 𝑥 对称，则"
  },
  {
    ...
    "page": 12,
    "heading": "考研数学 · 二重积分",
    "snippet": "考研数学 · 二重积分 ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 = ∬ 𝑓(𝑦, 𝑥)𝑑𝜎 𝐷 𝐷 因此 ∬ 𝑥𝑑𝜎 = ∬ 𝑦𝑑𝜎 𝐷 𝐷 对于圆盘、正方形等对称区域，常用结论为 ∬ 𝑥2 𝑑𝜎 = ∬ 𝑦2 𝑑𝜎 𝐷 𝐷 若 𝐷 是圆盘 𝑥2 + 𝑦2 ≤ 𝑎2 ，则 1 ∬ 𝑥2 𝑑𝜎 = ∬ 𝑦2 𝑑𝜎 = ∬ (𝑥2 + 𝑦2 )𝑑𝜎 𝐷 𝐷 ...",
    "text": "Double Integral Methods (二重积分计算方法) Double Integral Methods 二重积分计算方法 微积分 考研数学 · 二重积分 考研数学 · 二重积分 ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 = ∬ 𝑓(𝑦, 𝑥)𝑑𝜎 𝐷 𝐷 因此 ∬ 𝑥𝑑𝜎 = ∬ 𝑦𝑑𝜎 𝐷 𝐷 对于圆盘、正方形等对称区域，常用结论为 ∬ 𝑥2 𝑑𝜎 = ∬ 𝑦2 𝑑𝜎 𝐷 𝐷 若 𝐷 是圆盘 𝑥2 + 𝑦2 ≤ 𝑎2 ，则 1 ∬ 𝑥2 𝑑𝜎 = ∬ 𝑦2 𝑑𝜎 = ∬ (𝑥2 + 𝑦2 )𝑑𝜎 𝐷 𝐷 2 𝐷"
  },
  {
    ...
    "page": 13,
    "heading": "八、二重积分的常见应用",
    "snippet": "考研数学 · 二重积分 八、二重积分的常见应用 1. 平面区域面积 区域面积为 𝑆𝐷 = ∬ 1𝑑𝜎 𝐷 在极坐标下，若 𝛼 ≤ 𝜃 ≤ 𝛽 ，0 ≤ 𝑟 ≤ 𝑟(𝜃)，则 𝛽 𝑟(𝜃) 1 𝛽 2 𝑆𝐷 = ∫ ∫ 𝑟 𝑑𝑟 𝑑𝜃 = ∫ 𝑟 (𝜃)𝑑𝜃 𝛼 0 2 𝛼 2. 曲顶柱体体积 若曲顶为 𝑧 = 𝑓(𝑥, 𝑦)，底面为 𝐷，...",
    "text": "Double Integral Methods (二重积分计算方法) Double Integral Methods 二重积分计算方法 微积分 八、二重积分的常见应用 考研数学 · 二重积分 八、二重积分的常见应用 1. 平面区域面积 区域面积为 𝑆𝐷 = ∬ 1𝑑𝜎 𝐷 在极坐标下，若 𝛼 ≤ 𝜃 ≤ 𝛽 ，0 ≤ 𝑟 ≤ 𝑟(𝜃)，则 𝛽 𝑟(𝜃) 1 𝛽 2 𝑆𝐷 = ∫ ∫ 𝑟 𝑑𝑟 𝑑𝜃 = ∫ 𝑟 (𝜃)𝑑𝜃 𝛼 0 2 𝛼 2. 曲顶柱体体积 若曲顶为 𝑧 = 𝑓(𝑥, 𝑦)，底面为 𝐷，且 𝑓(𝑥, 𝑦) ≥ 0，则体积 𝑉 = ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 𝐷 若上下曲面分别为 𝑧 = 𝑧2 (𝑥, 𝑦), 𝑧 = 𝑧1 (𝑥, 𝑦) 则两曲面之间的体积为 𝑉 = ∬ [𝑧2 (𝑥, 𝑦) − 𝑧1 (𝑥, 𝑦)]𝑑𝜎 𝐷 3. 平面薄片质量与质心 质量： 𝑚 = ∬ 𝜌(𝑥, 𝑦)𝑑𝜎 𝐷 质心： ∬ 𝑥𝜌(𝑥, 𝑦)𝑑𝜎 𝐷 |(𝑥) = ∬ 𝜌(𝑥, 𝑦)𝑑𝜎 𝐷 ∬ 𝑦𝜌(𝑥, 𝑦)𝑑𝜎 𝐷 |(𝑦) = ∬ 𝜌(𝑥, 𝑦)𝑑𝜎 𝐷 若密度为常数且区域具有对称性，质心常位于对称中心或对称轴上。 4. 平均值 函数 𝑓(𝑥, 𝑦) 在区域 𝐷 上的平均值为 1 |(𝑓) = ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 𝑆𝐷 𝐷 其中 𝑆𝐷 = ∬ 1𝑑𝜎。 𝐷"
  },
  {
    ...
    "page": 14,
    "heading": "九、典型例题讲解",
    "snippet": "考研数学 · 二重积分 九、典型例题讲解 例题 1：直角坐标计算 题目 计算 ∬ (𝑥 + 𝑦)𝑑𝜎，其中 𝐷 由 𝑦 = 0、𝑥 = 1、𝑦 = 𝑥2 围成。 𝐷 解析：先画区域。边界 𝑦 = 0 和 𝑦 = 𝑥2 在 𝑥 = 0 相交，再由 𝑥 = 1 截断，所以 0 ≤ 𝑥 ≤ 1, 0 ≤ 𝑦 ≤ 𝑥2 于是 1 𝑥2 ∬ (𝑥 ...",
    "text": "Double Integral Methods (二重积分计算方法) Double Integral Methods 二重积分计算方法 微积分 九、典型例题讲解 考研数学 · 二重积分 九、典型例题讲解 例题 1：直角坐标计算 题目 计算 ∬ (𝑥 + 𝑦)𝑑𝜎，其中 𝐷 由 𝑦 = 0、𝑥 = 1、𝑦 = 𝑥2 围成。 𝐷 解析：先画区域。边界 𝑦 = 0 和 𝑦 = 𝑥2 在 𝑥 = 0 相交，再由 𝑥 = 1 截断，所以 0 ≤ 𝑥 ≤ 1, 0 ≤ 𝑦 ≤ 𝑥2 于是 1 𝑥2 ∬ (𝑥 + 𝑦)𝑑𝜎 = ∫ ∫ (𝑥 + 𝑦)𝑑𝑦 𝑑𝑥 𝐷 0 0 先对 𝑦 积分： 𝑥2 𝑥2 𝑦2 𝑥4 ∫ (𝑥 + 𝑦)𝑑𝑦 = [𝑥𝑦 + ] = 𝑥3 + 0 2 2 0 再对 𝑥 积分： 1 𝑥4 1 1 7 ∫ (𝑥3 + )𝑑𝑥 = + = 0 2 4 10 20 所以 7 ∬ (𝑥 + 𝑦)𝑑𝜎 = 𝐷 20 例题 2：交换积分次序 1 1 题目 将积分 ∫ ∫ 𝑓(𝑥, 𝑦)𝑑𝑦 𝑑𝑥 改变积分次序。 0 𝑥 解析：原积分表示 0 ≤ 𝑥 ≤ 1, 𝑥 ≤ 𝑦 ≤ 1 即区域为单位正方形内直线 𝑦 = 𝑥 上方的三角形。换成先 𝑥 后 𝑦： 整体 𝑦 的范围是 0≤𝑦≤1 固定 𝑦 时，𝑥 从 0 到 𝑦： 0≤𝑥≤𝑦 因此 1 1 1 𝑦 ∫ ∫ 𝑓(𝑥, 𝑦)𝑑𝑦 𝑑𝑥 = ∫ ∫ 𝑓(𝑥, 𝑦)𝑑𝑥 𝑑𝑦 0 𝑥 0 0"
  },
  {
    "id": "doc-b907693d8c25-p15",
    "docId": "doc-b907693d8c25",
    "title": "Double Integral Methods (二重积分计算方法)",
    "category": "微积分",
    "page": 15,
    "heading": "例题 3：需要分段的换序",
    "snippet": "考研数学 · 二重积分 例题 3：需要分段的换序 1 𝑥 题目 改变积分 ∫ ∫ 2 𝑓(𝑥, 𝑦)𝑑𝑦 𝑑𝑥 的积分次序。 0 𝑥 解析：区域为 0 ≤ 𝑥 ≤ 1, 𝑥2 ≤ 𝑦 ≤ 𝑥 边界是 𝑦 = 𝑥2 与 𝑦 = 𝑥，交点为 (0, 0) 和 (1, 1)。整体 𝑦 的范围为 0≤𝑦≤1 由𝑦=𝑥得 𝑥=𝑦 由 𝑦 = 𝑥2 ...",
    "text": "Double Integral Methods (二重积分计算方法) Double Integral Methods 二重积分计算方法 微积分 例题 3：需要分段的换序 考研数学 · 二重积分 例题 3：需要分段的换序 1 𝑥 题目 改变积分 ∫ ∫ 2 𝑓(𝑥, 𝑦)𝑑𝑦 𝑑𝑥 的积分次序。 0 𝑥 解析：区域为 0 ≤ 𝑥 ≤ 1, 𝑥2 ≤ 𝑦 ≤ 𝑥 边界是 𝑦 = 𝑥2 与 𝑦 = 𝑥，交点为 (0, 0) 和 (1, 1)。整体 𝑦 的范围为 0≤𝑦≤1 由𝑦=𝑥得 𝑥=𝑦 由 𝑦 = 𝑥2 得 √ 𝑥= 𝑦 √ 在 0 ≤ 𝑦 ≤ 1 内，水平线从左边界 𝑥 = 𝑦 到右边界 𝑥 = 𝑦，所以 √ 1 𝑥 1 𝑦 ∫ ∫ 𝑓(𝑥, 𝑦)𝑑𝑦 𝑑𝑥 = ∫ ∫ 𝑓(𝑥, 𝑦)𝑑𝑥 𝑑𝑦 0 𝑥2 0 𝑦 例题 4：极坐标计算 题目 计算 ∬ (𝑥2 + 𝑦2 )𝑑𝜎，其中 𝐷 : 𝑥2 + 𝑦2 ≤ 𝑎2 。 𝐷 解析：圆盘区域用极坐标最简单： 𝑥2 + 𝑦2 = 𝑟2 , 𝑑𝜎 = 𝑟 𝑑𝑟 𝑑𝜃 区域为 0 ≤ 𝑟 ≤ 𝑎, 0 ≤ 𝜃 ≤ 2𝜋 所以 2𝜋 𝑎 ∬ (𝑥2 + 𝑦2 )𝑑𝜎 = ∫ ∫ 𝑟2 ⋅ 𝑟 𝑑𝑟 𝑑𝜃 𝐷 0 0 2𝜋 𝑎 𝑎4 𝜋𝑎4 =∫ 𝑑𝜃 ∫ 𝑟3 𝑑𝑟 = 2𝜋 ⋅ = 0 0 4 2 例题 5：利用对称性 题目 设 𝐷 : 𝑥2 + 𝑦2 ≤ 1，计算 ∬ (𝑥3 + 𝑦2 )𝑑𝜎。 𝐷 解析：区域 𝐷 关于 𝑦 轴对称，而 𝑥3 关于 𝑥 为奇函数，因此 ∬ 𝑥3 𝑑𝜎 = 0 𝐷 于是"
  },
  {
    "id": "doc-b907693d8c25-p16",
    "docId": "doc-b907693d8c25",
    "title": "Double Integral Methods (二重积分计算方法)",
    "category": "微积分",
    "page": 16,
    "heading": "例题 6：两曲面之间体积",
    "snippet": "考研数学 · 二重积分 ∬ (𝑥3 + 𝑦2 )𝑑𝜎 = ∬ 𝑦2 𝑑𝜎 𝐷 𝐷 由于圆盘关于 𝑥、𝑦 对称， 1 ∬ 𝑦2 𝑑𝜎 = ∬ (𝑥2 + 𝑦2 )𝑑𝜎 𝐷 2 𝐷 用极坐标计算： 2𝜋 1 1 𝜋 ∬ (𝑥2 + 𝑦2 )𝑑𝜎 = ∫ ∫ 𝑟2 ⋅ 𝑟 𝑑𝑟 𝑑𝜃 = 2𝜋 ⋅ = 𝐷 0 0 4 2 所以 𝜋 ∬ 𝑦2 𝑑...",
    "text": "Double Integral Methods (二重积分计算方法) Double Integral Methods 二重积分计算方法 微积分 例题 6：两曲面之间体积 考研数学 · 二重积分 ∬ (𝑥3 + 𝑦2 )𝑑𝜎 = ∬ 𝑦2 𝑑𝜎 𝐷 𝐷 由于圆盘关于 𝑥、𝑦 对称， 1 ∬ 𝑦2 𝑑𝜎 = ∬ (𝑥2 + 𝑦2 )𝑑𝜎 𝐷 2 𝐷 用极坐标计算： 2𝜋 1 1 𝜋 ∬ (𝑥2 + 𝑦2 )𝑑𝜎 = ∫ ∫ 𝑟2 ⋅ 𝑟 𝑑𝑟 𝑑𝜃 = 2𝜋 ⋅ = 𝐷 0 0 4 2 所以 𝜋 ∬ 𝑦2 𝑑𝜎 = 𝐷 4 最终 𝜋 ∬ (𝑥3 + 𝑦2 )𝑑𝜎 = 𝐷 4 例题 6：两曲面之间体积 题目 求曲面 𝑧 = 4 − 𝑥2 − 𝑦2 与平面 𝑧 = 0 围成的立体体积。 解析：上下曲面分别为 𝑧2 = 4 − 𝑥 2 − 𝑦 2 , 𝑧 1 = 0 交线由 4 − 𝑥2 − 𝑦2 = 0 得到底面区域 𝐷 : 𝑥2 + 𝑦 2 ≤ 4 体积为 𝑉 = ∬ (4 − 𝑥2 − 𝑦2 )𝑑𝜎 𝐷 使用极坐标： 2𝜋 2 𝑉 =∫ ∫ (4 − 𝑟2 )𝑟 𝑑𝑟 𝑑𝜃 0 0 先对 𝑟 积分： 2 2 3 𝑟4 2 ∫ (4𝑟 − 𝑟 )𝑑𝑟 = [2𝑟 − ] = 8 − 4 = 4 0 4 0 再对 𝜃 积分："
  },
  {
    "id": "doc-b907693d8c25-p17",
    "docId": "doc-b907693d8c25",
    "title": "Double Integral Methods (二重积分计算方法)",
    "category": "微积分",
    "page": 17,
    "heading": "考研数学 · 二重积分",
    "snippet": "考研数学 · 二重积分 2𝜋 𝑉 =∫ 4𝑑𝜃 = 8𝜋 0",
    "text": "Double Integral Methods (二重积分计算方法) Double Integral Methods 二重积分计算方法 微积分 考研数学 · 二重积分 考研数学 · 二重积分 2𝜋 𝑉 =∫ 4𝑑𝜃 = 8𝜋 0"
  },
  {
    "id": "doc-b907693d8c25-p18",
    "docId": "doc-b907693d8c25",
    "title": "Double Integral Methods (二重积分计算方法)",
    "category": "微积分",
    "page": 18,
    "heading": "十、考研常见题型与解题模板",
    "snippet": "考研数学 · 二重积分 十、考研常见题型与解题模板 1. 给定区域，直接计算 解题模板： 1. 画出区域 𝐷。 2. 判断直角坐标还是极坐标更方便。 3. 写出积分限。 4. 按顺序积分，注意代入上下限。 2. 改变积分次序 解题模板： 1. 根据原积分限还原区域。 2. 画出边界曲线和交点。 3. 用另一方向切割区域。 4. 写出新积分...",
    "text": "Double Integral Methods (二重积分计算方法) Double Integral Methods 二重积分计算方法 微积分 十、考研常见题型与解题模板 考研数学 · 二重积分 十、考研常见题型与解题模板 1. 给定区域，直接计算 解题模板： 1. 画出区域 𝐷。 2. 判断直角坐标还是极坐标更方便。 3. 写出积分限。 4. 按顺序积分，注意代入上下限。 2. 改变积分次序 解题模板： 1. 根据原积分限还原区域。 2. 画出边界曲线和交点。 3. 用另一方向切割区域。 4. 写出新积分限，必要时分段。 3. 极坐标换元 解题模板： 1. 检查是否有 𝑥2 + 𝑦2 、圆、圆环、扇形。 2. 令 𝑥 = 𝑟 cos 𝜃，𝑦 = 𝑟 sin 𝜃。 3. 将被积函数和边界全部改写。 4. 面积元写成 𝑟 𝑑𝑟 𝑑𝜃。 4. 利用对称性 解题模板： 1. 判断区域关于哪条轴、原点或直线对称。 2. 判断被积函数关于对应变量的奇偶性。 3. 奇函数在对称区域上积分为 0。 4. 偶函数可化成半区域积分乘 2。 5. 应用题 面积题： 𝑆 = ∬ 1𝑑𝜎 𝐷 体积题： 𝑉 = ∬ 上函数 - 下函数 𝑑𝜎 𝐷 质量题： 𝑚 = ∬ 𝜌𝑑𝜎 𝐷 质心题："
  },
  {
    "id": "doc-b907693d8c25-p19",
    "docId": "doc-b907693d8c25",
    "title": "Double Integral Methods (二重积分计算方法)",
    "category": "微积分",
    "page": 19,
    "heading": "考研数学 · 二重积分",
    "snippet": "考研数学 · 二重积分 ∬ 𝑥𝜌𝑑𝜎 ∬ 𝑦𝜌𝑑𝜎 𝐷 𝐷 |(𝑥) = , |(𝑦) = 𝑚 𝑚",
    "text": "Double Integral Methods (二重积分计算方法) Double Integral Methods 二重积分计算方法 微积分 考研数学 · 二重积分 考研数学 · 二重积分 ∬ 𝑥𝜌𝑑𝜎 ∬ 𝑦𝜌𝑑𝜎 𝐷 𝐷 |(𝑥) = , |(𝑦) = 𝑚 𝑚"
  },
  {
    "id": "doc-b907693d8c25-p20",
    "docId": "doc-b907693d8c25",
    "title": "Double Integral Methods (二重积分计算方法)",
    "category": "微积分",
    "page": 20,
    "heading": "十一、易错点汇总",
    "snippet": "考研数学 · 二重积分 十一、易错点汇总 易错点： 二重积分中，𝑑𝑥 𝑑𝑦 的书写顺序容易和积分限对应关系混淆。内层积分的微分变量必须对应内层 上下限。 易错点： 极坐标换元必须乘 𝑟。例如 ∬ 1𝑑𝑥 𝑑𝑦 变成 ∫ ∫ 𝑟 𝑑𝑟 𝑑𝜃，不是 ∫ ∫ 𝑑𝑟 𝑑𝜃。 𝐷 易错点： 换序时要画同一个区域，不能只凭代数符号机械交换上下限。 易...",
    "text": "Double Integral Methods (二重积分计算方法) Double Integral Methods 二重积分计算方法 微积分 十一、易错点汇总 考研数学 · 二重积分 十一、易错点汇总 易错点： 二重积分中，𝑑𝑥 𝑑𝑦 的书写顺序容易和积分限对应关系混淆。内层积分的微分变量必须对应内层 上下限。 易错点： 极坐标换元必须乘 𝑟。例如 ∬ 1𝑑𝑥 𝑑𝑦 变成 ∫ ∫ 𝑟 𝑑𝑟 𝑑𝜃，不是 ∫ ∫ 𝑑𝑟 𝑑𝜃。 𝐷 易错点： 换序时要画同一个区域，不能只凭代数符号机械交换上下限。 易错点：对称性必须同时满足区域对称和函数奇偶性。只有函数是奇函数，但区域不对称，积分不一定为零。 易错点： 计算体积时要区分“曲面到 𝑥𝑦 平面之间的体积”和“两曲面之间的体积”。后者一般是 ∬ (𝑧上 − 𝐷 𝑧下 )𝑑𝜎。"
  },
  {
    "id": "doc-b907693d8c25-p21",
    "docId": "doc-b907693d8c25",
    "title": "Double Integral Methods (二重积分计算方法)",
    "category": "微积分",
    "page": 21,
    "heading": "十二、公式速查表",
    "snippet": "考研数学 · 二重积分 十二、公式速查表 内容 公式 定义 ∬ 𝑓𝑑𝜎 = lim𝜆→0 ∑ 𝑓(𝜉𝑖 , 𝜂𝑖 )Δ𝜎𝑖 𝐷 面积 𝑆𝐷 = ∬ 1𝑑𝜎 𝐷 曲顶柱体体积 𝑉 = ∬ 𝑓(𝑥, 𝑦)𝑑𝜎 𝐷 两曲面之间体积 𝑉 = ∬ (𝑧2 − 𝑧1 )𝑑𝜎 𝐷 𝑏 𝜑 (𝑥) 𝑥 型区域 ∬ 𝑓𝑑𝜎 = ∫ ∫ 2 𝑓𝑑𝑦 𝑑𝑥 𝐷...",
  ...
  },
  {
    ...
    "page": 5,
    "heading": "6. 距离公式",
    "snippet": "考研数学 · 多元函数积分学 直线与平面 𝑠⋅𝑛=0 直线方向与平面法向垂直，则直线平行 于平面或在平面内 直线垂直平面 𝑠×𝑛=0 直线方向与平面法向平行 两平面垂直 𝑛1 ⋅ 𝑛2 = 0 法向量垂直 6. 距离公式 点 𝑃0 (𝑥0 , 𝑦0 , 𝑧0 ) 到平面 𝐴𝑥 + 𝐵𝑦 + 𝐶𝑧 + 𝐷 = 0 的距离为 |𝐴𝑥0 + 𝐵...",
    "text": "Multivariable Integral Calculus (多元函数积分学) Multivariable Integral Calculus 多元函数积分学 微积分 6. 距离公式 考研数学 · 多元函数积分学 直线与平面 𝑠⋅𝑛=0 直线方向与平面法向垂直，则直线平行 于平面或在平面内 直线垂直平面 𝑠×𝑛=0 直线方向与平面法向平行 两平面垂直 𝑛1 ⋅ 𝑛2 = 0 法向量垂直 6. 距离公式 点 𝑃0 (𝑥0 , 𝑦0 , 𝑧0 ) 到平面 𝐴𝑥 + 𝐵𝑦 + 𝐶𝑧 + 𝐷 = 0 的距离为 |𝐴𝑥0 + 𝐵𝑦0 + 𝐶𝑧0 + 𝐷| 𝑑= √ 𝐴2 + 𝐵2 + 𝐶 2 点 𝑃 到过点 𝐴、方向向量为 𝑠 的直线距离为 |⃗ 𝐴𝑃 × 𝑠| 𝑑= |𝑠| 两异面直线 𝑙1 : 𝐴1 + 𝑡𝑠1 , 𝑙2 : 𝐴2 + 𝑡𝑠2 之间的距离为 ⃗ |𝐴 1 𝐴2 ⋅ (𝑠1 × 𝑠2 )| 𝑑= |𝑠1 × 𝑠2 | 易错点： 空间解析几何中，直线看方向向量，平面看法向量。判断平行、垂直、夹角和距离时，先把题目 中的几何对象转化为向量。"
  },
  {
    ...
    "category": "微积分",
    "page": 6,
    "heading": "三、多元函数微分与场论基础",
    "snippet": "考研数学 · 多元函数积分学 三、多元函数微分与场论基础 1. 偏导数与全微分 二元函数 𝑧 = 𝑓(𝑥, 𝑦) 的偏导数为 𝜕𝑓 𝜕𝑓 𝑓𝑥 = , 𝑓𝑦 = 𝜕𝑥 𝜕𝑦 若 𝑓 在点附近可微，则全微分为 𝑑𝑧 = 𝑓𝑥 𝑑𝑥 + 𝑓𝑦 𝑑𝑦 三元函数 𝑢 = 𝑓(𝑥, 𝑦, 𝑧) 的全微分为 𝑑𝑢 = 𝑓𝑥 𝑑𝑥 + 𝑓𝑦 𝑑𝑦 + ...",
    "text": "Multivariable Integral Calculus (多元函数积分学) Multivariable Integral Calculus 多元函数积分学 微积分 三、多元函数微分与场论基础 考研数学 · 多元函数积分学 三、多元函数微分与场论基础 1. 偏导数与全微分 二元函数 𝑧 = 𝑓(𝑥, 𝑦) 的偏导数为 𝜕𝑓 𝜕𝑓 𝑓𝑥 = , 𝑓𝑦 = 𝜕𝑥 𝜕𝑦 若 𝑓 在点附近可微，则全微分为 𝑑𝑧 = 𝑓𝑥 𝑑𝑥 + 𝑓𝑦 𝑑𝑦 三元函数 𝑢 = 𝑓(𝑥, 𝑦, 𝑧) 的全微分为 𝑑𝑢 = 𝑓𝑥 𝑑𝑥 + 𝑓𝑦 𝑑𝑦 + 𝑓𝑧 𝑑𝑧 2. 方向导数 设 𝑢 = 𝑓(𝑥, 𝑦, 𝑧)，单位方向向量为 𝑒 = (cos 𝛼, cos 𝛽, cos 𝛾) 则函数在该方向上的方向导数为 𝜕𝑓 = 𝑓𝑥 cos 𝛼 + 𝑓𝑦 cos 𝛽 + 𝑓𝑧 cos 𝛾 𝜕𝑒 向量形式为 𝜕𝑓 = grad 𝑓 ⋅ 𝑒 𝜕𝑒 其中 𝑒 必须是单位向量。若给的是普通方向向量 𝑎，要先单位化： 𝑎 𝑒= |𝑎| 3. 梯度 标量场 𝑓(𝑥, 𝑦, 𝑧) 的梯度为 grad 𝑓 = (𝑓𝑥 , 𝑓𝑦 , 𝑓𝑧 ) 也写作 𝜕𝑓 𝜕𝑓 𝜕𝑓 ∇𝑓 = 𝑖+ 𝑗+ 𝑘 𝜕𝑥 𝜕𝑦 𝜕𝑧 梯度的意义： 1. grad 𝑓 指向函数增长最快的方向。 2. 最大方向导数为 |grad 𝑓|。 3. grad 𝑓 垂直于等值面 𝑓(𝑥, 𝑦, 𝑧) = 𝐶 。 因此曲面 𝐹 (𝑥, 𝑦, 𝑧) = 0 在点 𝑃0 处的法向量可取 𝑛 = grad 𝐹 (𝑃0 )"
  },
  {
    ...
    "page": 7,
    "heading": "4. 向量场",
    "snippet": "考研数学 · 多元函数积分学 切平面方程为 𝐹𝑥(𝑃0 ) (𝑥 − 𝑥0 ) + 𝐹𝑦(𝑃0 ) (𝑦 − 𝑦0 ) + 𝐹𝑧(𝑃0 ) (𝑧 − 𝑧0 ) = 0 4. 向量场 向量场通常写为 𝐹 (𝑥, 𝑦, 𝑧) = (𝑃 (𝑥, 𝑦, 𝑧), 𝑄(𝑥, 𝑦, 𝑧), 𝑅(𝑥, 𝑦, 𝑧)) 它可以表示力场、速度场、电场等。第二型...",
    "text": "Multivariable Integral Calculus (多元函数积分学) Multivariable Integral Calculus 多元函数积分学 微积分 4. 向量场 考研数学 · 多元函数积分学 切平面方程为 𝐹𝑥(𝑃0 ) (𝑥 − 𝑥0 ) + 𝐹𝑦(𝑃0 ) (𝑦 − 𝑦0 ) + 𝐹𝑧(𝑃0 ) (𝑧 − 𝑧0 ) = 0 4. 向量场 向量场通常写为 𝐹 (𝑥, 𝑦, 𝑧) = (𝑃 (𝑥, 𝑦, 𝑧), 𝑄(𝑥, 𝑦, 𝑧), 𝑅(𝑥, 𝑦, 𝑧)) 它可以表示力场、速度场、电场等。第二型曲线积分 ∫ 𝐹 ⋅ 𝑑𝑟 𝐿 表示沿路径的做功；第二型曲面积分 ∬ 𝐹 ⋅ 𝑛 𝑑𝑆 Σ 表示穿过曲面的通量。 5. 散度 向量场 𝐹 = (𝑃 , 𝑄, 𝑅) 的散度为 𝜕𝑃 𝜕𝑄 𝜕𝑅 div 𝐹 = + + 𝜕𝑥 𝜕𝑦 𝜕𝑧 也写作 ∇ ⋅ 𝐹 = 𝑃𝑥 + 𝑄𝑦 + 𝑅𝑧 散度描述向量场在某点附近的源汇强度： 1. div 𝐹 > 0 表示局部像源一样向外发散。 2. div 𝐹 < 0 表示局部像汇一样向内吸收。 3. div 𝐹 = 0 常称为无源场或不可压缩场。 高斯公式正是把闭曲面通量与区域内散度累加联系起来： ∯ 𝐹 ⋅ 𝑛 𝑑𝑆 = ∭ div 𝐹 𝑑𝑉 𝑆 Ω 6. 旋度 向量场 𝐹 = (𝑃 , 𝑄, 𝑅) 的旋度为 𝑖 𝑗 𝑘 curl 𝐹 = ∇ × 𝐹 = 𝜕𝑥 𝜕𝑦 𝜕𝑧 (𝑃 𝑄 𝑅) 展开为 curl 𝐹 = (𝑅𝑦 − 𝑄𝑧 , 𝑃𝑧 − 𝑅𝑥 , 𝑄𝑥 − 𝑃𝑦 ) 旋度描述向量场的局部旋转趋势： 1. curl 𝐹 = 0 常称为无旋场。 2. 平面场 𝐹 = (𝑃 , 𝑄) 的旋度只剩 𝑧 分量 𝑄𝑥 − 𝑃𝑦 。"
  },
  {
    ...
    "category": "微积分",
    "page": 8,
    "heading": "3. 格林公式中的 𝑄𝑥 − 𝑃𝑦 可以理解为平面向量场的旋度。",
    "snippet": "考研数学 · 多元函数积分学 3. 格林公式中的 𝑄𝑥 − 𝑃𝑦 可以理解为平面向量场的旋度。 斯托克斯公式把闭曲线环流与曲面上旋度通量联系起来： ∮ 𝐹 ⋅ 𝑑𝑟 = ∬ (curl 𝐹 ) ⋅ 𝑛 𝑑𝑆 Γ Σ 7. 常用恒等关系 若函数足够光滑，则 curl(grad 𝑓) = 0 表示梯度场无旋。 又有 div(curl 𝐹 ) ...",
    "text": "Multivariable Integral Calculus (多元函数积分学) Multivariable Integral Calculus 多元函数积分学 微积分 3. 格林公式中的 𝑄𝑥 − 𝑃𝑦 可以理解为平面向量场的旋度。 考研数学 · 多元函数积分学 3. 格林公式中的 𝑄𝑥 − 𝑃𝑦 可以理解为平面向量场的旋度。 斯托克斯公式把闭曲线环流与曲面上旋度通量联系起来： ∮ 𝐹 ⋅ 𝑑𝑟 = ∬ (curl 𝐹 ) ⋅ 𝑛 𝑑𝑆 Γ Σ 7. 常用恒等关系 若函数足够光滑，则 curl(grad 𝑓) = 0 表示梯度场无旋。 又有 div(curl 𝐹 ) = 0 表示旋度场无源。 若 𝐹 = grad 𝑓 ，则第二型曲线积分与路径无关： 𝐵 ∫ 𝐹 ⋅ 𝑑𝑟 = 𝑓(𝐵) − 𝑓(𝐴) 𝐴 易错点： 方向导数一定要用单位方向向量；梯度属于标量场，散度和旋度属于向量场。不要把 grad 𝑓 、 div 𝐹 、curl 𝐹 的对象混在一起。"
  },
  {
  ...
  },
  {
    ...
    "text": "Multivariable Integral Calculus (多元函数积分学) Multivariable Integral Calculus 多元函数积分学 微积分 八、格林公式 考研数学 · 多元函数积分学 八、格林公式 1. 公式 设 𝐷 是平面有界闭区域，边界 𝐿 正向取逆时针方向，𝑃 , 𝑄 在 𝐷 上有连续一阶偏导，则 𝜕𝑄 𝜕𝑃 ∮ 𝑃 𝑑𝑥 + 𝑄 𝑑𝑦 = ∬ [ − ] 𝑑𝑥 𝑑𝑦 𝐿 𝐷 𝜕𝑥 𝜕𝑦 这就是格林公式。 2. 正向边界 平面区域的正向边界指沿边界走时，区域始终在左侧。对简单闭曲线来说就是逆时针方向。 若题目给的是顺时针方向，则 ∮ 𝑃 𝑑𝑥 + 𝑄 𝑑𝑦 = − ∮ 𝑃 𝑑𝑥 + 𝑄 𝑑𝑦 𝐿− 𝐿 3. 面积公式 由格林公式可以得到平面区域面积： 1 𝑆= ∮ 𝑥 𝑑𝑦 − 𝑦 𝑑𝑥 2 𝐿 也可用 𝑆 = ∮ 𝑥 𝑑𝑦 𝐿 或 𝑆 = − ∮ 𝑦 𝑑𝑥 𝐿 前提是 𝐿 取正向。 4. 典型用途 1. 把复杂闭曲线积分转化为二重积分。 2. 求平面区域面积。 3. 判断闭曲线积分是否为零。 4. 处理路径无关问题。 5. 三类常见应用场景 做格林公式题时，不要一上来就套公式。考研中更稳定的判断顺序是： 判断顺序： 先看曲线是否封闭；再看曲线围成的区域内部是否有奇点；最后看 𝑄𝑥 − 𝑃𝑦 是否为零或是否容 易积分。 场景 判断条件 核心做法 闭曲线且内部无奇 曲线 𝐿 封闭，𝑃 , 𝑄 在 𝐿 及其内部区 直接使用格林公式，把闭曲线积分化为区域 点 域 𝐷 上连续可偏导。 二重积分。注意边界正向为逆时针。"
  },
  {
    ...
    "snippet": "考研数学 · 多元函数积分学 曲线不封闭且 𝑄𝑥 − 曲线不是闭合曲线，并且偏导差不为 补一段辅助曲线 𝐿0 使其闭合，先对 𝐿 + 𝐿0 𝑃𝑦 ≠ 0 零，所以不能直接用路径无关。 用格林公式，再减去辅助曲线上的积分。 闭曲线但内部有奇 曲线封闭，但 𝑃 , 𝑄 在内部某点不连 不能直接对整个区域用格林公式。应挖去奇 点 续，例如分母在...",
    "text": "Multivariable Integral Calculus (多元函数积分学) Multivariable Integral Calculus 多元函数积分学 微积分 易错点： 这里说的“差值不为零”，通常就是 𝑄𝑥 − 𝑃𝑦 ≠ 0。如果 𝑄𝑥 − 𝑃𝑦 = 0 且区域单连通，则可能改用 考研数学 · 多元函数积分学 曲线不封闭且 𝑄𝑥 − 曲线不是闭合曲线，并且偏导差不为 补一段辅助曲线 𝐿0 使其闭合，先对 𝐿 + 𝐿0 𝑃𝑦 ≠ 0 零，所以不能直接用路径无关。 用格林公式，再减去辅助曲线上的积分。 闭曲线但内部有奇 曲线封闭，但 𝑃 , 𝑄 在内部某点不连 不能直接对整个区域用格林公式。应挖去奇 点 续，例如分母在原点为零。 点附近的小圆或小椭圆，在去奇点区域使用 格林公式，并处理内边界方向。 场景一：闭曲线且内部无奇点 若 𝐿 是区域 𝐷 的正向边界，且 𝑃 , 𝑄 在 𝐷 上连续可偏导，则直接套用： ∮ 𝑃 𝑑𝑥 + 𝑄 𝑑𝑦 = ∬ (𝑄𝑥 − 𝑃𝑦 ) 𝑑𝑥 𝑑𝑦 𝐿 𝐷 这种题的关键不是路径形状，而是二重积分区域 𝐷 是否容易描述。若 𝑄𝑥 − 𝑃𝑦 是常数，问题常常进一步变成 面积计算。 场景二：曲线不封闭且 𝑄𝑥 − 𝑃𝑦 ≠ 0 若曲线 𝐿 从点 𝐴 到点 𝐵，本身不封闭，格林公式不能直接使用。此时常见做法是补一条辅助曲线 𝐿0 ，让 𝐶 = 𝐿 + 𝐿0 成为正向闭曲线。若 𝐶 围成区域 𝐷，则 ∮ 𝑃 𝑑𝑥 + 𝑄 𝑑𝑦 = ∬ (𝑄𝑥 − 𝑃𝑦 ) 𝑑𝑥 𝑑𝑦 𝐶 𝐷 而 ∫ 𝑃 𝑑𝑥 + 𝑄 𝑑𝑦 = ∬ (𝑄𝑥 − 𝑃𝑦 ) 𝑑𝑥 𝑑𝑦 − ∫ 𝑃 𝑑𝑥 + 𝑄 𝑑𝑦 𝐿 𝐷 𝐿0 上式的符号取决于补线后闭曲线的方向。若补线方向与正向边界方向相反，减去时要同时注意方向号。 易错点： 这里说的“差值不为零”，通常就是 𝑄𝑥 − 𝑃𝑦 ≠ 0。如果 𝑄𝑥 − 𝑃𝑦 = 0 且区域单连通，则可能改用 路径无关或全微分方法；但当 𝑄𝑥 − 𝑃𝑦 ≠ 0 时，一般不能把积分只看成端点差。 场景三：闭曲线但内部有奇点 若 𝐿 已经封闭，但 𝑃 , 𝑄 在 𝐿 内部某点不连续，格林公式不能直接作用在整个区域上。典型处理是： 1. 以奇点为中心挖去一个很小的圆或椭圆 𝐶𝜀 。 2. 在去掉奇点后的区域 𝐷𝜀 上使用格林公式。 3. 注意内边界方向：对 𝐷𝜀 来说，外边界为逆时针，内边界为顺时针。 4. 若需要，令 𝜀 → 0，计算小圆或小椭圆边界上的极限积分。 对于含有 1 1 , 𝑥2 + 𝑦 2 𝑥2 + 2𝑦2 这类分母的题，原点往往就是需要优先检查的奇点。后面的“含奇点边界积分”例题正是这类情形：先挖去原点 附近的小椭圆，再在无奇点区域内使用格林公式。"
  },
  {
  ...
  },
  {
    ...
    "page": 27,
    "heading": "十三、三大公式对比",
    "snippet": "考研数学 · 多元函数积分学 十三、三大公式对比 公式 对象 方向 常见用途 格林 平面闭曲线 𝐿 与区域 𝐷 边界正向，区域在左侧 闭曲线积分转二重积分，求面 积 高斯 闭曲面 𝑆 与空间区域 Ω 外法向 通量转三重积分，补面求通量 斯托克斯 有向曲面 Σ 与边界 Γ 右手定则 空间闭曲线积分转曲面积分 1. 什么时候用格林公式 看到平...",
    "text": "Multivariable Integral Calculus (多元函数积分学) Multivariable Integral Calculus 多元函数积分学 微积分 十三、三大公式对比 考研数学 · 多元函数积分学 十三、三大公式对比 公式 对象 方向 常见用途 格林 平面闭曲线 𝐿 与区域 𝐷 边界正向，区域在左侧 闭曲线积分转二重积分，求面 积 高斯 闭曲面 𝑆 与空间区域 Ω 外法向 通量转三重积分，补面求通量 斯托克斯 有向曲面 Σ 与边界 Γ 右手定则 空间闭曲线积分转曲面积分 1. 什么时候用格林公式 看到平面闭曲线积分 ∮ 𝑃 𝑑𝑥 + 𝑄 𝑑𝑦 𝐿 且区域容易描述时，优先考虑格林公式。 2. 什么时候用高斯公式 看到闭曲面通量 ∯ 𝐹 ⋅ 𝑛 𝑑𝑆 𝑆 且散度简单时，优先考虑高斯公式。 若曲面不闭合，可以补面。 3. 什么时候用斯托克斯公式 看到空间闭曲线积分 ∮ 𝐹 ⋅ 𝑑𝑟 Γ 且曲线是某曲面的边界时，优先考虑斯托克斯公式。"
  },
  {
  ...
  },
  {
    ...
    "text": "Multivariable Integral Calculus (多元函数积分学) Multivariable Integral Calculus 多元函数积分学 微积分 十六、易错点汇总 考研数学 · 多元函数积分学 十六、易错点汇总 易错点： 第一型积分不看方向，第二型积分看方向。曲线反向会使第二型曲线积分变号，曲面反向会使第 二型曲面积分变号。 易错点：格林公式中的正向是逆时针方向，即沿边界走时区域在左侧。若题目给顺时针方向，结果要取负号。 易错点： 高斯公式只能直接用于闭曲面。非闭曲面要先补面，最后减去补面的通量。 易错点： 斯托克斯公式中曲线方向和曲面法向必须满足右手定则。方向反了，结果取负号。 易错点： 曲面积分中 𝑑𝑆 、𝑑𝑥 𝑑𝑦、𝑑𝑦 𝑑𝑧 、𝑑𝑧 𝑑𝑥 不可混淆。第一型用面积元 𝑑𝑆 ，第二型用有向面积投影 或 𝐹 ⋅ 𝑛 𝑑𝑆 。"
  },
  {
    "id": "doc-73ec94e14160-p37",
    "docId": "doc-73ec94e14160",
    "title": "Multivariable Integral Calculus (多元函数积分学)",
    "category": "微积分",
    "page": 37,
    "heading": "十七、公式速查表",
    "snippet": "考研数学 · 多元函数积分学 十七、公式速查表 内容 公式 向量点积 𝑎 ⋅ 𝑏 = |𝑎||𝑏| cos 𝜃 向量叉积 |𝑎 × 𝑏| = |𝑎||𝑏| sin 𝜃 空间直线 (𝑥, 𝑦, 𝑧) = (𝑥0 , 𝑦0 , 𝑧0 ) + 𝑡(𝑚, 𝑛, 𝑝) 平面方程 𝐴(𝑥 − 𝑥0 ) + 𝐵(𝑦 − 𝑦0 ) + 𝐶(𝑧 − 𝑧0 ...",
    "text": "Multivariable Integral Calculus (多元函数积分学) Multivariable Integral Calculus 多元函数积分学 微积分 十七、公式速查表 考研数学 · 多元函数积分学 十七、公式速查表 内容 公式 向量点积 𝑎 ⋅ 𝑏 = |𝑎||𝑏| cos 𝜃 向量叉积 |𝑎 × 𝑏| = |𝑎||𝑏| sin 𝜃 空间直线 (𝑥, 𝑦, 𝑧) = (𝑥0 , 𝑦0 , 𝑧0 ) + 𝑡(𝑚, 𝑛, 𝑝) 平面方程 𝐴(𝑥 − 𝑥0 ) + 𝐵(𝑦 − 𝑦0 ) + 𝐶(𝑧 − 𝑧0 ) = 0 平面束方程 Π1 + 𝜆Π2 = 0 |𝐴𝑥0 +𝐵𝑦0 +𝐶𝑧0 +𝐷| 点到平面距离 𝑑= √ 𝐴2 +𝐵2 +𝐶 2 𝜕𝑓 方向导数 𝜕𝑒 = grad 𝑓 ⋅ 𝑒 梯度 grad 𝑓 = (𝑓𝑥 , 𝑓𝑦 , 𝑓𝑧 ) 散度 div 𝐹 = 𝑃𝑥 + 𝑄𝑦 + 𝑅𝑧 旋度 curl 𝐹 = (𝑅𝑦 − 𝑄𝑧 , 𝑃𝑧 − 𝑅𝑥 , 𝑄𝑥 − 𝑃𝑦 ) 二重积分极坐标 𝑑𝑥 𝑑𝑦 = 𝑟 𝑑𝑟 𝑑𝜃 三重积分柱坐标 𝑑𝑉 = 𝑟 𝑑𝑟 𝑑𝜃 𝑑𝑧 三重积分球坐标 𝑑𝑉 = 𝜌2 sin 𝜑 𝑑𝜌 𝑑𝜑 𝑑𝜃 二重积分估值 𝑚𝑆𝐷 ≤ ∬ 𝑓 𝑑𝜎 ≤ 𝑀 𝑆𝐷 𝐷 三重积分估值 𝑚𝑉Ω ≤ ∭ 𝑓 𝑑𝑉 ≤ 𝑀 𝑉Ω Ω 二重积分中值 ∬ 𝑓 𝑑𝜎 = 𝑓(𝜉, 𝜂)𝑆𝐷 𝐷 平面形心 (𝑥𝑐 , 𝑦𝑐 ) = ( 𝑆1 ∬ 𝑥 𝑑𝜎, 𝑆1 ∬ 𝑦 𝑑𝜎) 𝐷 𝐷 𝐷 𝐷 1 1 1 空间质心 𝑥𝑐 = 𝑚 ∭ 𝑥𝜌 𝑑𝑉 , 𝑦𝑐 = 𝑚 ∭ 𝑦𝜌 𝑑𝑉 , 𝑧𝑐 = 𝑚 ∭ 𝑧𝜌 𝑑𝑉 Ω Ω Ω 𝛽 ′ 第一型曲线积分 ∫ 𝑓 𝑑𝑠 = ∫ 𝑓(𝑟(𝑡))|𝑟 (𝑡)| 𝑑𝑡 𝐿 𝛼 𝛽 第二型曲线积分 ∫ 𝐹 ⋅ 𝑑𝑟 = ∫ 𝐹 (𝑟(𝑡)) ⋅ 𝑟′ (𝑡) 𝑑𝑡 𝐿 𝛼 显式曲面面积元 𝑧 = 𝑧(𝑥, 𝑦) : 𝑑𝑆 = √1 + 𝑧𝑥2 + 𝑧𝑦2 𝑑𝑥 𝑑𝑦 第二型曲面积分 ∬ 𝐹 ⋅ 𝑛 𝑑𝑆 Σ 格林公式 ∮ 𝑃 𝑑𝑥 + 𝑄 𝑑𝑦 = ∬ (𝑄𝑥 − 𝑃𝑦 ) 𝑑𝑥 𝑑𝑦 𝐿 𝐷 高斯公式 ∯ 𝐹 ⋅ 𝑛 𝑑𝑆 = ∭ div 𝐹 𝑑𝑉 𝑆 Ω 斯托克斯公式 ∮ 𝐹 ⋅ 𝑑𝑟 = ∬ (curl 𝐹 ) ⋅ 𝑛 𝑑𝑆 Γ Σ 最终抓手： 多元函数积分学做题先判断积分对象：区域、曲线还是曲面；再判断是否有方向；最后判断能 不能用格林、高斯、斯托克斯把复杂边界积分化成区域积分。方向、封闭性、投影区域是最关键的三件事。"
  },
  {
    ...
    "page": 1,
    "heading": "考研数学 · 微分方程",
    "snippet": "考研数学 · 微分方程 微分方程求解总结讲解 常微分方程 · 线性方程 · 齐次非齐次 · 特解通解 考研数学复习资料 · Typst PDF 首页速览 • 核心公式：一阶线性方程 𝑦 ′ + 𝑝(𝑥)𝑦 = 𝑞(𝑥) 的通解 𝑦 = 𝑒− ∫ 𝑝𝑑𝑥 (∫ 𝑞𝑒∫ 𝑝𝑑𝑥 𝑑𝑥 + 𝐶)。 • 关键定理：二阶线性非齐次方程通解等于对应齐...",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 考研数学 · 微分方程 考研数学 · 微分方程 微分方程求解总结讲解 常微分方程 · 线性方程 · 齐次非齐次 · 特解通解 考研数学复习资料 · Typst PDF 首页速览 • 核心公式：一阶线性方程 𝑦 ′ + 𝑝(𝑥)𝑦 = 𝑞(𝑥) 的通解 𝑦 = 𝑒− ∫ 𝑝𝑑𝑥 (∫ 𝑞𝑒∫ 𝑝𝑑𝑥 𝑑𝑥 + 𝐶)。 • 关键定理：二阶线性非齐次方程通解等于对应齐次通解加一个非齐次特解。 • 方法抓手：先识别分离变量、齐次、一阶线性、可降阶或常系数线性，再代入初值定常数。 复习目标：微分方程题的关键不是死记形式，而是先识别类型，再套对应解法。考研常见主线是：一阶方程 的分离变量、齐次方程、一阶线性方程、可降阶高阶方程、二阶线性常系数齐次与非齐次方程，以及特解、 通解和初值条件的关系。"
  },
  {
    ...
    "page": 2,
    "heading": "一、基本概念",
    "snippet": "考研数学 · 微分方程 一、基本概念 1. 微分方程与常微分方程 含有未知函数及其导数的方程称为微分方程。若未知函数只含一个自变量，则称为常微分方程，简称 ODE。 例如 𝑦′ + 𝑦 = 𝑒𝑥 是关于未知函数 𝑦 = 𝑦(𝑥) 的一阶常微分方程。 若未知函数含有多个自变量，并含偏导数，则称为偏微分方程。考研数学中，本专题主要处理常微分方...",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 一、基本概念 考研数学 · 微分方程 一、基本概念 1. 微分方程与常微分方程 含有未知函数及其导数的方程称为微分方程。若未知函数只含一个自变量，则称为常微分方程，简称 ODE。 例如 𝑦′ + 𝑦 = 𝑒𝑥 是关于未知函数 𝑦 = 𝑦(𝑥) 的一阶常微分方程。 若未知函数含有多个自变量，并含偏导数，则称为偏微分方程。考研数学中，本专题主要处理常微分方程。 2. 阶数 微分方程中出现的最高阶导数的阶数称为方程的阶。 𝑦′ = 𝑥𝑦 是一阶微分方程。 𝑦″ + 3𝑦′ + 2𝑦 = 0 是二阶微分方程。 一般 𝑛 阶常微分方程可写成 𝐹 (𝑥, 𝑦, 𝑦′ , 𝑦″ , …, 𝑦(𝑛) ) = 0 若能解出最高阶导数，也可写成 𝑦(𝑛) = 𝑓(𝑥, 𝑦, 𝑦′ , …, 𝑦(𝑛−1) ) 3. 解、通解、特解 若函数 𝑦 = 𝜑(𝑥) 代入微分方程后使方程恒成立，则称 𝑦 = 𝜑(𝑥) 为该微分方程的一个解。 含有任意常数的解称为通解。对于 𝑛 阶微分方程，通解通常含有 𝑛 个相互独立的任意常数： 𝑦 = 𝜑(𝑥, 𝐶1 , 𝐶2 , …, 𝐶𝑛 ) 由初始条件或边界条件确定任意常数后得到的具体解称为特解。 例如 𝑦′ = 2𝑥 积分得通解 𝑦 = 𝑥2 + 𝐶 若给定 𝑦(0) = 1，则 𝐶 = 1，特解为 𝑦 = 𝑥2 + 1 4. 初值问题 给定方程和初始条件的问题称为初值问题。例如 𝑦′ = 𝑓(𝑥, 𝑦), 𝑦(𝑥0 ) = 𝑦0 求解步骤是：先求通解，再把初始条件代入，确定任意常数。"
  },
  {
    ...
    "page": 3,
    "heading": "二、一阶可分离变量方程",
    "snippet": "考研数学 · 微分方程 二、一阶可分离变量方程 1. 标准形式 若一阶微分方程可写成 𝑑𝑦 = 𝑓(𝑥)𝑔(𝑦) 𝑑𝑥 则称为可分离变量方程。 当 𝑔(𝑦) ≠ 0 时，两边分离变量： 𝑑𝑦 = 𝑓(𝑥)𝑑𝑥 𝑔(𝑦) 两边积分： 𝑑𝑦 ∫ = ∫ 𝑓(𝑥)𝑑𝑥 + 𝐶 𝑔(𝑦) 这就是通解的隐式形式。 2. 解题模板 1. 把所有含 𝑦...",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 二、一阶可分离变量方程 考研数学 · 微分方程 二、一阶可分离变量方程 1. 标准形式 若一阶微分方程可写成 𝑑𝑦 = 𝑓(𝑥)𝑔(𝑦) 𝑑𝑥 则称为可分离变量方程。 当 𝑔(𝑦) ≠ 0 时，两边分离变量： 𝑑𝑦 = 𝑓(𝑥)𝑑𝑥 𝑔(𝑦) 两边积分： 𝑑𝑦 ∫ = ∫ 𝑓(𝑥)𝑑𝑥 + 𝐶 𝑔(𝑦) 这就是通解的隐式形式。 2. 解题模板 1. 把所有含 𝑦 的项移到 𝑑𝑦 一侧，把所有含 𝑥 的项移到 𝑑𝑥 一侧。 2. 两边积分。 3. 化简通解。 4. 若有初值条件，代入确定常数。 易错点： 分离变量时，如果除以了 𝑔(𝑦)，要注意 𝑔(𝑦) = 0 可能带来常数解。考试中若题目强调完整解，应 检查这类解是否遗漏。 3. 例题 题目 求解 𝑦′ = 𝑥𝑦。 解析：方程可写为 𝑑𝑦 = 𝑥𝑦 𝑑𝑥 当 𝑦 ≠ 0 时分离变量： 𝑑𝑦 = 𝑥𝑑𝑥 𝑦 两边积分： 𝑑𝑦 ∫ = ∫ 𝑥𝑑𝑥 𝑦 得到 𝑥2 ln|𝑦| = +𝐶 2 于是"
  },
  {
    ...
    "page": 4,
    "heading": "考研数学 · 微分方程",
    "snippet": "考研数学 · 微分方程 𝑥2 𝑦 = 𝐶𝑒 2 其中 𝐶 可取任意常数。𝐶 = 0 时也包含常数解 𝑦 = 0。",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 考研数学 · 微分方程 考研数学 · 微分方程 𝑥2 𝑦 = 𝐶𝑒 2 其中 𝐶 可取任意常数。𝐶 = 0 时也包含常数解 𝑦 = 0。"
  },
  {
    ...
    "page": 5,
    "heading": "三、一阶齐次方程",
    "snippet": "考研数学 · 微分方程 三、一阶齐次方程 1. 齐次一阶方程的形式 若一阶微分方程可写成 𝑑𝑦 𝑦 = 𝐹( ) 𝑑𝑥 𝑥 则称为一阶齐次方程。 注意这里的“齐次”指 𝑦′ 右端只依赖比值 𝑥𝑦 ，不是线性方程中的齐次与非齐次概念。 2. 代换方法 令 𝑦 𝑣= 𝑥 即 𝑦 = 𝑣𝑥 对 𝑥 求导： 𝑑𝑦 𝑑𝑣 =𝑣+𝑥 𝑑𝑥 𝑑𝑥 代入...",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 三、一阶齐次方程 考研数学 · 微分方程 三、一阶齐次方程 1. 齐次一阶方程的形式 若一阶微分方程可写成 𝑑𝑦 𝑦 = 𝐹( ) 𝑑𝑥 𝑥 则称为一阶齐次方程。 注意这里的“齐次”指 𝑦′ 右端只依赖比值 𝑥𝑦 ，不是线性方程中的齐次与非齐次概念。 2. 代换方法 令 𝑦 𝑣= 𝑥 即 𝑦 = 𝑣𝑥 对 𝑥 求导： 𝑑𝑦 𝑑𝑣 =𝑣+𝑥 𝑑𝑥 𝑑𝑥 代入原方程： 𝑑𝑣 𝑣+𝑥 = 𝐹 (𝑣) 𝑑𝑥 于是 𝑑𝑣 𝑥 = 𝐹 (𝑣) − 𝑣 𝑑𝑥 若 𝐹 (𝑣) − 𝑣 ≠ 0，可分离变量： 𝑑𝑣 𝑑𝑥 = 𝐹 (𝑣) − 𝑣 𝑥 两边积分，再把 𝑣 = 𝑥𝑦 代回。 3. 例题 题目 求解 𝑦′ = 1 + 𝑥𝑦 。 解析：令 𝑣 = 𝑥𝑦 ，则 𝑦 = 𝑣𝑥，所以 𝑦′ = 𝑣 + 𝑥𝑣′ 代入： 𝑣 + 𝑥𝑣′ = 1 + 𝑣 得到 𝑥𝑣′ = 1 即"
  },
  {
    ...
    "page": 6,
    "heading": "考研数学 · 微分方程",
    "snippet": "考研数学 · 微分方程 𝑑𝑥 𝑑𝑣 = 𝑥 积分： 𝑣 = ln|𝑥| + 𝐶 代回 𝑣 = 𝑥𝑦 ： 𝑦 = 𝑥[ln|𝑥| + 𝐶]",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 考研数学 · 微分方程 考研数学 · 微分方程 𝑑𝑥 𝑑𝑣 = 𝑥 积分： 𝑣 = ln|𝑥| + 𝐶 代回 𝑣 = 𝑥𝑦 ： 𝑦 = 𝑥[ln|𝑥| + 𝐶]"
  },
  {
    ...
    "page": 7,
    "heading": "四、一阶线性微分方程",
    "snippet": "考研数学 · 微分方程 四、一阶线性微分方程 1. 标准形式 一阶线性微分方程标准形式为 𝑦′ + 𝑃 (𝑥)𝑦 = 𝑄(𝑥) 其中 𝑃 (𝑥)、𝑄(𝑥) 是已知函数。 若 𝑄(𝑥) = 0，称为一阶线性齐次方程： 𝑦′ + 𝑃 (𝑥)𝑦 = 0 若 𝑄(𝑥) ≠ 0，称为一阶线性非齐次方程： 𝑦′ + 𝑃 (𝑥)𝑦 = 𝑄(𝑥) 2. ...",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 四、一阶线性微分方程 考研数学 · 微分方程 四、一阶线性微分方程 1. 标准形式 一阶线性微分方程标准形式为 𝑦′ + 𝑃 (𝑥)𝑦 = 𝑄(𝑥) 其中 𝑃 (𝑥)、𝑄(𝑥) 是已知函数。 若 𝑄(𝑥) = 0，称为一阶线性齐次方程： 𝑦′ + 𝑃 (𝑥)𝑦 = 0 若 𝑄(𝑥) ≠ 0，称为一阶线性非齐次方程： 𝑦′ + 𝑃 (𝑥)𝑦 = 𝑄(𝑥) 2. 齐次方程解法 对于 𝑦′ + 𝑃 (𝑥)𝑦 = 0 有 𝑑𝑦 = −𝑃 (𝑥)𝑦 𝑑𝑥 分离变量： 𝑑𝑦 = −𝑃 (𝑥)𝑑𝑥 𝑦 积分： ln|𝑦| = − ∫ 𝑃 (𝑥)𝑑𝑥 + 𝐶 所以通解为 𝑦 = 𝐶𝑒− ∫ 𝑃 (𝑥)𝑑𝑥 3. 非齐次方程积分因子法 对 𝑦′ + 𝑃 (𝑥)𝑦 = 𝑄(𝑥) 取积分因子 𝜇(𝑥) = 𝑒∫ 𝑃 (𝑥)𝑑𝑥 两边乘以 𝜇(𝑥)： 𝜇𝑦′ + 𝜇𝑃 𝑦 = 𝜇𝑄 由于 (𝜇𝑦)′ = 𝜇𝑦′ + 𝜇′ 𝑦 又"
  },
  {
    ...
    "page": 8,
    "heading": "4. 通解结构",
    "snippet": "考研数学 · 微分方程 𝜇′ = 𝑃 𝜇 所以 (𝜇𝑦)′ = 𝜇𝑦′ + 𝜇𝑃 𝑦 方程化为 (𝜇𝑦)′ = 𝜇𝑄 两边积分： 𝜇𝑦 = ∫ 𝜇(𝑥)𝑄(𝑥)𝑑𝑥 + 𝐶 因此通解为 𝑦 = 𝑒− ∫ 𝑃 (𝑥)𝑑𝑥 [∫ 𝑒∫ 𝑃 (𝑥)𝑑𝑥 𝑄(𝑥)𝑑𝑥 + 𝐶] 4. 通解结构 非齐次线性方程的通解可写成 𝑦 = 𝑦ℎ + 𝑦𝑝 ...",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 4. 通解结构 考研数学 · 微分方程 𝜇′ = 𝑃 𝜇 所以 (𝜇𝑦)′ = 𝜇𝑦′ + 𝜇𝑃 𝑦 方程化为 (𝜇𝑦)′ = 𝜇𝑄 两边积分： 𝜇𝑦 = ∫ 𝜇(𝑥)𝑄(𝑥)𝑑𝑥 + 𝐶 因此通解为 𝑦 = 𝑒− ∫ 𝑃 (𝑥)𝑑𝑥 [∫ 𝑒∫ 𝑃 (𝑥)𝑑𝑥 𝑄(𝑥)𝑑𝑥 + 𝐶] 4. 通解结构 非齐次线性方程的通解可写成 𝑦 = 𝑦ℎ + 𝑦𝑝 其中 𝑦ℎ 是对应齐次方程的通解，𝑦𝑝 是非齐次方程的一个特解。 也就是说： 非齐次通解 = 齐次通解 + 非齐次一个特解 5. 例题 题目 求解 𝑦′ − 2𝑦 = 𝑒3𝑥 。 解析：这里 𝑃 (𝑥) = −2, 𝑄(𝑥) = 𝑒3𝑥 积分因子为 𝜇(𝑥) = 𝑒∫ −2𝑑𝑥 = 𝑒−2𝑥 两边乘以 𝑒−2𝑥 ： 𝑒−2𝑥 𝑦′ − 2𝑒−2𝑥 𝑦 = 𝑒𝑥 左边是 ′ (𝑒−2𝑥 𝑦) 所以 ′ (𝑒−2𝑥 𝑦) = 𝑒𝑥 积分得 𝑒−2𝑥 𝑦 = 𝑒𝑥 + 𝐶 于是"
  },
  {
    ...
    "page": 9,
    "heading": "考研数学 · 微分方程",
    "snippet": "考研数学 · 微分方程 𝑦 = 𝑒3𝑥 + 𝐶𝑒2𝑥 其中 𝐶𝑒2𝑥 是齐次通解，𝑒3𝑥 是一个非齐次特解。",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 考研数学 · 微分方程 考研数学 · 微分方程 𝑦 = 𝑒3𝑥 + 𝐶𝑒2𝑥 其中 𝐶𝑒2𝑥 是齐次通解，𝑒3𝑥 是一个非齐次特解。"
  },
  {
    ...
    "page": 10,
    "heading": "五、伯努利方程",
    "snippet": "考研数学 · 微分方程 五、伯努利方程 1. 标准形式 伯努利方程为 𝑦′ + 𝑃 (𝑥)𝑦 = 𝑄(𝑥)𝑦𝑛 其中 𝑛 ≠ 0, 1。 当 𝑛 = 0 时，它就是一阶线性方程；当 𝑛 = 1 时，可合并为可分离变量方程。 2. 代换推导 两边同除以 𝑦𝑛 ： 𝑦−𝑛 𝑦′ + 𝑃 (𝑥)𝑦1−𝑛 = 𝑄(𝑥) 令 𝑧 = 𝑦1−𝑛 则 ...",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 五、伯努利方程 考研数学 · 微分方程 五、伯努利方程 1. 标准形式 伯努利方程为 𝑦′ + 𝑃 (𝑥)𝑦 = 𝑄(𝑥)𝑦𝑛 其中 𝑛 ≠ 0, 1。 当 𝑛 = 0 时，它就是一阶线性方程；当 𝑛 = 1 时，可合并为可分离变量方程。 2. 代换推导 两边同除以 𝑦𝑛 ： 𝑦−𝑛 𝑦′ + 𝑃 (𝑥)𝑦1−𝑛 = 𝑄(𝑥) 令 𝑧 = 𝑦1−𝑛 则 𝑧 ′ = (1 − 𝑛)𝑦−𝑛 𝑦′ 所以 𝑧′ 𝑦−𝑛 𝑦′ = 1−𝑛 代入得 𝑧′ + 𝑃 (𝑥)𝑧 = 𝑄(𝑥) 1−𝑛 两边乘以 1 − 𝑛： 𝑧′ + (1 − 𝑛)𝑃 (𝑥)𝑧 = (1 − 𝑛)𝑄(𝑥) 这样就化为一阶线性微分方程。 3. 解题模板 1. 识别 𝑦′ + 𝑃 (𝑥)𝑦 = 𝑄(𝑥)𝑦𝑛 。 2. 除以 𝑦𝑛 。 3. 令 𝑧 = 𝑦1−𝑛 。 4. 解关于 𝑧 的一阶线性方程。 5. 代回 𝑦。"
  },
  {
    ...
    "page": 11,
    "heading": "六、全微分方程",
    "snippet": "考研数学 · 微分方程 六、全微分方程 1. 标准形式 方程 𝑀 (𝑥, 𝑦)𝑑𝑥 + 𝑁 (𝑥, 𝑦)𝑑𝑦 = 0 若存在函数 𝑢(𝑥, 𝑦)，使得 𝑑𝑢 = 𝑀 𝑑𝑥 + 𝑁 𝑑𝑦 则称该方程为全微分方程。此时通解为 𝑢(𝑥, 𝑦) = 𝐶 2. 判别条件 若 𝑀 , 𝑁 在单连通区域内有连续偏导数，则方程为全微分方程的充分必要条件是...",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 六、全微分方程 考研数学 · 微分方程 六、全微分方程 1. 标准形式 方程 𝑀 (𝑥, 𝑦)𝑑𝑥 + 𝑁 (𝑥, 𝑦)𝑑𝑦 = 0 若存在函数 𝑢(𝑥, 𝑦)，使得 𝑑𝑢 = 𝑀 𝑑𝑥 + 𝑁 𝑑𝑦 则称该方程为全微分方程。此时通解为 𝑢(𝑥, 𝑦) = 𝐶 2. 判别条件 若 𝑀 , 𝑁 在单连通区域内有连续偏导数，则方程为全微分方程的充分必要条件是 𝜕𝑀 𝜕𝑁 = 𝜕𝑦 𝜕𝑥 3. 求解方法 由 𝜕𝑢 = 𝑀 (𝑥, 𝑦) 𝜕𝑥 先对 𝑥 积分： 𝑢(𝑥, 𝑦) = ∫ 𝑀 (𝑥, 𝑦)𝑑𝑥 + 𝜑(𝑦) 再对 𝑦 求偏导，并令其等于 𝑁 (𝑥, 𝑦)： 𝜕𝑢 = 𝑁 (𝑥, 𝑦) 𝜕𝑦 求出 𝜑′ (𝑦)，进而得到 𝜑(𝑦)。最后写出 𝑢(𝑥, 𝑦) = 𝐶 4. 例题 题目 求解 (2𝑥𝑦 + 1)𝑑𝑥 + 𝑥2 𝑑𝑦 = 0。 解析：这里 𝑀 = 2𝑥𝑦 + 1, 𝑁 = 𝑥2 有 𝜕𝑀 𝜕𝑁 = 2𝑥, = 2𝑥 𝜕𝑦 𝜕𝑥 因此是全微分方程。设 𝑑𝑢 = (2𝑥𝑦 + 1)𝑑𝑥 + 𝑥2 𝑑𝑦"
  },
  {
    ...
    "page": 12,
    "heading": "考研数学 · 微分方程",
    "snippet": "考研数学 · 微分方程 由 𝑢𝑥 = 2𝑥𝑦 + 1，对 𝑥 积分： 𝑢 = 𝑥2 𝑦 + 𝑥 + 𝜑(𝑦) 再对 𝑦 求偏导： 𝑢𝑦 = 𝑥2 + 𝜑′ (𝑦) 令 𝑢𝑦 = 𝑁 = 𝑥2 ，得 𝜑′ (𝑦) = 0 所以通解为 𝑥2 𝑦 + 𝑥 = 𝐶",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 考研数学 · 微分方程 考研数学 · 微分方程 由 𝑢𝑥 = 2𝑥𝑦 + 1，对 𝑥 积分： 𝑢 = 𝑥2 𝑦 + 𝑥 + 𝜑(𝑦) 再对 𝑦 求偏导： 𝑢𝑦 = 𝑥2 + 𝜑′ (𝑦) 令 𝑢𝑦 = 𝑁 = 𝑥2 ，得 𝜑′ (𝑦) = 0 所以通解为 𝑥2 𝑦 + 𝑥 = 𝐶"
  },
  {
    ...
    "page": 13,
    "heading": "七、可降阶高阶微分方程",
    "snippet": "考研数学 · 微分方程 七、可降阶高阶微分方程 有些高阶方程虽然阶数较高，但可以通过积分或变量代换降阶。 1. 形如 𝑦(𝑛) = 𝑓(𝑥) 直接连续积分 𝑛 次。 例如 𝑦″ = 6𝑥 积分一次： 𝑦′ = 3𝑥2 + 𝐶1 再积分： 𝑦 = 𝑥3 + 𝐶1 𝑥 + 𝐶2 2. 形如 𝑦″ = 𝑓(𝑥, 𝑦′ ) 方程不显含 𝑦。令 𝑝...",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 七、可降阶高阶微分方程 考研数学 · 微分方程 七、可降阶高阶微分方程 有些高阶方程虽然阶数较高，但可以通过积分或变量代换降阶。 1. 形如 𝑦(𝑛) = 𝑓(𝑥) 直接连续积分 𝑛 次。 例如 𝑦″ = 6𝑥 积分一次： 𝑦′ = 3𝑥2 + 𝐶1 再积分： 𝑦 = 𝑥3 + 𝐶1 𝑥 + 𝐶2 2. 形如 𝑦″ = 𝑓(𝑥, 𝑦′ ) 方程不显含 𝑦。令 𝑝 = 𝑦′ 则 𝑑𝑝 𝑦 ″ = 𝑝′ = 𝑑𝑥 方程化为一阶方程 𝑑𝑝 = 𝑓(𝑥, 𝑝) 𝑑𝑥 先求 𝑝(𝑥)，再由 𝑦′ = 𝑝(𝑥) 积分求 𝑦。 3. 形如 𝑦″ = 𝑓(𝑦, 𝑦′ ) 方程不显含 𝑥。令 𝑝 = 𝑦′ 把 𝑝 看作 𝑦 的函数。由链式法则 𝑑𝑝 𝑑𝑝 𝑑𝑦 𝑑𝑝 𝑦″ = = =𝑝 𝑑𝑥 𝑑𝑦 𝑑𝑥 𝑑𝑦 于是方程化为 𝑑𝑝 𝑝 = 𝑓(𝑦, 𝑝) 𝑑𝑦 这是关于 𝑝 与 𝑦 的一阶方程。 易错点：不显含 𝑥 时不能简单令 𝑝′ = 𝑦″ 后仍对 𝑥 积分。关键是把 𝑝 = 𝑦′ 看作 𝑦 的函数，使用 𝑦″ = 𝑝𝑑 𝑑𝑝 𝑦。"
  },
  {
    ...
    "page": 14,
    "heading": "八、线性微分方程总论",
    "snippet": "考研数学 · 微分方程 八、线性微分方程总论 1. 𝑛 阶线性微分方程 𝑛 阶线性微分方程的一般形式为 𝑦(𝑛) + 𝑎1 (𝑥)𝑦(𝑛−1) + … + 𝑎𝑛−1 (𝑥)𝑦′ + 𝑎𝑛(𝑥) 𝑦 = 𝑓(𝑥) 若 𝑓(𝑥) = 0，称为线性齐次微分方程： 𝑦(𝑛) + 𝑎1 (𝑥)𝑦(𝑛−1) + … + 𝑎𝑛(𝑥) 𝑦 = 0 若 𝑓...",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 八、线性微分方程总论 考研数学 · 微分方程 八、线性微分方程总论 1. 𝑛 阶线性微分方程 𝑛 阶线性微分方程的一般形式为 𝑦(𝑛) + 𝑎1 (𝑥)𝑦(𝑛−1) + … + 𝑎𝑛−1 (𝑥)𝑦′ + 𝑎𝑛(𝑥) 𝑦 = 𝑓(𝑥) 若 𝑓(𝑥) = 0，称为线性齐次微分方程： 𝑦(𝑛) + 𝑎1 (𝑥)𝑦(𝑛−1) + … + 𝑎𝑛(𝑥) 𝑦 = 0 若 𝑓(𝑥) ≠ 0，称为线性非齐次微分方程： 𝑦(𝑛) + 𝑎1 (𝑥)𝑦(𝑛−1) + … + 𝑎𝑛(𝑥) 𝑦 = 𝑓(𝑥) 2. 齐次线性方程解的叠加原理 若 𝑦1 , 𝑦2 , …, 𝑦𝑛 都是齐次线性方程的解，则 𝑦 = 𝐶1 𝑦1 + 𝐶2 𝑦2 + … + 𝐶𝑛 𝑦𝑛 也是齐次线性方程的解。 如果 𝑦1 , …, 𝑦𝑛 线性无关，则齐次方程通解为 𝑦ℎ = 𝐶1 𝑦1 + 𝐶2 𝑦2 + … + 𝐶𝑛 𝑦𝑛 3. 非齐次线性方程通解结构 若 𝑦𝑝 是非齐次方程的一个特解，𝑦ℎ 是对应齐次方程的通解，则非齐次方程通解为 𝑦 = 𝑦ℎ + 𝑦𝑝 证明思路： 令线性微分算子为 𝐿。非齐次方程为 𝐿(𝑦) = 𝑓(𝑥) 若 𝐿(𝑦𝑝 ) = 𝑓(𝑥), 𝐿(𝑦ℎ ) = 0 则 𝐿(𝑦ℎ + 𝑦𝑝 ) = 𝐿(𝑦ℎ ) + 𝐿(𝑦𝑝 ) = 0 + 𝑓(𝑥) = 𝑓(𝑥) 所以 𝑦ℎ + 𝑦𝑝 是非齐次方程的解。 反过来，若 𝑦1 和 𝑦2 是同一个非齐次方程的两个解，则 𝐿(𝑦1 − 𝑦2 ) = 𝐿(𝑦1 ) − 𝐿(𝑦2 ) = 𝑓(𝑥) − 𝑓(𝑥) = 0 所以两个非齐次解之差是对应齐次方程的解。"
  },
  {
    ...
    "category": "微积分",
    "page": 15,
    "heading": "九、二阶线性常系数齐次方程",
    "snippet": "考研数学 · 微分方程 九、二阶线性常系数齐次方程 1. 标准形式 二阶线性常系数齐次方程为 𝑦″ + 𝑝𝑦′ + 𝑞𝑦 = 0 其中 𝑝, 𝑞 为常数。 设试探解 𝑦 = 𝑒𝑟𝑥 则 𝑦′ = 𝑟𝑒𝑟𝑥 , 𝑦″ = 𝑟2 𝑒𝑟𝑥 代入方程： (𝑟2 + 𝑝𝑟 + 𝑞)𝑒𝑟𝑥 = 0 由于 𝑒𝑟𝑥 ≠ 0，得到特征方程： 𝑟2 + 𝑝𝑟...",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 九、二阶线性常系数齐次方程 考研数学 · 微分方程 九、二阶线性常系数齐次方程 1. 标准形式 二阶线性常系数齐次方程为 𝑦″ + 𝑝𝑦′ + 𝑞𝑦 = 0 其中 𝑝, 𝑞 为常数。 设试探解 𝑦 = 𝑒𝑟𝑥 则 𝑦′ = 𝑟𝑒𝑟𝑥 , 𝑦″ = 𝑟2 𝑒𝑟𝑥 代入方程： (𝑟2 + 𝑝𝑟 + 𝑞)𝑒𝑟𝑥 = 0 由于 𝑒𝑟𝑥 ≠ 0，得到特征方程： 𝑟2 + 𝑝𝑟 + 𝑞 = 0 2. 三种根的情况 特征根情况 齐次通解 两个不等实根 𝑟1 , 𝑟2 𝑦ℎ = 𝐶1 𝑒𝑟1 𝑥 + 𝐶2 𝑒𝑟2 𝑥 两个相等实根 𝑟1 = 𝑟2 = 𝑟 𝑦ℎ = (𝐶1 + 𝐶2 𝑥)𝑒𝑟𝑥 共轭复根 𝑟 = 𝛼 ± 𝛽𝑖 𝑦ℎ = 𝑒𝛼𝑥 (𝐶1 cos 𝛽𝑥 + 𝐶2 sin 𝛽𝑥) 3. 例题 题目 求解 𝑦″ − 3𝑦′ + 2𝑦 = 0。 解析：特征方程为 𝑟2 − 3𝑟 + 2 = 0 即 (𝑟 − 1)(𝑟 − 2) = 0 所以 𝑟1 = 1, 𝑟2 = 2 通解为 𝑦 = 𝐶1 𝑒𝑥 + 𝐶2 𝑒2𝑥"
  },
  {
    ...
    "category": "微积分",
    "page": 16,
    "heading": "十、二阶线性常系数非齐次方程",
    "snippet": "考研数学 · 微分方程 十、二阶线性常系数非齐次方程 1. 标准形式与总思路 二阶线性常系数非齐次方程为 𝑦″ + 𝑝𝑦′ + 𝑞𝑦 = 𝑓(𝑥) 通解为 𝑦 = 𝑦ℎ + 𝑦𝑝 其中 𝑦ℎ 由对应齐次方程 𝑦″ + 𝑝𝑦′ + 𝑞𝑦 = 0 求出，𝑦𝑝 是非齐次方程的一个特解。 2. 待定系数法适用对象 待定系数法常用于 𝑓(𝑥) 为以...",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 十、二阶线性常系数非齐次方程 考研数学 · 微分方程 十、二阶线性常系数非齐次方程 1. 标准形式与总思路 二阶线性常系数非齐次方程为 𝑦″ + 𝑝𝑦′ + 𝑞𝑦 = 𝑓(𝑥) 通解为 𝑦 = 𝑦ℎ + 𝑦𝑝 其中 𝑦ℎ 由对应齐次方程 𝑦″ + 𝑝𝑦′ + 𝑞𝑦 = 0 求出，𝑦𝑝 是非齐次方程的一个特解。 2. 待定系数法适用对象 待定系数法常用于 𝑓(𝑥) 为以下类型： 1. 多项式 𝑃𝑚(𝑥) 。 2. 指数函数 𝑒𝜆𝑥 。 3. 三角函数 cos 𝜔𝑥、sin 𝜔𝑥。 4. 它们的有限和或乘积，如 𝑒𝜆𝑥 𝑃𝑚(𝑥) 、𝑒𝜆𝑥 [𝐴 cos 𝜔𝑥 + 𝐵 sin 𝜔𝑥]。 3. 特解设法 右端 𝑓(𝑥) 特解初设形式 𝑃𝑚(𝑥) 𝑦𝑝 = 𝑄𝑚(𝑥) 𝑒𝜆𝑥 𝑃𝑚(𝑥) 𝑦𝑝 = 𝑒𝜆𝑥 𝑄𝑚(𝑥) 𝐴 cos 𝜔𝑥 + 𝐵 sin 𝜔𝑥 𝑦𝑝 = 𝑀 cos 𝜔𝑥 + 𝑁 sin 𝜔𝑥 𝑒𝜆𝑥 (𝐴 cos 𝜔𝑥 + 𝐵 sin 𝜔𝑥) 𝑦𝑝 = 𝑒𝜆𝑥 (𝑀 cos 𝜔𝑥 + 𝑁 sin 𝜔𝑥) 如果初设形式与齐次解重复，需要乘以 𝑥𝑘 ，其中 𝑘 是重复根的重数。更一般地： 𝑦𝑝 = 𝑥𝑘 × 原初设形式 其中 𝑘 为对应特征根在特征方程中的重数。 4. 例题：右端为指数函数 题目 求解 𝑦″ − 3𝑦′ + 2𝑦 = 𝑒3𝑥 。 解析：先求齐次解。特征方程： 𝑟2 − 3𝑟 + 2 = 0 所以 𝑟1 = 1, 𝑟2 = 2 对应齐次通解： 𝑦ℎ = 𝐶1 𝑒𝑥 + 𝐶2 𝑒2𝑥 右端是 𝑒3𝑥 ，且 3 不是特征根，设"
  },
  {
    ...
    "category": "微积分",
    "page": 17,
    "heading": "5. 例题：右端与齐次解重复",
    "snippet": "考研数学 · 微分方程 𝑦𝑝 = 𝐴𝑒3𝑥 则 𝑦𝑝′ = 3𝐴𝑒3𝑥 , 𝑦𝑝″ = 9𝐴𝑒3𝑥 代入左端： 𝑦𝑝″ − 3𝑦𝑝′ + 2𝑦𝑝 = (9𝐴 − 9𝐴 + 2𝐴)𝑒3𝑥 = 2𝐴𝑒3𝑥 令其等于 𝑒3𝑥 ，得 2𝐴 = 1 所以 1 𝐴= 2 通解为 1 𝑦 = 𝐶1 𝑒𝑥 + 𝐶2 𝑒2𝑥 + 𝑒3𝑥 2 5. 例题：右...",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 5. 例题：右端与齐次解重复 考研数学 · 微分方程 𝑦𝑝 = 𝐴𝑒3𝑥 则 𝑦𝑝′ = 3𝐴𝑒3𝑥 , 𝑦𝑝″ = 9𝐴𝑒3𝑥 代入左端： 𝑦𝑝″ − 3𝑦𝑝′ + 2𝑦𝑝 = (9𝐴 − 9𝐴 + 2𝐴)𝑒3𝑥 = 2𝐴𝑒3𝑥 令其等于 𝑒3𝑥 ，得 2𝐴 = 1 所以 1 𝐴= 2 通解为 1 𝑦 = 𝐶1 𝑒𝑥 + 𝐶2 𝑒2𝑥 + 𝑒3𝑥 2 5. 例题：右端与齐次解重复 题目 求解 𝑦″ − 3𝑦′ + 2𝑦 = 𝑒𝑥 。 解析：对应齐次通解仍为 𝑦ℎ = 𝐶1 𝑒𝑥 + 𝐶2 𝑒2𝑥 右端 𝑒𝑥 对应的 𝜆 = 1 是特征根，且为一重根，所以不能设 𝐴𝑒𝑥 ，应乘以 𝑥： 𝑦𝑝 = 𝐴𝑥𝑒𝑥 计算： 𝑦𝑝′ = 𝐴𝑒𝑥 + 𝐴𝑥𝑒𝑥 = 𝐴(1 + 𝑥)𝑒𝑥 𝑦𝑝″ = 𝐴(2 + 𝑥)𝑒𝑥 代入： 𝑦𝑝″ − 3𝑦𝑝′ + 2𝑦𝑝 = 𝐴[(2 + 𝑥) − 3(1 + 𝑥) + 2𝑥]𝑒𝑥 = 𝐴[−1]𝑒𝑥 令其等于 𝑒𝑥 ，得 𝐴 = −1 因此 𝑦 = 𝐶1 𝑒𝑥 + 𝐶2 𝑒2𝑥 − 𝑥𝑒𝑥"
  },
  {
    ...
    "page": 18,
    "heading": "十一、常数变易法",
    "snippet": "考研数学 · 微分方程 十一、常数变易法 1. 一阶线性方程中的常数变易 一阶线性齐次方程 𝑦′ + 𝑃 (𝑥)𝑦 = 0 通解为 𝑦ℎ = 𝐶𝑒− ∫ 𝑃 (𝑥)𝑑𝑥 将常数 𝐶 看成函数 𝐶(𝑥)： 𝑦 = 𝐶(𝑥)𝑒− ∫ 𝑃 (𝑥)𝑑𝑥 代入非齐次方程 𝑦′ + 𝑃 (𝑥)𝑦 = 𝑄(𝑥)，即可求出 𝐶 ′ (𝑥)。这与积分因子法...",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 十一、常数变易法 考研数学 · 微分方程 十一、常数变易法 1. 一阶线性方程中的常数变易 一阶线性齐次方程 𝑦′ + 𝑃 (𝑥)𝑦 = 0 通解为 𝑦ℎ = 𝐶𝑒− ∫ 𝑃 (𝑥)𝑑𝑥 将常数 𝐶 看成函数 𝐶(𝑥)： 𝑦 = 𝐶(𝑥)𝑒− ∫ 𝑃 (𝑥)𝑑𝑥 代入非齐次方程 𝑦′ + 𝑃 (𝑥)𝑦 = 𝑄(𝑥)，即可求出 𝐶 ′ (𝑥)。这与积分因子法本质一致。 2. 二阶线性方程中的常数变易 对于 𝑦″ + 𝑝(𝑥)𝑦′ + 𝑞(𝑥)𝑦 = 𝑓(𝑥) 若对应齐次方程有一组基本解 𝑦1 , 𝑦2 ，则设特解为 𝑦𝑝 = 𝑢1 (𝑥)𝑦1 + 𝑢2 (𝑥)𝑦2 附加条件 𝑢1′ 𝑦1 + 𝑢2′ 𝑦2 = 0 并要求 𝑢1′ 𝑦1′ + 𝑢2′ 𝑦2′ = 𝑓(𝑥) 解线性方程组可得 𝑦 𝑓 𝑦1 𝑓 𝑢 1′ = − 2 , 𝑢2′ = 𝑊 𝑊 其中 𝑦 𝑦 𝑊 = ( 1 2 ) = 𝑦1 𝑦2′ − 𝑦1′ 𝑦2 𝑦1′ 𝑦2′ 因此 𝑦2 𝑓 𝑦 𝑓 𝑦𝑝 = −𝑦1 ∫ 𝑑𝑥 + 𝑦2 ∫ 1 𝑑𝑥 𝑊 𝑊 常数变易法适用范围比待定系数法更广，但计算量通常更大。"
  },
  {
    "id": "doc-2e19c43e8eca-p19",
    "docId": "doc-2e19c43e8eca",
    "title": "Ordinary Differential Equations (常微分方程)",
    "category": "微积分",
    "page": 19,
    "heading": "十二、欧拉方程",
    "snippet": "考研数学 · 微分方程 十二、欧拉方程 1. 标准形式 二阶欧拉方程常写为 𝑥2 𝑦″ + 𝑎𝑥𝑦′ + 𝑏𝑦 = 𝑓(𝑥) 对应齐次方程为 𝑥2 𝑦″ + 𝑎𝑥𝑦′ + 𝑏𝑦 = 0 2. 齐次欧拉方程解法 设 𝑦 = 𝑥𝑟 则 𝑦′ = 𝑟𝑥𝑟−1 , 𝑦″ = 𝑟(𝑟 − 1)𝑥𝑟−2 代入齐次方程： 𝑥2 𝑟(𝑟 − 1)𝑥𝑟−2...",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 十二、欧拉方程 考研数学 · 微分方程 十二、欧拉方程 1. 标准形式 二阶欧拉方程常写为 𝑥2 𝑦″ + 𝑎𝑥𝑦′ + 𝑏𝑦 = 𝑓(𝑥) 对应齐次方程为 𝑥2 𝑦″ + 𝑎𝑥𝑦′ + 𝑏𝑦 = 0 2. 齐次欧拉方程解法 设 𝑦 = 𝑥𝑟 则 𝑦′ = 𝑟𝑥𝑟−1 , 𝑦″ = 𝑟(𝑟 − 1)𝑥𝑟−2 代入齐次方程： 𝑥2 𝑟(𝑟 − 1)𝑥𝑟−2 + 𝑎𝑥𝑟𝑥𝑟−1 + 𝑏𝑥𝑟 = 0 化简： [𝑟(𝑟 − 1) + 𝑎𝑟 + 𝑏]𝑥𝑟 = 0 得到特征方程： 𝑟(𝑟 − 1) + 𝑎𝑟 + 𝑏 = 0 也即 𝑟2 + (𝑎 − 1)𝑟 + 𝑏 = 0 然后按特征根情况写解： 根的情况 齐次通解 不等实根 𝑟1 , 𝑟2 𝑦 = 𝐶1 𝑥𝑟1 + 𝐶2 𝑥𝑟2 相等实根 𝑟 𝑦 = (𝐶1 + 𝐶2 ln|𝑥|)𝑥𝑟 复根 𝑟 = 𝛼 ± 𝛽𝑖 𝑦 = 𝑥𝛼 [𝐶1 cos(𝛽 ln|𝑥|) + 𝐶2 sin(𝛽 ln|𝑥|)]"
  },
  {
    "id": "doc-2e19c43e8eca-p20",
    "docId": "doc-2e19c43e8eca",
    "title": "Ordinary Differential Equations (常微分方程)",
    "category": "微积分",
    "page": 20,
    "heading": "十三、齐次与非齐次、特解与通解的关系",
    "snippet": "考研数学 · 微分方程 十三、齐次与非齐次、特解与通解的关系 1. 齐次与非齐次的区别 对线性方程 𝐿(𝑦) = 𝑓(𝑥) 若右端 𝑓(𝑥) = 0，称为齐次方程；若 𝑓(𝑥) ≠ 0，称为非齐次方程。 齐次方程： 𝐿(𝑦) = 0 非齐次方程： 𝐿(𝑦) = 𝑓(𝑥) 2. 特解不是唯一的 非齐次方程的特解只要求满足原方程，不要求含有任...",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 十三、齐次与非齐次、特解与通解的关系 考研数学 · 微分方程 十三、齐次与非齐次、特解与通解的关系 1. 齐次与非齐次的区别 对线性方程 𝐿(𝑦) = 𝑓(𝑥) 若右端 𝑓(𝑥) = 0，称为齐次方程；若 𝑓(𝑥) ≠ 0，称为非齐次方程。 齐次方程： 𝐿(𝑦) = 0 非齐次方程： 𝐿(𝑦) = 𝑓(𝑥) 2. 特解不是唯一的 非齐次方程的特解只要求满足原方程，不要求含有任意常数。特解一般不唯一。 如果 𝑦𝑝 是一个特解，𝑦ℎ 是对应齐次方程任意解，则 𝑦𝑝 + 𝑦ℎ 仍然是非齐次方程的解。 所以“特解”只是用来构造通解的一块砖，不是唯一答案。 3. 通解必须包含完整任意常数 一阶方程通解通常含 1 个任意常数；二阶方程通解通常含 2 个任意常数；𝑛 阶方程通解通常含 𝑛 个任意常数。 对于非齐次线性方程，不能只写一个特解，必须补上对应齐次通解： 𝑦 = 𝑦ℎ + 𝑦𝑝 易错点： 很多错误答案只求出了 𝑦𝑝 ，没有加 𝑦ℎ 。只要是非齐次线性微分方程，最终通解一定要写成“齐次 通解 + 一个非齐次特解”。"
  },
  {
    "id": "doc-2e19c43e8eca-p21",
    "docId": "doc-2e19c43e8eca",
    "title": "Ordinary Differential Equations (常微分方程)",
    "category": "微积分",
    "page": 21,
    "heading": "十四、典型综合例题",
    "snippet": "考研数学 · 微分方程 十四、典型综合例题 例题 1：初值问题 题目 求解初值问题 𝑦′ + 𝑦 = 𝑒𝑥 , 𝑦(0) = 2。 解析：这是一阶线性方程， 𝑃 (𝑥) = 1, 𝑄(𝑥) = 𝑒𝑥 积分因子： 𝜇 = 𝑒∫ 1𝑑𝑥 = 𝑒𝑥 两边乘以 𝑒𝑥 ： 𝑒𝑥 𝑦′ + 𝑒𝑥 𝑦 = 𝑒2𝑥 即 (𝑒𝑥 𝑦)′ = 𝑒2𝑥 积分：...",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 十四、典型综合例题 考研数学 · 微分方程 十四、典型综合例题 例题 1：初值问题 题目 求解初值问题 𝑦′ + 𝑦 = 𝑒𝑥 , 𝑦(0) = 2。 解析：这是一阶线性方程， 𝑃 (𝑥) = 1, 𝑄(𝑥) = 𝑒𝑥 积分因子： 𝜇 = 𝑒∫ 1𝑑𝑥 = 𝑒𝑥 两边乘以 𝑒𝑥 ： 𝑒𝑥 𝑦′ + 𝑒𝑥 𝑦 = 𝑒2𝑥 即 (𝑒𝑥 𝑦)′ = 𝑒2𝑥 积分： 1 𝑒𝑥 𝑦 = 𝑒2𝑥 + 𝐶 2 所以通解为 1 𝑦 = 𝑒𝑥 + 𝐶𝑒−𝑥 2 代入 𝑦(0) = 2： 1 2= +𝐶 2 得 3 𝐶= 2 特解为 1 3 𝑦 = 𝑒𝑥 + 𝑒−𝑥 2 2 例题 2：二阶非齐次常系数方程 题目 求解 𝑦″ + 𝑦 = sin 𝑥。 解析：先解齐次方程： 𝑦″ + 𝑦 = 0 特征方程： 𝑟2 + 1 = 0 故"
  },
  {
    "id": "doc-2e19c43e8eca-p22",
    "docId": "doc-2e19c43e8eca",
    "title": "Ordinary Differential Equations (常微分方程)",
    "category": "微积分",
    "page": 22,
    "heading": "例题 3：不显含 𝑥 的降阶",
    "snippet": "考研数学 · 微分方程 𝑟 = ±𝑖 齐次通解： 𝑦ℎ = 𝐶1 cos 𝑥 + 𝐶2 sin 𝑥 右端 sin 𝑥 与齐次解重复，因此设特解时需乘以 𝑥。可设 𝑦𝑝 = 𝐴𝑥 cos 𝑥 计算： 𝑦𝑝′ = 𝐴 cos 𝑥 − 𝐴𝑥 sin 𝑥 𝑦𝑝″ = −2𝐴 sin 𝑥 − 𝐴𝑥 cos 𝑥 代入左端： 𝑦𝑝″ + 𝑦𝑝 = −2...",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 例题 3：不显含 𝑥 的降阶 考研数学 · 微分方程 𝑟 = ±𝑖 齐次通解： 𝑦ℎ = 𝐶1 cos 𝑥 + 𝐶2 sin 𝑥 右端 sin 𝑥 与齐次解重复，因此设特解时需乘以 𝑥。可设 𝑦𝑝 = 𝐴𝑥 cos 𝑥 计算： 𝑦𝑝′ = 𝐴 cos 𝑥 − 𝐴𝑥 sin 𝑥 𝑦𝑝″ = −2𝐴 sin 𝑥 − 𝐴𝑥 cos 𝑥 代入左端： 𝑦𝑝″ + 𝑦𝑝 = −2𝐴 sin 𝑥 令其等于 sin 𝑥，得 −2𝐴 = 1 所以 1 𝐴=− 2 通解为 1 𝑦 = 𝐶1 cos 𝑥 + 𝐶2 sin 𝑥 − 𝑥 cos 𝑥 2 例题 3：不显含 𝑥 的降阶 2 题目 求解 𝑦𝑦″ = (𝑦′ ) 。 解析：方程不显含 𝑥，令 𝑝 = 𝑦′ 并把 𝑝 看作 𝑦 的函数，则 𝑑𝑝 𝑦″ = 𝑝 𝑑𝑦 代入： 𝑑𝑝 𝑦𝑝 = 𝑝2 𝑑𝑦 当 𝑝 ≠ 0 时，两边除以 𝑝： 𝑑𝑝 𝑦 =𝑝 𝑑𝑦 分离变量： 𝑑𝑝 𝑑𝑦 = 𝑝 𝑦"
  },
  {
    "id": "doc-2e19c43e8eca-p23",
    "docId": "doc-2e19c43e8eca",
    "title": "Ordinary Differential Equations (常微分方程)",
    "category": "微积分",
    "page": 23,
    "heading": "考研数学 · 微分方程",
    "snippet": "考研数学 · 微分方程 积分： ln|𝑝| = ln|𝑦| + 𝐶 所以 𝑝 = 𝐶1 𝑦 即 𝑦′ = 𝐶1 𝑦 再分离变量： 𝑑𝑦 = 𝐶1 𝑑𝑥 𝑦 积分得 𝑦 = 𝐶2 𝑒𝐶1 𝑥 当 𝑝 = 0 时，得到常数解，也包含在 𝐶1 = 0 的情形中。",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 考研数学 · 微分方程 考研数学 · 微分方程 积分： ln|𝑝| = ln|𝑦| + 𝐶 所以 𝑝 = 𝐶1 𝑦 即 𝑦′ = 𝐶1 𝑦 再分离变量： 𝑑𝑦 = 𝐶1 𝑑𝑥 𝑦 积分得 𝑦 = 𝐶2 𝑒𝐶1 𝑥 当 𝑝 = 0 时，得到常数解，也包含在 𝐶1 = 0 的情形中。"
  },
  {
    "id": "doc-2e19c43e8eca-p24",
    "docId": "doc-2e19c43e8eca",
    "title": "Ordinary Differential Equations (常微分方程)",
    "category": "微积分",
    "page": 24,
  ...
  {
    "id": "doc-2e19c43e8eca-p25",
    "docId": "doc-2e19c43e8eca",
    "title": "Ordinary Differential Equations (常微分方程)",
    "category": "微积分",
    "page": 25,
    "heading": "十六、公式速查表",
    "snippet": "考研数学 · 微分方程 十六、公式速查表 内容 公式 𝑑𝑦 可分离变量 ∫ 𝑔(𝑦) = ∫ 𝑓(𝑥)𝑑𝑥 + 𝐶 一阶齐次代换 𝑦 = 𝑣𝑥, 𝑦′ = 𝑣 + 𝑥𝑣′ 一阶线性通解 𝑦 = 𝑒− ∫ 𝑃 𝑑𝑥 [∫ 𝑒∫ 𝑃 𝑑𝑥 𝑄𝑑𝑥 + 𝐶] 伯努利代换 𝑧 = 𝑦1−𝑛 𝜕𝑀 𝜕𝑁 全微分条件 𝜕𝑦 = 𝜕𝑥 不显含 𝑥 的降...",
    "text": "Ordinary Differential Equations (常微分方程) Ordinary Differential Equations 常微分方程 微积分 十六、公式速查表 考研数学 · 微分方程 十六、公式速查表 内容 公式 𝑑𝑦 可分离变量 ∫ 𝑔(𝑦) = ∫ 𝑓(𝑥)𝑑𝑥 + 𝐶 一阶齐次代换 𝑦 = 𝑣𝑥, 𝑦′ = 𝑣 + 𝑥𝑣′ 一阶线性通解 𝑦 = 𝑒− ∫ 𝑃 𝑑𝑥 [∫ 𝑒∫ 𝑃 𝑑𝑥 𝑄𝑑𝑥 + 𝐶] 伯努利代换 𝑧 = 𝑦1−𝑛 𝜕𝑀 𝜕𝑁 全微分条件 𝜕𝑦 = 𝜕𝑥 不显含 𝑥 的降阶 𝑝 = 𝑦′ , 𝑦″ = 𝑝 𝑑𝑝 𝑑𝑦 二阶齐次特征方程 𝑟2 + 𝑝𝑟 + 𝑞 = 0 非齐次通解结构 𝑦 = 𝑦ℎ + 𝑦 𝑝 欧拉齐次特征方程 𝑟(𝑟 − 1) + 𝑎𝑟 + 𝑏 = 0 最终抓手： 微分方程先分类：能不能分离变量？是不是 𝑦′ = 𝐹 ( 𝑥𝑦 )？是不是一阶线性？是不是二阶常系数 线性？如果是非齐次线性，永远记住最后答案是 𝑦ℎ + 𝑦𝑝 。初值条件只负责确定通解里的任意常数。"
  },
  {
    ...
    "page": 1,
    "heading": "考研数学 · 无穷级数",
    "snippet": "考研数学 · 无穷级数 无穷级数专项总结 数项级数 · 判别法 · 幂级数 · 泰勒展开 · 傅里叶级数 考研数学复习资料 · Typst PDF 首页速览 1 𝑎 • 核心公式：∑ 𝑞 𝑛 看 |𝑞| < 1；幂级数半径由 𝑅 = lim | 𝑎𝑛+1 | 确定。 𝑛 • 关键定理：正项级数常用比较、比值、根值和积分判别；交错级数用 L...",
    "text": "Infinite Series (无穷级数) Infinite Series 无穷级数 微积分 考研数学 · 无穷级数 考研数学 · 无穷级数 无穷级数专项总结 数项级数 · 判别法 · 幂级数 · 泰勒展开 · 傅里叶级数 考研数学复习资料 · Typst PDF 首页速览 1 𝑎 • 核心公式：∑ 𝑞 𝑛 看 |𝑞| < 1；幂级数半径由 𝑅 = lim | 𝑎𝑛+1 | 确定。 𝑛 • 关键定理：正项级数常用比较、比值、根值和积分判别；交错级数用 Leibniz 判别；绝对收敛必收敛。 • 方法抓手：先分类为正项、任意项、交错或幂级数；幂级数求出 𝑅 后必须单独检查端点。 复习目标： 无穷级数的核心是“看部分和是否有极限”。考研常考两条线：数项级数判断敛散性，幂级数求 收敛半径、收敛域与展开式。做题时先分类，再选判别法，最后单独检查端点和特殊项。"
  },
  {
    ...
    "page": 2,
    "heading": "一、无穷级数的基本概念",
    "snippet": "考研数学 · 无穷级数 一、无穷级数的基本概念 1. 数项级数 给定数列 𝑢1 , 𝑢2 , …, 𝑢𝑛 , …，形式和 ∞ ∑ 𝑢𝑛 = 𝑢1 + 𝑢2 + … + 𝑢𝑛 + … 𝑛=1 称为无穷级数，简称级数。 定义部分和 𝑛 𝑆𝑛 = ∑ 𝑢𝑘 𝑘=1 若极限 lim 𝑆𝑛 = 𝑆 𝑛→∞ ∞ 存在，则称级数 ∑𝑛=1 𝑢𝑛 收敛，...",
    "text": "Infinite Series (无穷级数) Infinite Series 无穷级数 微积分 一、无穷级数的基本概念 考研数学 · 无穷级数 一、无穷级数的基本概念 1. 数项级数 给定数列 𝑢1 , 𝑢2 , …, 𝑢𝑛 , …，形式和 ∞ ∑ 𝑢𝑛 = 𝑢1 + 𝑢2 + … + 𝑢𝑛 + … 𝑛=1 称为无穷级数，简称级数。 定义部分和 𝑛 𝑆𝑛 = ∑ 𝑢𝑘 𝑘=1 若极限 lim 𝑆𝑛 = 𝑆 𝑛→∞ ∞ 存在，则称级数 ∑𝑛=1 𝑢𝑛 收敛，且和为 𝑆 ；若极限不存在，则称级数发散。 2. 通项趋零是收敛的必要条件 若级数 ∑ 𝑢𝑛 收敛，则 lim 𝑢𝑛 = 0 𝑛→∞ 证明思路：因为 𝑢𝑛 = 𝑆𝑛 − 𝑆𝑛−1 若 𝑆𝑛 → 𝑆 ，则 𝑆𝑛−1 → 𝑆 ，所以 𝑢𝑛 = 𝑆𝑛 − 𝑆𝑛−1 → 0 但反过来不成立。即 𝑢𝑛 → 0 不能推出 ∑ 𝑢𝑛 收敛。 易错点： 判断级数敛散性时，第一步常先看 lim 𝑢𝑛 。若通项极限不为 0 或不存在，则级数一定发散；若通 项趋于 0，还需要进一步判别。 3. 收敛级数的基本性质 若 ∑ 𝑢𝑛 和 ∑ 𝑣𝑛 都收敛，则 ∞ ∞ ∞ ∑(𝑎𝑢𝑛 + 𝑏𝑣𝑛 ) = 𝑎 ∑ 𝑢𝑛 + 𝑏 ∑ 𝑣𝑛 𝑛=1 𝑛=1 𝑛=1 改变、增删有限项不影响级数的敛散性，但会改变级数的和。 如果 ∑ 𝑢𝑛 收敛，则去掉前 𝑚 项后的余项 ∞ 𝑅𝑚 = ∑ 𝑢𝑛 𝑛=𝑚+1 满足"
  },
  {
    ...
    "page": 3,
    "heading": "考研数学 · 无穷级数",
    "snippet": "考研数学 · 无穷级数 𝑅𝑚 → 0 (𝑚 → ∞)",
    "text": "Infinite Series (无穷级数) Infinite Series 无穷级数 微积分 考研数学 · 无穷级数 考研数学 · 无穷级数 𝑅𝑚 → 0 (𝑚 → ∞)"
  },
  {
  ...
  },
  {
    ...
    "text": "Infinite Series (无穷级数) Infinite Series 无穷级数 微积分 考研数学 · 无穷级数 考研数学 · 无穷级数 ∞ ∞ 𝑥𝑛 𝑥𝑛 𝑒𝑥 = ∑ , 𝑒−𝑥 = ∑ (−1)𝑛 𝑛=0 𝑛! 𝑛=0 𝑛! 更一般地，若 𝑎 > 0，则 ∞ (ln 𝑎)𝑛 𝑛 𝑎𝑥 = 𝑒𝑥 ln 𝑎 = ∑ 𝑥 𝑛=0 𝑛! 对数函数： ∞ 𝑥𝑛 ln(1 + 𝑥) = ∑ (−1)𝑛−1 , |𝑥| < 1 𝑛=1 𝑛 ∞ 𝑥𝑛 ln(1 − 𝑥) = − ∑ , |𝑥| < 1 𝑛=1 𝑛 三角函数： ∞ 𝑥2𝑛+1 sin 𝑥 = ∑ (−1)𝑛 𝑛=0 (2𝑛 + 1)! ∞ 𝑥2𝑛 cos 𝑥 = ∑ (−1)𝑛 𝑛=0 (2𝑛)! 𝑥3 2𝑥5 17𝑥7 tan 𝑥 = 𝑥 + + + +… 3 15 315 正切函数的完整通项可写为 ∞ (−1)𝑛−1 22𝑛 (22𝑛 − 1)𝐵2𝑛 2𝑛−1 tan 𝑥 = ∑ 𝑥 𝑛=1 (2𝑛)! 其中 𝐵2𝑛 表示伯努利数。考研计算中通常只需记住前几项。 三角函数倒数： 本小节补充 sec 𝑥、csc 𝑥、cot 𝑥 的常用展开；检索时也可使用 secx、cscx、cotx 作为关键词。 𝑥2 5𝑥4 61𝑥6 1385𝑥8 sec 𝑥 = 1 + + + + +… 2 24 720 40320 ∞ (−1)𝑛 𝐸2𝑛 2𝑛 𝜋 sec 𝑥 = ∑ 𝑥 , |𝑥| < 𝑛=0 (2𝑛)! 2 其中 𝐸2𝑛 表示欧拉数，按 𝐸0 = 1, 𝐸2 = −1, 𝐸4 = 5, 𝐸6 = −61, … 取值。 易错点： csc 𝑥 与 cot 𝑥 在 𝑥 = 0 处无定义，因此它们在 0 附近不是普通泰勒展开，而是含有 𝑥1 项的洛朗 展开。做极限题时要先保留这个奇异主项，再看后续项是否抵消。 1 𝑥 7𝑥3 31𝑥5 127𝑥7 csc 𝑥 = + + + + +… 𝑥 6 360 15120 604800 ∞ 1 (−1)𝑛−1 2(22𝑛−1 − 1)𝐵2𝑛 2𝑛−1 csc 𝑥 = +∑ 𝑥 , 0 < |𝑥| < 𝜋 𝑥 𝑛=1 (2𝑛)!"
  },
  {
    ...
    "page": 14,
    "heading": "考研数学 · 无穷级数",
    "snippet": "考研数学 · 无穷级数 1 𝑥 𝑥3 2𝑥5 𝑥7 cot 𝑥 = − − − − +… 𝑥 3 45 945 4725 ∞ 1 (−1)𝑛 22𝑛 𝐵2𝑛 2𝑛−1 cot 𝑥 = +∑ 𝑥 , 0 < |𝑥| < 𝜋 𝑥 𝑛=1 (2𝑛)! 反三角函数： ∞ (2𝑛)! arcsin 𝑥 = ∑ 𝑥2𝑛+1 𝑛=0 4𝑛 (𝑛!)2 ...",
    "text": "Infinite Series (无穷级数) Infinite Series 无穷级数 微积分 考研数学 · 无穷级数 考研数学 · 无穷级数 1 𝑥 𝑥3 2𝑥5 𝑥7 cot 𝑥 = − − − − +… 𝑥 3 45 945 4725 ∞ 1 (−1)𝑛 22𝑛 𝐵2𝑛 2𝑛−1 cot 𝑥 = +∑ 𝑥 , 0 < |𝑥| < 𝜋 𝑥 𝑛=1 (2𝑛)! 反三角函数： ∞ (2𝑛)! arcsin 𝑥 = ∑ 𝑥2𝑛+1 𝑛=0 4𝑛 (𝑛!)2 (2𝑛 + 1) ∞ 𝑥2𝑛+1 arctan 𝑥 = ∑ (−1)𝑛 𝑛=0 2𝑛 + 1 ∞ 𝜋 (2𝑛)! arccos 𝑥 = −∑ 𝑛 𝑥2𝑛+1 2 𝑛=0 4 (𝑛!)2 (2𝑛 + 1) 函数类型 通项形式 幂函数 (1 + 𝑥)𝛼 = ∑∞ 𝐶 𝑛 𝑥𝑛 𝑛=0 𝛼 𝑒 𝑥 = ∑∞ 𝑛 𝑥 指数函数 𝑛=0 𝑛! ln(1 + 𝑥) = ∑∞ 𝑛 对数函数 𝑛=1 (−1)𝑛−1 𝑥𝑛 ∞ 𝑥 2𝑛+1 正弦函数 sin 𝑥 = ∑𝑛=0 (−1)𝑛 (2𝑛+1)! cos 𝑥 = ∑∞ 2𝑛 𝑥 余弦函数 𝑛=0 (−1)𝑛 (2𝑛)! ∞ (−1)𝑛−1 22𝑛 (22𝑛 −1)𝐵2𝑛 2𝑛−1 正切函数 tan 𝑥 = ∑𝑛=1 (2𝑛)! 𝑥 ∞ (−1)𝑛 𝐸2𝑛 2𝑛 正割函数 sec 𝑥 = ∑𝑛=0 (2𝑛)! 𝑥 (−1)𝑛−1 2(22𝑛−1 −1)𝐵2𝑛 2𝑛−1 余割函数 csc 𝑥 = 𝑥1 + ∑∞ 𝑛=1 (2𝑛)! 𝑥 ∞ (−1)𝑛 22𝑛 𝐵2𝑛 2𝑛−1 余切函数 cot 𝑥 = 𝑥1 + ∑𝑛=1 (2𝑛)! 𝑥 反正弦 arcsin 𝑥 = ∑∞ (2𝑛)! 𝑥2𝑛+1 𝑛=04𝑛(𝑛!)2 (2𝑛+1) ∞ 2𝑛+1 反正切 arctan 𝑥 = ∑𝑛=0 (−1)𝑛 𝑥2𝑛+1 易错点： 只记一阶等价不够。若出现 𝑥 − sin 𝑥、tan 𝑥 − 𝑥、ln(1 + 𝑥) − 𝑥 这类低阶抵消结构，必须继续 展开到第一项非零高阶项。 4. 展开函数的常用方法 1. 直接用泰勒公式求导。 2. 从常用展开式替换变量。 3. 通过逐项求导或逐项积分得到新展开式。 4. 先作代数变形，再展开。 例如 1 1 2 = 1+𝑥 1 − (−𝑥2 ) 所以"
  },
  {
    ...
    "page": 15,
    "heading": "考研数学 · 无穷级数",
    "snippet": "考研数学 · 无穷级数 ∞ 1 = ∑ (−1)𝑛 𝑥2𝑛 , |𝑥| < 1 1 + 𝑥2 𝑛=0 逐项积分： ∞ 𝑥2𝑛+1 arctan 𝑥 = ∑ (−1)𝑛 , |𝑥| ≤ 1 𝑛=0 2𝑛 + 1",
    "text": "Infinite Series (无穷级数) Infinite Series 无穷级数 微积分 考研数学 · 无穷级数 考研数学 · 无穷级数 ∞ 1 = ∑ (−1)𝑛 𝑥2𝑛 , |𝑥| < 1 1 + 𝑥2 𝑛=0 逐项积分： ∞ 𝑥2𝑛+1 arctan 𝑥 = ∑ (−1)𝑛 , |𝑥| ≤ 1 𝑛=0 2𝑛 + 1"
  },
  {
  ...
  },
  {
    ...
    "snippet": "考研数学 · Linear Algebra · Determinants (行列式) Determinants (行列式) 定义 · 性质 · 展开 · 计算 · 应用 考研数学复习资料 · Typst PDF 首页速览 • 核心公式：|𝐴| = ∑ (−1)𝜏(𝑗1 …𝑗𝑛 ) 𝑎1𝑗1 …𝑎𝑛𝑗𝑛 ，|𝐴𝐵| = |𝐴‖𝐵|，|𝐴𝑇 ...",
    "text": "Determinants (行列式) Determinants 行列式 线性代数 定义 · 性质 · 展开 · 计算 · 应用 考研数学 · Linear Algebra · Determinants (行列式) Determinants (行列式) 定义 · 性质 · 展开 · 计算 · 应用 考研数学复习资料 · Typst PDF 首页速览 • 核心公式：|𝐴| = ∑ (−1)𝜏(𝑗1 …𝑗𝑛 ) 𝑎1𝑗1 …𝑎𝑛𝑗𝑛 ，|𝐴𝐵| = |𝐴‖𝐵|，|𝐴𝑇 | = |𝐴|。 • 关键定理：三角行列式等于主对角线乘积；Laplace 展开 |𝐴| = ∑ 𝑎𝑖𝑗 𝐴𝑖𝑗 ；Vandermonde 行列式 ∏ (𝑥𝑗 − 𝑗 𝑖<𝑗 𝑥𝑖 )。 • 方法抓手：二阶看有向面积，三阶看有向体积；计算优先化三角，其次按零多的行列展开。 复习目标： 行列式的核心是把矩阵是否可逆、线性方程组是否有唯一解、向量是否线性相关、几何面积体 积以及特征值和二次型判定等问题转化为一个数。复习时先理解有向面积、有向体积和伸缩倍数，再掌握性 质并选择化三角、按行列展开或利用特殊结构计算。"
  },
  {
  ...
  },
  {
    ...
    "page": 3,
    "heading": "二、几何意义与向量关系",
    "snippet": "考研数学 · Linear Algebra · Determinants (行列式) 二、几何意义与向量关系 1. 二阶行列式：二维有向面积 设二维向量 𝑢 = (𝑎, 𝑏)𝑇 , 𝑣 = (𝑐, 𝑑)𝑇 把它们作为列向量组成矩阵 𝑎 𝑐 𝐴 = (𝑢, 𝑣) = ( ) 𝑏 𝑑 则 det(𝐴) = 𝑎𝑑 − 𝑏𝑐 表示由 𝑢, 𝑣 张...",
    "text": "Determinants (行列式) Determinants 行列式 线性代数 二、几何意义与向量关系 考研数学 · Linear Algebra · Determinants (行列式) 二、几何意义与向量关系 1. 二阶行列式：二维有向面积 设二维向量 𝑢 = (𝑎, 𝑏)𝑇 , 𝑣 = (𝑐, 𝑑)𝑇 把它们作为列向量组成矩阵 𝑎 𝑐 𝐴 = (𝑢, 𝑣) = ( ) 𝑏 𝑑 则 det(𝐴) = 𝑎𝑑 − 𝑏𝑐 表示由 𝑢, 𝑣 张成的平行四边形的有向面积。实际面积取绝对值： 𝑆 = |det(𝑢, 𝑣)| 若题目要求由两个向量张成的三角形面积，则 1 𝑆triangle = |det(𝑢, 𝑣)| 2 2. 三阶行列式：三维有向体积 设三维向量 𝑢, 𝑣, 𝑤 作为列向量组成矩阵 𝐴 = (𝑢, 𝑣, 𝑤) 则 det(𝐴) 表示由 𝑢, 𝑣, 𝑤 张成的平行六面体的有向体积。实际体积为 𝑉 = |det(𝑢, 𝑣, 𝑤)| 若题目要求由三个向量张成的四面体体积，则 1 𝑉tetrahedron = |det(𝑢, 𝑣, 𝑤)| 6 三阶行列式还可写成混合积形式： det(𝑢, 𝑣, 𝑤) = 𝑢 ⋅ (𝑣 × 𝑤) 其中 𝑣 × 𝑤 的长度表示以 𝑣, 𝑤 为邻边的平行四边形面积，再与 𝑢 在法向方向上的投影相乘得到体积。 3. 符号、方向与退化 行列式的正负表示方向： 1. det(𝐴) > 0：保持方向，面积或体积为正向。 2. det(𝐴) < 0：方向翻转，面积或体积为负向。 3. det(𝐴) = 0：面积或体积塌缩为零。 当 det(𝑢, 𝑣) = 0 时，两个二维向量共线；当 det(𝑢, 𝑣, 𝑤) = 0 时，三个三维向量共面或线性相关。几何上就是 平行四边形面积或平行六面体体积为零。"
  },
  {
    ...
    "page": 4,
    "heading": "4. 线性变换的伸缩倍数",
    "snippet": "考研数学 · Linear Algebra · Determinants (行列式) 4. 线性变换的伸缩倍数 矩阵 𝐴 可以看成线性变换。二维中，|det(𝐴)| 是面积伸缩倍数；三维中，|det(𝐴)| 是体积伸缩倍数。 更一般地，𝑛 阶矩阵 𝐴 的 |det(𝐴)| 表示 𝑛 维体积的伸缩倍数。若 det(𝐴) = 0，说明变换把空...",
    "text": "Determinants (行列式) Determinants 行列式 线性代数 4. 线性变换的伸缩倍数 考研数学 · Linear Algebra · Determinants (行列式) 4. 线性变换的伸缩倍数 矩阵 𝐴 可以看成线性变换。二维中，|det(𝐴)| 是面积伸缩倍数；三维中，|det(𝐴)| 是体积伸缩倍数。 更一般地，𝑛 阶矩阵 𝐴 的 |det(𝐴)| 表示 𝑛 维体积的伸缩倍数。若 det(𝐴) = 0，说明变换把空间压扁到低 维，因而 𝐴 不可逆。 核心理解： 二阶行列式看面积，三阶行列式看体积，高阶行列式看高维体积伸缩。绝对值给大小，符号给 方向，是否为零给线性相关和可逆性。"
  },
  {
    ...
    "page": 5,
    "heading": "三、基本性质",
    "snippet": "考研数学 · Linear Algebra · Determinants (行列式) 三、基本性质 1. 转置不变 det(𝐴𝑇 ) = det(𝐴) 因此行性质和列性质完全对称。 2. 行列交换与倍乘 交换两行或两列，行列式变号： 𝑅𝑖 ↔ 𝑅𝑗 ⟹ det → − det 某一行或某一列乘以数 𝑘，行列式也乘以 𝑘。 3. 倍加不变 ...",
    "text": "Determinants (行列式) Determinants 行列式 线性代数 三、基本性质 考研数学 · Linear Algebra · Determinants (行列式) 三、基本性质 1. 转置不变 det(𝐴𝑇 ) = det(𝐴) 因此行性质和列性质完全对称。 2. 行列交换与倍乘 交换两行或两列，行列式变号： 𝑅𝑖 ↔ 𝑅𝑗 ⟹ det → − det 某一行或某一列乘以数 𝑘，行列式也乘以 𝑘。 3. 倍加不变 把某一行的 𝑘 倍加到另一行，行列式不变： 𝑅𝑖 → 𝑅𝑖 + 𝑘𝑅𝑗 (𝑖 ≠ 𝑗) 列变换同理。这是化三角计算的最重要工具。 4. 两行成比例则为零 若两行相同、两列相同、两行成比例或两列成比例，则行列式为零。更一般地，若行向量组或列向量组线性相 关，则 det(𝐴) = 0 5. 乘法性质 同阶方阵满足 det(𝐴𝐵) = det(𝐴) det(𝐵) 由此可得： 1 det(𝐴−1 ) = (det(𝐴) ≠ 0) det(𝐴) det(𝑘𝐴) = 𝑘𝑛 det(𝐴) 其中 𝐴 是 𝑛 阶方阵。"
  },
  {
    ...
    "page": 6,
    "heading": "四、展开定理",
    "snippet": "考研数学 · Linear Algebra · Determinants (行列式) 四、展开定理 1. 代数余子式 删除元素 𝑎𝑖𝑗 所在第 𝑖 行、第 𝑗 列后得到的 𝑛 − 1 阶行列式称为余子式，记作 𝑀𝑖𝑗 。代数余子式为 𝐴𝑖𝑗 = (−1)𝑖+𝑗 𝑀𝑖𝑗 2. 按行或列展开 按第 𝑖 行展开： 𝑛 det(𝐴) = ∑ 𝑎𝑖...",
    "text": "Determinants (行列式) Determinants 行列式 线性代数 四、展开定理 考研数学 · Linear Algebra · Determinants (行列式) 四、展开定理 1. 代数余子式 删除元素 𝑎𝑖𝑗 所在第 𝑖 行、第 𝑗 列后得到的 𝑛 − 1 阶行列式称为余子式，记作 𝑀𝑖𝑗 。代数余子式为 𝐴𝑖𝑗 = (−1)𝑖+𝑗 𝑀𝑖𝑗 2. 按行或列展开 按第 𝑖 行展开： 𝑛 det(𝐴) = ∑ 𝑎𝑖𝑗 𝐴𝑖𝑗 𝑗=1 按第 𝑗 列展开： 𝑛 det(𝐴) = ∑ 𝑎𝑖𝑗 𝐴𝑖𝑗 𝑖=1 计算时优先选择零最多的一行或一列展开。 3. 三阶展开公式的推导 以三阶行列式为例，设 𝑎11 𝑎12 𝑎13 𝐴= 𝑎21 𝑎22 𝑎23 (𝑎31 𝑎32 𝑎33 ) 按三阶行列式的定义，有 det(𝐴) = 𝑎11 𝑎22 𝑎33 + 𝑎12 𝑎23 𝑎31 + 𝑎13 𝑎21 𝑎32 −𝑎13 𝑎22 𝑎31 − 𝑎12 𝑎21 𝑎33 − 𝑎11 𝑎23 𝑎32 把含 𝑎11 , 𝑎12 , 𝑎13 的项分别分组： det(𝐴) = 𝑎11 (𝑎22 𝑎33 − 𝑎23 𝑎32 ) −𝑎12 (𝑎21 𝑎33 − 𝑎23 𝑎31 ) +𝑎13 (𝑎21 𝑎32 − 𝑎22 𝑎31 ) 另一方面，第一行三个元素对应的余子式为 𝑎 𝑎 𝑀11 = det ( 22 23 ) = 𝑎22 𝑎33 − 𝑎23 𝑎32 𝑎32 𝑎33 𝑎 𝑎 𝑀12 = det ( 21 23 ) = 𝑎21 𝑎33 − 𝑎23 𝑎31 𝑎31 𝑎33 𝑎 𝑎 𝑀13 = det ( 21 22 ) = 𝑎21 𝑎32 − 𝑎22 𝑎31 𝑎31 𝑎32 对应代数余子式为 𝐴11 = 𝑀11 , 𝐴12 = −𝑀12 , 𝐴13 = 𝑀13 因此"
  },
  {
  ...
  },
  {
    ...
    "page": 8,
    "heading": "五、常用计算方法",
    "snippet": "考研数学 · Linear Algebra · Determinants (行列式) 五、常用计算方法 方法 适用场景 关键动作 化三角 一般数字型行列式 用倍加不变制造零，最后乘主对角线 按行列展开 某行或某列零较多 选择零最多的位置展开 提取公因子 一行或一列有公共因子 先提出公共因子，再计算剩余行列式 特殊结构 主对角线、副对角线、...",
    "text": "Determinants (行列式) Determinants 行列式 线性代数 五、常用计算方法 考研数学 · Linear Algebra · Determinants (行列式) 五、常用计算方法 方法 适用场景 关键动作 化三角 一般数字型行列式 用倍加不变制造零，最后乘主对角线 按行列展开 某行或某列零较多 选择零最多的位置展开 提取公因子 一行或一列有公共因子 先提出公共因子，再计算剩余行列式 特殊结构 主对角线、副对角线、分块三角 识别零元素位置，直接套结构结论 拉普拉斯展开 分块零较多或某几行列有规律 按若干行列的子式整体展开 范德蒙德 幂次按列或按行排列 识别差积 ∏𝑖<𝑗 (𝑥𝑗 − 𝑥𝑖 ) 1. 主对角线行列式 若行列式只有主对角线上元素非零，即 𝑎1 0 … 0 0 𝑎2 … 0 𝐷 = det … … … … ( 0 0 … 𝑎𝑛 ) 则按逆序数法看，非零项只能从第 𝑖 行取第 𝑖 列元素。对应排列为 12…𝑛 其逆序数为 0，符号为正。因此 𝐷 = 𝑎1 𝑎2 …𝑎𝑛 上三角或下三角行列式同理。因为除主对角线排列外，其他排列至少会取到非零区域外的零元素，所以非零项 仍只剩主对角线乘积： det(𝐴) = 𝑎11 𝑎22 …𝑎𝑛𝑛 2 1 3 示例 若 𝐴 = (0 −1 4)，则 𝐴 为上三角矩阵， 0 0 5 det(𝐴) = 2 ⋅ (−1) ⋅ 5 = −10 2. 副对角线行列式 若行列式只有副对角线上元素非零： 0 0 … 𝑏1 0 0 … 0 𝐷 = det … … … … ( 𝑛 0 … 0) 𝑏 更清楚地说，第 𝑖 行的非零元素在第 𝑛 + 1 − 𝑖 列。唯一可能非零的排列为 𝑛, 𝑛 − 1, …, 2, 1 这个排列的逆序数为 𝑛(𝑛 − 1) 2"
  },
  {
    ...
    "page": 9,
    "heading": "3. 分块三角行列式",
    "snippet": "考研数学 · Linear Algebra · Determinants (行列式) 所以副对角线行列式为 𝑛(𝑛−1) 𝐷 = (−1) 2 𝑏1 𝑏2 …𝑏𝑛 其中 𝑏𝑖 = 𝑎𝑖,𝑛+1−𝑖 。 示例 三阶副对角线行列式 0 0 𝑎 det 0 𝑏 0 = (−1)3 𝑎𝑏𝑐 = −𝑎𝑏𝑐 ( 𝑐 0 0) 四阶副对角线行列式符号为...",
    "text": "Determinants (行列式) Determinants 行列式 线性代数 3. 分块三角行列式 考研数学 · Linear Algebra · Determinants (行列式) 所以副对角线行列式为 𝑛(𝑛−1) 𝐷 = (−1) 2 𝑏1 𝑏2 …𝑏𝑛 其中 𝑏𝑖 = 𝑎𝑖,𝑛+1−𝑖 。 示例 三阶副对角线行列式 0 0 𝑎 det 0 𝑏 0 = (−1)3 𝑎𝑏𝑐 = −𝑎𝑏𝑐 ( 𝑐 0 0) 四阶副对角线行列式符号为 (−1)6 = +。 3. 分块三角行列式 若 𝐵 𝐶 𝐴=( ) 0 𝐷 其中 𝐵, 𝐷 是方阵，则 det(𝐴) = det(𝐵) det(𝐷) 推导思路可以从拉普拉斯展开理解：下左块为零，凡是试图从下半部分选择左侧列的项都会含零；非零项只能 在左上块 𝐵 和右下块 𝐷 内部分别选列。因此整体行列式分解为两个子行列式的乘积。 4. 拉普拉斯展开式 行列式按一行或一列展开是代数余子式展开。拉普拉斯展开式是它的推广：可以按若干行或若干列整体展开。 设在 𝑛 阶行列式中固定第 𝑖1 , 𝑖2 , …, 𝑖𝑘 行，取列指标 1 ≤ 𝑗1 < 𝑗2 < … < 𝑗𝑘 ≤ 𝑛 由这些行列交叉处元素组成的 𝑘 阶子式记为 𝑀 ；删去这些行和列后得到的余子式记为 𝑀 ′ 。则按这 𝑘 行展开时： 𝐷 = ∑ (−1)𝑖1 +…+𝑖𝑘 +𝑗1 +…+𝑗𝑘 𝑀 𝑀 ′ 求和遍历所有 𝑘 个列指标的选择。 当 𝑘 = 1 时，这个公式退化为普通按一行展开。 示例 四阶行列式若前两行后两列全为零： 𝑎 𝑏 0 0 𝑐 𝑑 0 0 𝐷 = det 𝑒 𝑓 𝑔 ℎ ( 𝑞 𝑟 𝑠) 𝑝 按前两行作拉普拉斯展开，只有选第 1、2 列的子式不为零， 𝑎 𝑏 𝑔 ℎ 𝐷 = det ( ) ⋅ det ( ) 𝑐 𝑑 𝑟 𝑠 。 这就是分块下三角行列式结论的一个具体应用。"
  },
  {
    "id": "doc-2999b2188b1e-p10",
    "docId": "doc-2999b2188b1e",
    "title": "Determinants (行列式)",
    "category": "线性代数",
    "page": 10,
    "heading": "5. 范德蒙德行列式",
    "snippet": "考研数学 · Linear Algebra · Determinants (行列式) 5. 范德蒙德行列式 典型形式为 1 1 … 1 𝑥1 𝑥2 … 𝑥𝑛 𝑉 = … … … … 𝑛−1 𝑛−1 (𝑥1 𝑥2 … 𝑥𝑛−1 𝑛 ) 则 det(𝑉 ) = ∏ (𝑥𝑗 − 𝑥𝑖 ) 1≤𝑖<𝑗≤𝑛 推导要点如下： 1. 若 𝑥𝑖 = 𝑥𝑗...",
    "text": "Determinants (行列式) Determinants 行列式 线性代数 5. 范德蒙德行列式 考研数学 · Linear Algebra · Determinants (行列式) 5. 范德蒙德行列式 典型形式为 1 1 … 1 𝑥1 𝑥2 … 𝑥𝑛 𝑉 = … … … … 𝑛−1 𝑛−1 (𝑥1 𝑥2 … 𝑥𝑛−1 𝑛 ) 则 det(𝑉 ) = ∏ (𝑥𝑗 − 𝑥𝑖 ) 1≤𝑖<𝑗≤𝑛 推导要点如下： 1. 若 𝑥𝑖 = 𝑥𝑗 ，第 𝑖 列与第 𝑗 列相同，行列式为零，所以 det(𝑉 ) 必含因子 (𝑥𝑗 − 𝑥𝑖 )。 2. 所有 1 ≤ 𝑖 < 𝑗 ≤ 𝑛 的差因子都出现，因此 det(𝑉 ) 含有 ∏𝑖<𝑗 (𝑥𝑗 − 𝑥𝑖 )。 𝑛(𝑛−1) 3. 范德蒙德行列式总次数为 0 + 1 + … + (𝑛 − 1) = 2 ，与差积次数相同。 4. 比较最高次项系数可知常数因子为 1。 示例 三阶范德蒙德行列式 1 1 1 det 𝑥1 𝑥2 𝑥3 = (𝑥2 − 𝑥1 )(𝑥3 − 𝑥1 )(𝑥3 − 𝑥2 ) 2 2 2 𝑥 𝑥 𝑥 ( 1 2 3) 若 𝑥1 = 1, 𝑥2 = 2, 𝑥3 = 4，则行列式为 (2 − 1)(4 − 1)(4 − 2) = 6。 易错点： 范德蒙德行列式的符号取决于列的排列顺序。若列顺序写成 𝑥𝑛 , …, 𝑥2 , 𝑥1 ，差积符号会随交换列 次数改变。"
  },
  {
    "id": "doc-2999b2188b1e-p11",
    "docId": "doc-2999b2188b1e",
    "title": "Determinants (行列式)",
    "category": "线性代数",
    "page": 11,
    "heading": "六、与矩阵和方程组的联系",
    "snippet": "考研数学 · Linear Algebra · Determinants (行列式) 六、与矩阵和方程组的联系 1. 可逆判定 𝐴 可逆 ⟺ det(𝐴) ≠ 0 若 𝐴 可逆，则齐次方程组 𝐴𝑥 = 0 只有零解，非齐次方程组 𝐴𝑥 = 𝑏 有唯一解。 2. 克拉默法则 若 𝑛 元线性方程组 𝐴𝑥 = 𝑏 满足 𝐷 = det(𝐴) ≠...",
    "text": "Determinants (行列式) Determinants 行列式 线性代数 六、与矩阵和方程组的联系 考研数学 · Linear Algebra · Determinants (行列式) 六、与矩阵和方程组的联系 1. 可逆判定 𝐴 可逆 ⟺ det(𝐴) ≠ 0 若 𝐴 可逆，则齐次方程组 𝐴𝑥 = 0 只有零解，非齐次方程组 𝐴𝑥 = 𝑏 有唯一解。 2. 克拉默法则 若 𝑛 元线性方程组 𝐴𝑥 = 𝑏 满足 𝐷 = det(𝐴) ≠ 0，则唯一解为 𝐷𝑖 𝑥𝑖 = 𝐷 其中 𝐷𝑖 是把 𝐴 的第 𝑖 列换成常数列 𝑏 后得到的行列式。 易错点： 克拉默法则只适用于方程个数和未知数个数相同且系数行列式不为零的情形。若 𝐷 = 0，不能直 接说无解，必须再看秩。"
  },
  {
    "id": "doc-2999b2188b1e-p12",
    "docId": "doc-2999b2188b1e",
    "title": "Determinants (行列式)",
    "category": "线性代数",
    "page": 12,
    "heading": "七、典型题型",
    "snippet": "考研数学 · Linear Algebra · Determinants (行列式) 七、典型题型 1. 计算数字型或含参数行列式：优先用倍加变换化三角。 2. 证明行列式恒等式：常用行列式性质、转置、乘法性质或分块结构。 3. 判断矩阵可逆：计算或化简行列式 det(𝐴)，再看它是否为零。 4. 求方程组参数：先看行列式 det(𝐴) ...",
    "text": "Determinants (行列式) Determinants 行列式 线性代数 七、典型题型 考研数学 · Linear Algebra · Determinants (行列式) 七、典型题型 1. 计算数字型或含参数行列式：优先用倍加变换化三角。 2. 证明行列式恒等式：常用行列式性质、转置、乘法性质或分块结构。 3. 判断矩阵可逆：计算或化简行列式 det(𝐴)，再看它是否为零。 4. 求方程组参数：先看行列式 det(𝐴) 是否为零，再结合秩讨论。 5. 与特征值结合：若 𝜆𝑖 是 𝐴 的特征值，则行列式等于全部特征值之积：det(𝐴) = 𝜆1 𝜆2 …𝜆𝑛 。 6. 与向量几何结合：二阶行列式求平行四边形或三角形面积，三阶行列式求平行六面体或四面体体积。 解题顺序 看到行列式，先观察是否有公共因子、是否有相同或成比例的行列、是否能做倍加化零。若含参 数，通常先化简成因式形式，再讨论参数取值。"
  },
  {
    "id": "doc-2999b2188b1e-p13",
    "docId": "doc-2999b2188b1e",
    "title": "Determinants (行列式)",
    "category": "线性代数",
    "page": 13,
    "heading": "八、公式速查表",
    "snippet": "考研数学 · Linear Algebra · Determinants (行列式) 八、公式速查表 内容 公式 𝑎 𝑏 二阶行列式 det ( 𝑐 𝑑) = 𝑎𝑑 − 𝑏𝑐 逆序数法 det(𝐴) = ∑ (−1)𝜏 𝑎1𝑗1 𝑎2𝑗2 …𝑎𝑛𝑗𝑛 平行四边形面积 𝑆 = |det(𝑢, 𝑣)| 三角形面积 𝑆triangle = 12...",
    "text": "Determinants (行列式) Determinants 行列式 线性代数 八、公式速查表 考研数学 · Linear Algebra · Determinants (行列式) 八、公式速查表 内容 公式 𝑎 𝑏 二阶行列式 det ( 𝑐 𝑑) = 𝑎𝑑 − 𝑏𝑐 逆序数法 det(𝐴) = ∑ (−1)𝜏 𝑎1𝑗1 𝑎2𝑗2 …𝑎𝑛𝑗𝑛 平行四边形面积 𝑆 = |det(𝑢, 𝑣)| 三角形面积 𝑆triangle = 12 |det(𝑢, 𝑣)| 平行六面体体积 𝑉 = |det(𝑢, 𝑣, 𝑤)| 四面体体积 𝑉tetrahedron = 16 |det(𝑢, 𝑣, 𝑤)| 混合积 det(𝑢, 𝑣, 𝑤) = 𝑢 ⋅ (𝑣 × 𝑤) 转置 det(𝐴𝑇 ) = det(𝐴) 乘法 det(𝐴𝐵) = det(𝐴) det(𝐵) 1 逆矩阵 det(𝐴−1 ) = det(𝐴) 数乘矩阵 det(𝑘𝐴) = 𝑘𝑛 det(𝐴) 𝑛 按行展开 det(𝐴) = ∑𝑗=1 𝑎𝑖𝑗 𝐴𝑖𝑗 主对角线/三角 det(𝐴) = 𝑎11 𝑎22 …𝑎𝑛𝑛 𝑛(𝑛−1) 副对角线 𝐷 = (−1) 2 𝑏1 𝑏2 …𝑏𝑛 拉普拉斯展开 𝐷 = ∑ (−1)∑ 𝑖+ ∑ 𝑗 𝑀 𝑀 ′ 范德蒙德 𝑉 = ∏1≤𝑖<𝑗≤𝑛 (𝑥𝑗 − 𝑥𝑖 ) 可逆判定 𝐴 可逆 ⟺ det(𝐴) ≠ 0 最终抓手： 行列式计算的主线是“先理解几何含义，再化简结构并套性质”。二阶看有向面积，三阶看有向 体积，高阶看体积伸缩；计算时最常用的是倍加不变、交换变号、提取因子和化三角。"
  },
  {
    ...
    "category": "线性代数",
    "page": 1,
    "heading": "考研数学 · Linear Algebra · Matrices (矩阵)",
    "snippet": "考研数学 · Linear Algebra · Matrices (矩阵) Matrices (矩阵) 运算 · 逆矩阵 · 初等变换 · 秩 · 分块 考研数学复习资料 · Typst PDF 首页速览 • 核心公式：𝑐𝑖𝑗 = ∑ 𝑎𝑖𝑘 𝑏𝑘𝑗 ，𝐴−1 𝐴 = 𝐼 ，𝑟(𝐴) = 𝑟(𝑃 𝐴𝑄)。 𝑘 • 关键定理：𝐴 可逆等价于...",
    "text": "Matrices (矩阵) Matrices 矩阵 线性代数 考研数学 · Linear Algebra · Matrices (矩阵) 考研数学 · Linear Algebra · Matrices (矩阵) Matrices (矩阵) 运算 · 逆矩阵 · 初等变换 · 秩 · 分块 考研数学复习资料 · Typst PDF 首页速览 • 核心公式：𝑐𝑖𝑗 = ∑ 𝑎𝑖𝑘 𝑏𝑘𝑗 ，𝐴−1 𝐴 = 𝐼 ，𝑟(𝐴) = 𝑟(𝑃 𝐴𝑄)。 𝑘 • 关键定理：𝐴 可逆等价于 |𝐴| ≠ 0、𝑟(𝐴) = 𝑛、𝐴𝑥 = 0 只有零解；Gram 矩阵 𝐺 = 𝐴𝑇 𝐴 半正定。 • 方法抓手：乘法看维数匹配，初等变换看秩和逆，分块矩阵先确认块大小和可交换条件。 复习目标：矩阵是线性代数的语言。考研中矩阵章节常用于表达线性方程组、向量组、特征值和二次型。复 习重点是矩阵运算规则、可逆判定、初等变换、矩阵秩、Gram 矩阵和分块矩阵。"
  },
  {
    ...
    "page": 2,
    "heading": "一、矩阵与基本运算",
    "snippet": "考研数学 · Linear Algebra · Matrices (矩阵) 一、矩阵与基本运算 1. 矩阵定义 由 𝑚𝑛 个数排成的 𝑚 行 𝑛 列表称为 𝑚 × 𝑛 矩阵，记为 𝐴 = (𝑎𝑖𝑗 ) 𝑚×𝑛 当 𝑚 = 𝑛 时称为方阵。 2. 加法与数乘 同型矩阵才能相加： 𝐴 + 𝐵 = (𝑎𝑖𝑗 + 𝑏𝑖𝑗 ) 数乘为 𝑘𝐴 = (...",
    "text": "Matrices (矩阵) Matrices 矩阵 线性代数 一、矩阵与基本运算 考研数学 · Linear Algebra · Matrices (矩阵) 一、矩阵与基本运算 1. 矩阵定义 由 𝑚𝑛 个数排成的 𝑚 行 𝑛 列表称为 𝑚 × 𝑛 矩阵，记为 𝐴 = (𝑎𝑖𝑗 ) 𝑚×𝑛 当 𝑚 = 𝑛 时称为方阵。 2. 加法与数乘 同型矩阵才能相加： 𝐴 + 𝐵 = (𝑎𝑖𝑗 + 𝑏𝑖𝑗 ) 数乘为 𝑘𝐴 = (𝑘𝑎𝑖𝑗 ) 3. 矩阵乘法 若 𝐴 是 𝑚 × 𝑛 矩阵，𝐵 是 𝑛 × 𝑠 矩阵，则 𝐴𝐵 是 𝑚 × 𝑠 矩阵，元素为 𝑛 𝑐𝑖𝑗 = ∑ 𝑎𝑖𝑘 𝑏𝑘𝑗 𝑘=1 易错点： 矩阵乘法一般不满足交换律，即通常 𝐴𝐵 ≠ 𝐵𝐴。很多题的错误都来自把矩阵当作普通数来移项 或约分。 4. 转置 𝑇 (𝐴𝑇 ) = 𝐴 (𝐴 + 𝐵)𝑇 = 𝐴𝑇 + 𝐵𝑇 (𝐴𝐵)𝑇 = 𝐵𝑇 𝐴𝑇"
  },
  {
    ...
    "page": 3,
    "heading": "二、特殊矩阵",
    "snippet": "考研数学 · Linear Algebra · Matrices (矩阵) 二、特殊矩阵 类型 条件 说明 零矩阵 所有元素为零 加法零元 单位矩阵 主对角线为 1，其余为 0 𝐴𝐼 = 𝐼𝐴 = 𝐴 对角矩阵 非主对角线元素为 0 运算和特征值较简单 上三角矩阵 主对角线下方元素为 0 行列式为主对角线乘积 对称矩阵 𝐴𝑇 = 𝐴 二次...",
    "text": "Matrices (矩阵) Matrices 矩阵 线性代数 二、特殊矩阵 考研数学 · Linear Algebra · Matrices (矩阵) 二、特殊矩阵 类型 条件 说明 零矩阵 所有元素为零 加法零元 单位矩阵 主对角线为 1，其余为 0 𝐴𝐼 = 𝐼𝐴 = 𝐴 对角矩阵 非主对角线元素为 0 运算和特征值较简单 上三角矩阵 主对角线下方元素为 0 行列式为主对角线乘积 对称矩阵 𝐴𝑇 = 𝐴 二次型和正交对角化常用 正交矩阵 𝐴𝑇 𝐴 = 𝐼 𝐴−1 = 𝐴𝑇"
  },
  {
    ...
    "page": 4,
    "heading": "三、Gram 矩阵",
    "snippet": "考研数学 · Linear Algebra · Matrices (矩阵) 三、Gram 矩阵 1. 定义 设有向量组 𝛼1 , 𝛼2 , …, 𝛼𝑠 在实内积空间中，定义矩阵 𝐺 = (𝑔𝑖𝑗 ) , 𝑔𝑖𝑗 = 𝛼𝑇𝑖 𝛼𝑗 𝑠×𝑠 则 𝐺 称为该向量组的 Gram 矩阵，也可写作 𝛼𝑇1 𝛼1 𝛼𝑇1 𝛼2 … 𝛼𝑇1 𝛼𝑠 𝛼𝑇2...",
    "text": "Matrices (矩阵) Matrices 矩阵 线性代数 三、Gram 矩阵 考研数学 · Linear Algebra · Matrices (矩阵) 三、Gram 矩阵 1. 定义 设有向量组 𝛼1 , 𝛼2 , …, 𝛼𝑠 在实内积空间中，定义矩阵 𝐺 = (𝑔𝑖𝑗 ) , 𝑔𝑖𝑗 = 𝛼𝑇𝑖 𝛼𝑗 𝑠×𝑠 则 𝐺 称为该向量组的 Gram 矩阵，也可写作 𝛼𝑇1 𝛼1 𝛼𝑇1 𝛼2 … 𝛼𝑇1 𝛼𝑠 𝛼𝑇2 𝛼1 𝛼𝑇2 𝛼2 … 𝛼𝑇2 𝛼𝑠 𝐺= … … … … 𝛼 𝑇 𝛼 𝛼𝑇 𝛼 … 𝛼𝑇 𝛼 ( 𝑠 1 𝑠 2 𝑠 𝑠) 如果把这些向量作为列组成矩阵 𝐴 = (𝛼1 , 𝛼2 , …, 𝛼𝑠 ) 则 Gram 矩阵可以简写为 𝐺 = 𝐴𝑇 𝐴 2. 基本性质 Gram 矩阵有以下性质： 1. 𝐺 是对称矩阵，因为 𝑔𝑖𝑗 = 𝛼𝑇 𝑇 𝑖 𝛼𝑗 = 𝛼𝑗 𝛼𝑖 = 𝑔𝑗𝑖 。 2. 对任意向量 𝑥，有 𝑥𝑇 𝐺𝑥 = 𝑥𝑇 𝐴𝑇 𝐴𝑥 = (𝐴𝑥)𝑇 (𝐴𝑥) = |𝐴𝑥|2 ≥ 0 因此 𝐺 半正定。 3. rank(𝐺) = rank(𝐴)，所以 Gram 矩阵的秩等于向量组的秩。 4. 若 𝛼1 , …, 𝛼𝑠 线性无关，则 𝐺 正定，且 det(𝐺) > 0。 5. 若 𝛼1 , …, 𝛼𝑠 线性相关，则 det(𝐺) = 0。 判定关系：Gram 矩阵把“向量组的线性无关性”转化为“矩阵正定性或行列式是否为零”。对有限个实向量， 𝛼1 , …, 𝛼𝑠 线性无关，当且仅当 det(𝐺) > 0。 3. 几何意义 Gram 行列式表示向量组张成的几何量的平方。若 𝛼1 , …, 𝛼𝑠 张成一个 𝑠 维平行体，则 Vol2 = det(𝐺) 二维时，设向量 𝑢, 𝑣 的 Gram 矩阵为 𝑢⋅𝑢 𝑢⋅𝑣 𝐺=( ) 𝑣⋅𝑢 𝑣⋅𝑣 则 det(𝐺) = |𝑢|2 |𝑣|2 − (𝑢 ⋅ 𝑣)2"
  },
  {
    ...
    "page": 5,
    "heading": "4. 示例",
    "snippet": "考研数学 · Linear Algebra · Matrices (矩阵) 它等于由 𝑢, 𝑣 张成的平行四边形面积的平方。 4. 示例 设 𝑢 = (1, 2)𝑇 , 𝑣 = (3, 1)𝑇 则 𝑢 ⋅ 𝑢 = 5, 𝑢 ⋅ 𝑣 = 5, 𝑣 ⋅ 𝑣 = 10 Gram 矩阵为 5 5 𝐺=( ) 5 10 其行列式为 det(𝐺) =...",
    "text": "Matrices (矩阵) Matrices 矩阵 线性代数 4. 示例 考研数学 · Linear Algebra · Matrices (矩阵) 它等于由 𝑢, 𝑣 张成的平行四边形面积的平方。 4. 示例 设 𝑢 = (1, 2)𝑇 , 𝑣 = (3, 1)𝑇 则 𝑢 ⋅ 𝑢 = 5, 𝑢 ⋅ 𝑣 = 5, 𝑣 ⋅ 𝑣 = 10 Gram 矩阵为 5 5 𝐺=( ) 5 10 其行列式为 det(𝐺) = 5 ⋅ 10 − 5 ⋅ 5 = 25 > 0 因此 𝑢, 𝑣 线性无关。它们张成的平行四边形面积为 𝑆 = √det(𝐺) = 5 易错点： Gram 矩阵依赖内积。通常考研默认欧氏内积 𝛼𝑇 𝑖 𝛼𝑗 ；若题目给出其他内积，Gram 矩阵的元素要 按题目给定的内积计算。"
  },
  {
    ...
    "page": 6,
    "heading": "四、逆矩阵",
    "snippet": "考研数学 · Linear Algebra · Matrices (矩阵) 四、逆矩阵 1. 定义 若方阵 𝐴 存在方阵 𝐵，使得 𝐴𝐵 = 𝐵𝐴 = 𝐼 则称 𝐴 可逆，𝐵 为 𝐴 的逆矩阵，记为 𝐴−1 。 2. 可逆判定 对 𝑛 阶方阵 𝐴，以下命题等价： 1. 𝐴 可逆。 2. det(𝐴) ≠ 0。 3. rank(𝐴) = 𝑛...",
    "text": "Matrices (矩阵) Matrices 矩阵 线性代数 四、逆矩阵 考研数学 · Linear Algebra · Matrices (矩阵) 四、逆矩阵 1. 定义 若方阵 𝐴 存在方阵 𝐵，使得 𝐴𝐵 = 𝐵𝐴 = 𝐼 则称 𝐴 可逆，𝐵 为 𝐴 的逆矩阵，记为 𝐴−1 。 2. 可逆判定 对 𝑛 阶方阵 𝐴，以下命题等价： 1. 𝐴 可逆。 2. det(𝐴) ≠ 0。 3. rank(𝐴) = 𝑛。 4. 齐次方程组 𝐴𝑥 = 0 只有零解。 5. 对任意 𝑏，非齐次方程组 𝐴𝑥 = 𝑏 有唯一解。 3. 逆矩阵公式 若 𝐴 可逆，则 1 𝐴−1 = 𝐴∗ det(𝐴) 其中 𝐴∗ 是伴随矩阵。 常用运算： (𝐴𝐵)−1 = 𝐵−1 𝐴−1 −1 𝑇 (𝐴𝑇 ) = (𝐴−1 ) 1 −1 (𝑘𝐴)−1 = 𝐴 (𝑘 ≠ 0) 𝑘 易错点： (𝐴 + 𝐵)−1 通常不等于 𝐴−1 + 𝐵−1 。矩阵逆没有普通分式那样的拆分规则。"
  },
  {
    ...
    "page": 7,
    "heading": "五、初等变换与初等矩阵",
    "snippet": "考研数学 · Linear Algebra · Matrices (矩阵) 五、初等变换与初等矩阵 1. 三类初等行变换 1. 交换两行。 2. 某一行乘以非零常数。 3. 某一行的倍数加到另一行。 列变换同理。 2. 初等矩阵 对单位矩阵作一次初等变换得到的矩阵称为初等矩阵。对矩阵 𝐴 左乘初等矩阵，相当于对 𝐴 作对应的初等行 变换；...",
    "text": "Matrices (矩阵) Matrices 矩阵 线性代数 五、初等变换与初等矩阵 考研数学 · Linear Algebra · Matrices (矩阵) 五、初等变换与初等矩阵 1. 三类初等行变换 1. 交换两行。 2. 某一行乘以非零常数。 3. 某一行的倍数加到另一行。 列变换同理。 2. 初等矩阵 对单位矩阵作一次初等变换得到的矩阵称为初等矩阵。对矩阵 𝐴 左乘初等矩阵，相当于对 𝐴 作对应的初等行 变换；右乘初等矩阵，相当于作对应的初等列变换。 3. 用初等变换求逆 若 𝐴 可逆，则 (𝐴, 𝐼) → (𝐼, 𝐴−1 ) 即把增广矩阵左半部分通过行初等变换化为单位矩阵，右半部分即为逆矩阵。"
  },
  {
    "id": "doc-f8d85d8d3cbe-p8",
    "docId": "doc-f8d85d8d3cbe",
    "title": "Matrices (矩阵)",
    "category": "线性代数",
    "page": 8,
    "heading": "六、矩阵秩",
    "snippet": "考研数学 · Linear Algebra · Matrices (矩阵) 六、矩阵秩 1. 定义 矩阵 𝐴 中最高阶非零子式的阶数称为矩阵的秩，记为 rank(𝐴)。 2. 求秩方法 通过初等行变换把矩阵化为阶梯形矩阵，非零行的行数就是矩阵秩。 3. 秩的常用性质 rank(𝐴) ≤ min(𝑚, 𝑛) rank(𝐴𝑇 ) = rank...",
    "text": "Matrices (矩阵) Matrices 矩阵 线性代数 六、矩阵秩 考研数学 · Linear Algebra · Matrices (矩阵) 六、矩阵秩 1. 定义 矩阵 𝐴 中最高阶非零子式的阶数称为矩阵的秩，记为 rank(𝐴)。 2. 求秩方法 通过初等行变换把矩阵化为阶梯形矩阵，非零行的行数就是矩阵秩。 3. 秩的常用性质 rank(𝐴) ≤ min(𝑚, 𝑛) rank(𝐴𝑇 ) = rank(𝐴) rank(𝐴𝐵) ≤ min(rank(𝐴), rank(𝐵)) 若 𝑃 , 𝑄 可逆，则 rank(𝑃 𝐴𝑄) = rank(𝐴) 这说明初等行列变换不改变矩阵秩。"
  },
  {
    "id": "doc-f8d85d8d3cbe-p9",
    "docId": "doc-f8d85d8d3cbe",
    "title": "Matrices (矩阵)",
    "category": "线性代数",
    "page": 9,
    "heading": "七、分块矩阵",
    "snippet": "考研数学 · Linear Algebra · Matrices (矩阵) 七、分块矩阵 1. 分块运算 当矩阵规模较大或结构明显时，可以把矩阵按行列分块。分块矩阵不是一种新运算，而是把大矩阵看成由若干 小矩阵组成的“矩阵的矩阵”。使用时必须先确认每个分块的行数和列数。 若 𝐴 与 𝐵 采用相同分块方式，且对应分块同型，则 𝐴 + 𝐵 =...",
    "text": "Matrices (矩阵) Matrices 矩阵 线性代数 七、分块矩阵 考研数学 · Linear Algebra · Matrices (矩阵) 七、分块矩阵 1. 分块运算 当矩阵规模较大或结构明显时，可以把矩阵按行列分块。分块矩阵不是一种新运算，而是把大矩阵看成由若干 小矩阵组成的“矩阵的矩阵”。使用时必须先确认每个分块的行数和列数。 若 𝐴 与 𝐵 采用相同分块方式，且对应分块同型，则 𝐴 + 𝐵 = (𝐴𝑖𝑗 + 𝐵𝑖𝑗 ), 𝑘𝐴 = (𝑘𝐴𝑖𝑗 ) 例如 𝐴11 𝐴12 𝐵 𝐵 𝐴 + 𝐵11 𝐴12 + 𝐵12 ( ) + ( 11 12 ) = ( 11 ) 𝐴21 𝐴22 𝐵21 𝐵22 𝐴21 + 𝐵21 𝐴22 + 𝐵22 2. 分块乘法 分块乘法的形式与普通矩阵乘法一致：行分块乘列分块，再对中间分块求和。若 𝐴 = (𝐴𝑖𝑘 )，𝐵 = (𝐵𝑘𝑗 ) 的中 间分块维数相容，则 𝑡 𝐶 = 𝐴𝐵, 𝐶𝑖𝑗 = ∑ 𝐴𝑖𝑘 𝐵𝑘𝑗 𝑘=1 二阶分块的典型形式为 𝐴 𝐵 𝐸 𝐹 𝐴𝐸 + 𝐵𝐺 𝐴𝐹 + 𝐵𝐻 ( )( )=( ) 𝐶 𝐷 𝐺 𝐻 𝐶𝐸 + 𝐷𝐺 𝐶𝐹 + 𝐷𝐻 这里要求 𝐴𝐸 、𝐵𝐺 等每一项都能相乘，并且同一位置相加的分块必须同型。 易错点： 分块乘法可以像普通矩阵一样写，但不能只看“外形”。例如 𝐴𝐸 + 𝐵𝐺 成立的前提是 𝐴𝐸 与 𝐵𝐺 都有意义，且结果维数相同。 3. 转置、逆与单位分块 分块转置要同时转置每个分块，并交换分块位置： 𝑇 𝐴 𝐵 𝐴𝑇 𝐶 𝑇 ( ) = ( 𝑇 𝑇) 𝐶 𝐷 𝐵 𝐷 若 𝐴, 𝐷 都可逆，则分块对角矩阵可逆，且 −1 𝐴 0 𝐴−1 0 ( ) =( ) 0 𝐷 0 𝐷−1 分块单位矩阵常写为 𝐼 0 𝐼 =( 1 ) 0 𝐼2 它与普通单位矩阵的作用相同，但每个 𝐼1 , 𝐼2 的阶数要与对应分块匹配。"
  },
  {
    "id": "doc-f8d85d8d3cbe-p10",
    "docId": "doc-f8d85d8d3cbe",
    "title": "Matrices (矩阵)",
    "category": "线性代数",
    "page": 10,
  ...
  {
    "id": "doc-f8d85d8d3cbe-p11",
    "docId": "doc-f8d85d8d3cbe",
    "title": "Matrices (矩阵)",
    "category": "线性代数",
    "page": 11,
    "heading": "八、典型题型",
    "snippet": "考研数学 · Linear Algebra · Matrices (矩阵) 八、典型题型 1. 求矩阵乘积或表达式：先检查维数，再按顺序计算。 2. 求逆矩阵：常用伴随矩阵公式或初等行变换。 3. 判断可逆：看行列式、秩或齐次方程组。 4. 求矩阵秩：化阶梯形，数非零行。 5. 判断向量组无关：可构造 Gram 矩阵，看 det(𝐺) 是...",
    "text": "Matrices (矩阵) Matrices 矩阵 线性代数 八、典型题型 考研数学 · Linear Algebra · Matrices (矩阵) 八、典型题型 1. 求矩阵乘积或表达式：先检查维数，再按顺序计算。 2. 求逆矩阵：常用伴随矩阵公式或初等行变换。 3. 判断可逆：看行列式、秩或齐次方程组。 4. 求矩阵秩：化阶梯形，数非零行。 5. 判断向量组无关：可构造 Gram 矩阵，看 det(𝐺) 是否大于零。 6. 证明矩阵恒等式：注意乘法顺序，必要时左乘或右乘逆矩阵。 7. 分块矩阵计算：先确认分块维数，再使用分块运算规则。 解题顺序 矩阵题先看“是否方阵”和“维数是否匹配”。如果涉及可逆，优先联想到行列式、秩和初等变换； 如果涉及方程组，优先把问题转为 𝐴𝑥 = 𝑏 或 𝐴𝑥 = 0。"
  },
  {
    "id": "doc-f8d85d8d3cbe-p12",
    "docId": "doc-f8d85d8d3cbe",
    "title": "Matrices (矩阵)",
    "category": "线性代数",
    "page": 12,
    "heading": "九、公式速查表",
    "snippet": "考研数学 · Linear Algebra · Matrices (矩阵) 九、公式速查表 内容 公式 𝑛 矩阵乘法 𝑐𝑖𝑗 = ∑𝑘=1 𝑎𝑖𝑘 𝑏𝑘𝑗 转置乘法 (𝐴𝐵)𝑇 = 𝐵𝑇 𝐴𝑇 1 逆矩阵 𝐴−1 = det(𝐴) 𝐴∗ 乘积求逆 (𝐴𝐵)−1 = 𝐵−1 𝐴−1 可逆判定 𝐴 可逆 ⟺ det(𝐴) ≠ 0 ⟺ rank...",
    "text": "Matrices (矩阵) Matrices 矩阵 线性代数 九、公式速查表 考研数学 · Linear Algebra · Matrices (矩阵) 九、公式速查表 内容 公式 𝑛 矩阵乘法 𝑐𝑖𝑗 = ∑𝑘=1 𝑎𝑖𝑘 𝑏𝑘𝑗 转置乘法 (𝐴𝐵)𝑇 = 𝐵𝑇 𝐴𝑇 1 逆矩阵 𝐴−1 = det(𝐴) 𝐴∗ 乘积求逆 (𝐴𝐵)−1 = 𝐵−1 𝐴−1 可逆判定 𝐴 可逆 ⟺ det(𝐴) ≠ 0 ⟺ rank(𝐴) = 𝑛 秩不变 rank(𝑃 𝐴𝑄) = rank(𝐴)，其中 𝑃 , 𝑄 可逆 正交矩阵 𝐴𝑇 𝐴 = 𝐼, 𝐴−1 = 𝐴𝑇 Gram 矩阵 𝐺 = 𝐴𝑇 𝐴, 𝑔𝑖𝑗 = 𝛼𝑇𝑖 𝛼𝑗 Gram 判定 𝛼1 , …, 𝛼𝑠 无关 ⟺ det(𝐺) > 0 𝑡 分块乘法 𝐶𝑖𝑗 = ∑𝑘=1 𝐴𝑖𝑘 𝐵𝑘𝑗 𝐴 𝐵 分块三角行列式 det ( 0 𝐷) = det(𝐴)det(𝐷) 最终抓手： 矩阵章节的关键是“顺序”和“秩”。乘法顺序不能乱，初等变换围绕秩和逆矩阵展开；Gram 矩 阵把向量内积信息组织成对称半正定矩阵；分块矩阵要先看维数和零分块结构；一旦题目出现可逆，就同步 想到行列式非零、满秩和齐次方程只有零解。"
  },
  {
    ...
    "snippet": "考研数学 · Linear Algebra · Vector Groups (向量组) Vector Groups (向量组) 线性组合 · 相关无关 · 秩 · 极大无关组 · 等价 考研数学复习资料 · Typst PDF 首页速览 • 核心公式：𝑟(𝛼1 , …, 𝛼𝑠 ) = 𝑟(𝐴)；极大无关组中向量个数等于向量组的秩。 • 关...",
    "text": "Vector Groups (向量组) Vector Groups 向量组 线性代数 考研数学 · Linear Algebra · Vector Groups (向量组) 考研数学 · Linear Algebra · Vector Groups (向量组) Vector Groups (向量组) 线性组合 · 相关无关 · 秩 · 极大无关组 · 等价 考研数学复习资料 · Typst PDF 首页速览 • 核心公式：𝑟(𝛼1 , …, 𝛼𝑠 ) = 𝑟(𝐴)；极大无关组中向量个数等于向量组的秩。 • 关键定理：向量组线性相关等价于齐次方程 𝐴𝑥 = 0 有非零解；等价向量组有相同秩。 • 方法抓手：判相关先排成矩阵做初等行变换；求表示关系时把目标向量并入增广列统一求解。 复习目标： 向量组章节把矩阵秩、方程组解的结构和线性空间思想连接起来。考研常考线性表示、线性相 关性、极大线性无关组、向量组秩与等价。"
  },
  {
    ...
    "page": 2,
    "heading": "一、向量与线性组合",
    "snippet": "考研数学 · Linear Algebra · Vector Groups (向量组) 一、向量与线性组合 1. 向量组 若干同维列向量 𝛼1 , 𝛼2 , …, 𝛼𝑠 组成一个向量组。只有同维向量才能讨论线性组合和线性相关性。 2. 线性组合 若存在数 𝑘1 , 𝑘2 , …, 𝑘𝑠 ，使得 𝛽 = 𝑘1 𝛼1 + 𝑘2 𝛼2 + … ...",
    "text": "Vector Groups (向量组) Vector Groups 向量组 线性代数 一、向量与线性组合 考研数学 · Linear Algebra · Vector Groups (向量组) 一、向量与线性组合 1. 向量组 若干同维列向量 𝛼1 , 𝛼2 , …, 𝛼𝑠 组成一个向量组。只有同维向量才能讨论线性组合和线性相关性。 2. 线性组合 若存在数 𝑘1 , 𝑘2 , …, 𝑘𝑠 ，使得 𝛽 = 𝑘1 𝛼1 + 𝑘2 𝛼2 + … + 𝑘𝑠 𝛼𝑠 则称 𝛽 可由向量组 𝛼1 , …, 𝛼𝑠 线性表示。 3. 与方程组的关系 令 𝐴 = (𝛼1 , 𝛼2 , …, 𝛼𝑠 ) 则 𝛽 可由该向量组线性表示等价于方程组 𝐴𝑥 = 𝛽 有解。"
  },
  {
    ...
    "page": 3,
    "heading": "二、线性相关与线性无关",
    "snippet": "考研数学 · Linear Algebra · Vector Groups (向量组) 二、线性相关与线性无关 1. 定义 若存在不全为零的数 𝑘1 , …, 𝑘𝑠 ，使得 𝑘1 𝛼1 + 𝑘2 𝛼2 + … + 𝑘𝑠 𝛼𝑠 = 0 则称向量组线性相关。 若只有当 𝑘1 = 𝑘2 = … = 𝑘𝑠 = 0 时等式成立，则称向量组线性无关。...",
    "text": "Vector Groups (向量组) Vector Groups 向量组 线性代数 二、线性相关与线性无关 考研数学 · Linear Algebra · Vector Groups (向量组) 二、线性相关与线性无关 1. 定义 若存在不全为零的数 𝑘1 , …, 𝑘𝑠 ，使得 𝑘1 𝛼1 + 𝑘2 𝛼2 + … + 𝑘𝑠 𝛼𝑠 = 0 则称向量组线性相关。 若只有当 𝑘1 = 𝑘2 = … = 𝑘𝑠 = 0 时等式成立，则称向量组线性无关。 2. 判定方法 把向量作为列组成矩阵 𝐴： 1. 若 rank(𝐴) = 𝑠，则 𝑠 个列向量线性无关。 2. 若 rank(𝐴) < 𝑠，则 𝑠 个列向量线性相关。 其中 𝑠 是向量个数。 易错点： 𝑛 维空间中多于 𝑛 个向量一定线性相关；少于或等于 𝑛 个向量不一定无关，必须看秩或解齐次 方程组。"
  },
  {
    ...
    "page": 4,
    "heading": "三、向量组的秩",
    "snippet": "考研数学 · Linear Algebra · Vector Groups (向量组) 三、向量组的秩 1. 极大线性无关组 向量组中若某个部分组线性无关，并且再加入原向量组中任一其他向量都会线性相关，则称该部分组为极大线 性无关组。 2. 向量组秩 极大线性无关组所含向量个数称为向量组的秩，记为 𝑟(𝛼1 , …, 𝛼𝑠 ) 若把向量组...",
    "text": "Vector Groups (向量组) Vector Groups 向量组 线性代数 三、向量组的秩 考研数学 · Linear Algebra · Vector Groups (向量组) 三、向量组的秩 1. 极大线性无关组 向量组中若某个部分组线性无关，并且再加入原向量组中任一其他向量都会线性相关，则称该部分组为极大线 性无关组。 2. 向量组秩 极大线性无关组所含向量个数称为向量组的秩，记为 𝑟(𝛼1 , …, 𝛼𝑠 ) 若把向量组作为矩阵的列，则向量组秩等于该矩阵的列秩，也等于矩阵秩。 3. 求极大无关组 把向量作为列组成矩阵，作初等行变换化为阶梯形矩阵。主元列对应的原向量构成一个极大线性无关组。 注意 行变换会改变行向量，但不会改变列向量之间的线性关系。因此求列向量组极大无关组时，要记录阶 梯形矩阵中的主元列，再回到原矩阵取对应列。"
  },
  {
    "id": "doc-aedda68a99a2-p5",
    "docId": "doc-aedda68a99a2",
    "title": "Vector Groups (向量组)",
    "category": "线性代数",
    "page": 5,
    "heading": "四、向量组等价",
    "snippet": "考研数学 · Linear Algebra · Vector Groups (向量组) 四、向量组等价 1. 等价定义 若向量组 𝐴 中每个向量都可由向量组 𝐵 线性表示，同时 𝐵 中每个向量也可由 𝐴 线性表示，则称两个向量组 等价。 2. 等价判定 两个向量组等价意味着它们张成同一个线性空间，因此它们的秩相同。但“秩相同”本身不一定推...",
    "text": "Vector Groups (向量组) Vector Groups 向量组 线性代数 四、向量组等价 考研数学 · Linear Algebra · Vector Groups (向量组) 四、向量组等价 1. 等价定义 若向量组 𝐴 中每个向量都可由向量组 𝐵 线性表示，同时 𝐵 中每个向量也可由 𝐴 线性表示，则称两个向量组 等价。 2. 等价判定 两个向量组等价意味着它们张成同一个线性空间，因此它们的秩相同。但“秩相同”本身不一定推出等价，还要 看互相可表示。 3. 矩阵语言 若 𝐵 的列向量都可由 𝐴 的列向量线性表示，则存在矩阵 𝐶 ，使得 𝐵 = 𝐴𝐶 若还存在矩阵 𝐷，使得 𝐴 = 𝐵𝐷 则两个列向量组等价。"
  },
  {
    "id": "doc-aedda68a99a2-p6",
    "docId": "doc-aedda68a99a2",
    "title": "Vector Groups (向量组)",
    "category": "线性代数",
    "page": 6,
    ...
    "text": "Vector Groups (向量组) Vector Groups 向量组 线性代数 五、线性表示的判定 考研数学 · Linear Algebra · Vector Groups (向量组) 五、线性表示的判定 1. 秩判定 𝛽 可由 𝛼1 , …, 𝛼𝑠 线性表示，当且仅当 rank(𝛼1 , …, 𝛼𝑠 ) = rank(𝛼1 , …, 𝛼𝑠 , 𝛽) 也就是把 𝛽 加入向量组后，秩不增加。 2. 唯一性 若 𝛽 可由向量组线性表示： 1. 当 𝛼1 , …, 𝛼𝑠 线性无关时，表示系数唯一。 2. 当 𝛼1 , …, 𝛼𝑠 线性相关时，表示系数可能不唯一。"
  },
  {
    "id": "doc-aedda68a99a2-p7",
    "docId": "doc-aedda68a99a2",
    "title": "Vector Groups (向量组)",
    "category": "线性代数",
    "page": 7,
    "heading": "六、常见结论",
    "snippet": "考研数学 · Linear Algebra · Vector Groups (向量组) 六、常见结论 结论 说明 含零向量的向量组相关 取零向量系数为 1，其余为 0 部分组相关则整体相关 相关关系可以扩展到更大的向量组 整体无关则任一部分组无关 无关性向部分组继承 一个向量可由其他向量表示则整体相关 把该向量移到等式一侧得到非零系数关系...",
    "text": "Vector Groups (向量组) Vector Groups 向量组 线性代数 六、常见结论 考研数学 · Linear Algebra · Vector Groups (向量组) 六、常见结论 结论 说明 含零向量的向量组相关 取零向量系数为 1，其余为 0 部分组相关则整体相关 相关关系可以扩展到更大的向量组 整体无关则任一部分组无关 无关性向部分组继承 一个向量可由其他向量表示则整体相关 把该向量移到等式一侧得到非零系数关系 向量个数大于维数则相关 矩阵列数大于行数，列满秩不可能"
  },
  {
    "id": "doc-aedda68a99a2-p8",
    "docId": "doc-aedda68a99a2",
    "title": "Vector Groups (向量组)",
    "category": "线性代数",
    "page": 8,
    "heading": "七、典型题型",
    "snippet": "考研数学 · Linear Algebra · Vector Groups (向量组) 七、典型题型 1. 判断线性相关或无关：列成矩阵求秩，或解齐次方程组。 2. 判断能否线性表示：比较加入目标向量前后的秩。 3. 求表示系数：解非齐次方程组 𝐴𝑥 = 𝛽 。 4. 求极大线性无关组：化阶梯形，取主元列对应的原向量。 5. 判断向量组等...",
    "text": "Vector Groups (向量组) Vector Groups 向量组 线性代数 七、典型题型 考研数学 · Linear Algebra · Vector Groups (向量组) 七、典型题型 1. 判断线性相关或无关：列成矩阵求秩，或解齐次方程组。 2. 判断能否线性表示：比较加入目标向量前后的秩。 3. 求表示系数：解非齐次方程组 𝐴𝑥 = 𝛽 。 4. 求极大线性无关组：化阶梯形，取主元列对应的原向量。 5. 判断向量组等价：验证互相线性表示或张成空间相同。 6. 参数讨论：把参数带入秩判定，重点看主元是否消失。"
  },
  {
    "id": "doc-aedda68a99a2-p9",
    "docId": "doc-aedda68a99a2",
    "title": "Vector Groups (向量组)",
    "category": "线性代数",
    "page": 9,
    "heading": "八、公式速查表",
    "snippet": "考研数学 · Linear Algebra · Vector Groups (向量组) 八、公式速查表 内容 公式或判定 𝑠 线性组合 𝛽 = ∑𝑖=1 𝑘𝑖 𝛼𝑖 𝑠 线性相关 ∑𝑖=1 𝑘𝑖 𝛼𝑖 = 0 有不全为零解 线性无关 ∑𝑠𝑖=1 𝑘𝑖 𝛼𝑖 = 0 只有零解 无关判定 rank(𝐴) = 𝑠 相关判定 rank(𝐴) < ...",
    "text": "Vector Groups (向量组) Vector Groups 向量组 线性代数 八、公式速查表 考研数学 · Linear Algebra · Vector Groups (向量组) 八、公式速查表 内容 公式或判定 𝑠 线性组合 𝛽 = ∑𝑖=1 𝑘𝑖 𝛼𝑖 𝑠 线性相关 ∑𝑖=1 𝑘𝑖 𝛼𝑖 = 0 有不全为零解 线性无关 ∑𝑠𝑖=1 𝑘𝑖 𝛼𝑖 = 0 只有零解 无关判定 rank(𝐴) = 𝑠 相关判定 rank(𝐴) < 𝑠 线性表示 rank(𝐴) = rank(𝐴, 𝛽) 极大无关组 主元列对应的原向量 最终抓手： 向量组题几乎都可以翻译成矩阵秩和方程组。判断相关性看齐次方程，判断线性表示看非齐次 方程，求极大无关组看阶梯形矩阵的主元列。"
  },
  {
    ...
    "snippet": "考研数学 · Linear Algebra · Linear Equations (线性方程组) Linear Equations (线性方程组) 齐次 · 非齐次 · 秩判定 · 解结构 · 参数讨论 考研数学复习资料 · Typst PDF 首页速览 • 核心公式：齐次方程基础解系个数为 𝑛 − 𝑟(𝐴)；非齐次通解为 𝑥 = 𝜂 +...",
    "text": "Linear Equations (线性方程组) Linear Equations 线性方程组 线性代数 考研数学 · Linear Algebra · Linear Equations (线性方程组) 考研数学 · Linear Algebra · Linear Equations (线性方程组) Linear Equations (线性方程组) 齐次 · 非齐次 · 秩判定 · 解结构 · 参数讨论 考研数学复习资料 · Typst PDF 首页速览 • 核心公式：齐次方程基础解系个数为 𝑛 − 𝑟(𝐴)；非齐次通解为 𝑥 = 𝜂 + 𝑘1 𝜉1 + … + 𝑘𝑛−𝑟 𝜉𝑛−𝑟 。 • 关键定理：Rouché-Capelli 判定：𝑟(𝐴) = 𝑟(𝐴, 𝑏) 有解；若再等于未知数个数则唯一解。 • 方法抓手：先比较系数矩阵与增广矩阵的秩，再决定无解、唯一解或无穷多解。 复习目标： 线性方程组的核心是“有没有解、解是否唯一、通解怎么写”。所有判断都围绕系数矩阵秩、增 广矩阵秩和未知数个数展开。"
  },
  {
    ...
    "page": 2,
    "heading": "一、基本形式",
    "snippet": "考研数学 · Linear Algebra · Linear Equations (线性方程组) 一、基本形式 1. 矩阵表示 线性方程组可写为 𝐴𝑥 = 𝑏 其中 𝐴 是系数矩阵，𝑥 是未知向量，𝑏 是常数向量。 若 𝑏 = 0，称为齐次线性方程组： 𝐴𝑥 = 0 若 𝑏 ≠ 0，称为非齐次线性方程组。 2. 增广矩阵 把常数列 𝑏 拼...",
    "text": "Linear Equations (线性方程组) Linear Equations 线性方程组 线性代数 一、基本形式 考研数学 · Linear Algebra · Linear Equations (线性方程组) 一、基本形式 1. 矩阵表示 线性方程组可写为 𝐴𝑥 = 𝑏 其中 𝐴 是系数矩阵，𝑥 是未知向量，𝑏 是常数向量。 若 𝑏 = 0，称为齐次线性方程组： 𝐴𝑥 = 0 若 𝑏 ≠ 0，称为非齐次线性方程组。 2. 增广矩阵 把常数列 𝑏 拼到系数矩阵后得到增广矩阵，记作 (𝐴, 𝑏) 研究非齐次方程组时必须同时看 𝐴 与 (𝐴, 𝑏) 的秩。"
  },
  {
    ...
    "page": 3,
    "heading": "二、齐次线性方程组",
    "snippet": "考研数学 · Linear Algebra · Linear Equations (线性方程组) 二、齐次线性方程组 1. 解的判定 齐次方程组 𝐴𝑥 = 0 一定有零解。设 𝐴 是 𝑚 × 𝑛 矩阵，则： 1. 若 rank(𝐴) = 𝑛，只有零解。 2. 若 rank(𝐴) < 𝑛，有非零解。 2. 基础解系 当 rank(𝐴) = ...",
    "text": "Linear Equations (线性方程组) Linear Equations 线性方程组 线性代数 二、齐次线性方程组 考研数学 · Linear Algebra · Linear Equations (线性方程组) 二、齐次线性方程组 1. 解的判定 齐次方程组 𝐴𝑥 = 0 一定有零解。设 𝐴 是 𝑚 × 𝑛 矩阵，则： 1. 若 rank(𝐴) = 𝑛，只有零解。 2. 若 rank(𝐴) < 𝑛，有非零解。 2. 基础解系 当 rank(𝐴) = 𝑟 < 𝑛 时，齐次方程组有 𝑛 − 𝑟 个自由变量，基础解系含有 𝑛 − 𝑟 个线性无关解向量。 通解可写为 𝑥 = 𝑘1 𝜉1 + 𝑘2 𝜉2 + … + 𝑘𝑛−𝑟 𝜉𝑛−𝑟 其中 𝜉1 , …, 𝜉𝑛−𝑟 是基础解系。 3. 解空间维数 齐次方程组的解空间维数为 𝑛 − rank(𝐴) 这也是自由变量个数。"
  },
  {
    ...
    "page": 4,
    "heading": "三、非齐次线性方程组",
    "snippet": "考研数学 · Linear Algebra · Linear Equations (线性方程组) 三、非齐次线性方程组 1. 有解判定 非齐次方程组 𝐴𝑥 = 𝑏 有解，当且仅当 rank(𝐴) = rank(𝐴, 𝑏) 若 rank(𝐴) < rank(𝐴, 𝑏) 则无解。 2. 解的个数 设 𝐴 有 𝑛 列： 1. 若 rank(𝐴)...",
    "text": "Linear Equations (线性方程组) Linear Equations 线性方程组 线性代数 三、非齐次线性方程组 考研数学 · Linear Algebra · Linear Equations (线性方程组) 三、非齐次线性方程组 1. 有解判定 非齐次方程组 𝐴𝑥 = 𝑏 有解，当且仅当 rank(𝐴) = rank(𝐴, 𝑏) 若 rank(𝐴) < rank(𝐴, 𝑏) 则无解。 2. 解的个数 设 𝐴 有 𝑛 列： 1. 若 rank(𝐴) = rank(𝐴, 𝑏) = 𝑛，有唯一解。 2. 若 rank(𝐴) = rank(𝐴, 𝑏) < 𝑛，有无穷多解。 3. 若 rank(𝐴) < rank(𝐴, 𝑏)，无解。 3. 通解结构 若 𝜂 是非齐次方程组的一个特解，𝜉 是对应齐次方程组 𝐴𝑥 = 0 的通解，则非齐次方程组通解为 𝑥=𝜂+𝜉 即 𝑥 = 𝜂 + 𝑘1 𝜉1 + 𝑘2 𝜉2 + … + 𝑘𝑛−𝑟 𝜉𝑛−𝑟 易错点： 非齐次方程组的解集不是线性空间，因为两个非齐次解相加通常不再是原方程组的解。两个非齐 次解之差才是对应齐次方程组的解。"
  },
  {
    "id": "doc-715b679dcb8e-p5",
    "docId": "doc-715b679dcb8e",
    "title": "Linear Equations (线性方程组)",
    "category": "线性代数",
    "page": 5,
    "heading": "四、解的性质",
    "snippet": "考研数学 · Linear Algebra · Linear Equations (线性方程组) 四、解的性质 1. 齐次方程组 若 𝜉1 , 𝜉2 是 𝐴𝑥 = 0 的解，则 𝑘1 𝜉1 + 𝑘2 𝜉2 仍是 𝐴𝑥 = 0 的解。 2. 非齐次方程组 若 𝜂1 , 𝜂2 是 𝐴𝑥 = 𝑏 的解，则 𝜂1 − 𝜂2 是 𝐴𝑥 = 0 的解...",
    "text": "Linear Equations (线性方程组) Linear Equations 线性方程组 线性代数 四、解的性质 考研数学 · Linear Algebra · Linear Equations (线性方程组) 四、解的性质 1. 齐次方程组 若 𝜉1 , 𝜉2 是 𝐴𝑥 = 0 的解，则 𝑘1 𝜉1 + 𝑘2 𝜉2 仍是 𝐴𝑥 = 0 的解。 2. 非齐次方程组 若 𝜂1 , 𝜂2 是 𝐴𝑥 = 𝑏 的解，则 𝜂1 − 𝜂2 是 𝐴𝑥 = 0 的解。 若 𝜂 是 𝐴𝑥 = 𝑏 的一个解，𝜉 是 𝐴𝑥 = 0 的解，则 𝜂+𝜉 仍是 𝐴𝑥 = 𝑏 的解。"
  },
  {
    "id": "doc-715b679dcb8e-p6",
    "docId": "doc-715b679dcb8e",
    "title": "Linear Equations (线性方程组)",
    "category": "线性代数",
    "page": 6,
    "heading": "五、求解步骤",
    "snippet": "考研数学 · Linear Algebra · Linear Equations (线性方程组) 五、求解步骤 步骤 操作 1 写出系数矩阵 𝐴 和增广矩阵 (𝐴, 𝑏) 2 对增广矩阵作初等行变换化为阶梯形 3 比较 rank(𝐴) 与 rank(𝐴, 𝑏) 4 若有解，确定主元变量和自由变量 5 令自由变量取参数，写出通解",
    "text": "Linear Equations (线性方程组) Linear Equations 线性方程组 线性代数 五、求解步骤 考研数学 · Linear Algebra · Linear Equations (线性方程组) 五、求解步骤 步骤 操作 1 写出系数矩阵 𝐴 和增广矩阵 (𝐴, 𝑏) 2 对增广矩阵作初等行变换化为阶梯形 3 比较 rank(𝐴) 与 rank(𝐴, 𝑏) 4 若有解，确定主元变量和自由变量 5 令自由变量取参数，写出通解"
  },
  {
    "id": "doc-715b679dcb8e-p7",
    "docId": "doc-715b679dcb8e",
    "title": "Linear Equations (线性方程组)",
    "category": "线性代数",
    "page": 7,
    "heading": "六、参数方程组",
    "snippet": "考研数学 · Linear Algebra · Linear Equations (线性方程组) 六、参数方程组 1. 参数讨论原则 参数方程组常通过行变换或行列式得到关键因子。参数取值通常分为： 1. 使系数矩阵满秩的情况。 2. 使秩下降但仍有解的情况。 3. 使增广矩阵秩大于系数矩阵秩的情况。 2. 方阵情形 若 𝐴 是 𝑛 阶方阵...",
    "text": "Linear Equations (线性方程组) Linear Equations 线性方程组 线性代数 六、参数方程组 考研数学 · Linear Algebra · Linear Equations (线性方程组) 六、参数方程组 1. 参数讨论原则 参数方程组常通过行变换或行列式得到关键因子。参数取值通常分为： 1. 使系数矩阵满秩的情况。 2. 使秩下降但仍有解的情况。 3. 使增广矩阵秩大于系数矩阵秩的情况。 2. 方阵情形 若 𝐴 是 𝑛 阶方阵： 1. 当 det(𝐴) ≠ 0，方程组有唯一解。 2. 当 det(𝐴) = 0，需要继续比较 rank(𝐴) 与 rank(𝐴, 𝑏)。 解题顺序 含参数方程组不要看到 det(𝐴) = 0 就写无解。正确做法是先用 det(𝐴) 找出特殊参数，再在特 殊参数下重新求秩。"
  },
  {
    "id": "doc-715b679dcb8e-p8",
    "docId": "doc-715b679dcb8e",
    "title": "Linear Equations (线性方程组)",
    "category": "线性代数",
    "page": 8,
    "heading": "七、典型题型",
    "snippet": "考研数学 · Linear Algebra · Linear Equations (线性方程组) 七、典型题型 1. 判断解的情况：比较系数矩阵和增广矩阵的秩。 2. 求齐次方程组基础解系：化阶梯形，设自由变量。 3. 求非齐次方程组通解：先求一个特解，再加对应齐次通解。 4. 参数讨论：先找使秩变化的参数，再分类讨论。 5. 已知解反求...",
    "text": "Linear Equations (线性方程组) Linear Equations 线性方程组 线性代数 七、典型题型 考研数学 · Linear Algebra · Linear Equations (线性方程组) 七、典型题型 1. 判断解的情况：比较系数矩阵和增广矩阵的秩。 2. 求齐次方程组基础解系：化阶梯形，设自由变量。 3. 求非齐次方程组通解：先求一个特解，再加对应齐次通解。 4. 参数讨论：先找使秩变化的参数，再分类讨论。 5. 已知解反求参数：把解代入方程组，结合秩条件。 6. 与向量组结合：线性表示问题等价于方程组有解。"
  },
  {
    "id": "doc-715b679dcb8e-p9",
    "docId": "doc-715b679dcb8e",
    "title": "Linear Equations (线性方程组)",
    "category": "线性代数",
    "page": 9,
    "heading": "八、公式速查表",
    "snippet": "考研数学 · Linear Algebra · Linear Equations (线性方程组) 八、公式速查表 内容 判定或公式 齐次只有零解 rank(𝐴) = 𝑛 齐次有非零解 rank(𝐴) < 𝑛 基础解系个数 𝑛 − rank(𝐴) 非齐次有解 rank(𝐴) = rank(𝐴, 𝑏) 非齐次无解 rank(𝐴) < rank...",
    "text": "Linear Equations (线性方程组) Linear Equations 线性方程组 线性代数 八、公式速查表 考研数学 · Linear Algebra · Linear Equations (线性方程组) 八、公式速查表 内容 判定或公式 齐次只有零解 rank(𝐴) = 𝑛 齐次有非零解 rank(𝐴) < 𝑛 基础解系个数 𝑛 − rank(𝐴) 非齐次有解 rank(𝐴) = rank(𝐴, 𝑏) 非齐次无解 rank(𝐴) < rank(𝐴, 𝑏) 非齐次唯一解 rank(𝐴) = rank(𝐴, 𝑏) = 𝑛 非齐次无穷多解 rank(𝐴) = rank(𝐴, 𝑏) < 𝑛 通解结构 𝑥 = 𝜂 + 𝑘1 𝜉1 + … + 𝑘𝑛−𝑟 𝜉𝑛−𝑟 最终抓手： 线性方程组题先分类：齐次只看 𝐴 的秩，非齐次要比较 𝐴 与 (𝐴, 𝑏) 的秩。通解永远是“非齐 次特解 + 齐次通解”。"
  },
  {
    ...
    "category": "线性代数",
    "page": 1,
    "heading": "Eigenvalues and Eigenvectors (特征值与特征向量)",
    "snippet": "考研数学 · Linear Algebra · Eigenvalues and Eigenvectors (特征值与特征向量) Eigenvalues and Eigenvectors (特征值与特征向量) 特征方程 · 相似 · 对角化 · 实对称矩阵 考研数学复习资料 · Typst PDF 首页速览 • 核心公式：|𝜆𝐼 − 𝐴| ...",
    "text": "Eigenvalues and Eigenvectors (特征值与特征向量) Eigenvalues and Eigenvectors 特征值与特征向量 线性代数 Eigenvalues and Eigenvectors (特征值与特征向量) 考研数学 · Linear Algebra · Eigenvalues and Eigenvectors (特征值与特征向量) Eigenvalues and Eigenvectors (特征值与特征向量) 特征方程 · 相似 · 对角化 · 实对称矩阵 考研数学复习资料 · Typst PDF 首页速览 • 核心公式：|𝜆𝐼 − 𝐴| = 0，(𝐴 − 𝜆𝐼)𝑥 = 0，𝑃 −1 𝐴𝑃 = Λ。 • 关键定理：不同特征值对应的特征向量线性无关；𝑛 阶矩阵可对角化等价于有 𝑛 个线性无关特征向量。 • 方法抓手：先求特征值，再求每个特征子空间维数；重根要检查几何重数是否足够。 复习目标： 特征值与特征向量描述矩阵在线性变换下保持方向不变的向量，是相似对角化和二次型正交化 的基础。考研重点是求特征值、求特征向量、判断能否对角化以及实对称矩阵性质。"
  },
  {
    ...
    "page": 2,
    "heading": "一、基本定义",
    "snippet": "考研数学 · Linear Algebra · Eigenvalues and Eigenvectors (特征值与特征向量) 一、基本定义 1. 特征值与特征向量 设 𝐴 是 𝑛 阶方阵，若存在非零向量 𝑥 和数 𝜆，使得 𝐴𝑥 = 𝜆𝑥 则称 𝜆 是 𝐴 的特征值，𝑥 是对应于 𝜆 的特征向量。 等价地， (𝐴 − 𝜆𝐼)𝑥 = 0 ...",
    "text": "Eigenvalues and Eigenvectors (特征值与特征向量) Eigenvalues and Eigenvectors 特征值与特征向量 线性代数 一、基本定义 考研数学 · Linear Algebra · Eigenvalues and Eigenvectors (特征值与特征向量) 一、基本定义 1. 特征值与特征向量 设 𝐴 是 𝑛 阶方阵，若存在非零向量 𝑥 和数 𝜆，使得 𝐴𝑥 = 𝜆𝑥 则称 𝜆 是 𝐴 的特征值，𝑥 是对应于 𝜆 的特征向量。 等价地， (𝐴 − 𝜆𝐼)𝑥 = 0 有非零解。 2. 特征方程 特征值满足 det(𝜆𝐼 − 𝐴) = 0 这个方程称为特征方程。也可使用 det(𝐴 − 𝜆𝐼) = 0，二者根相同。 3. 特征子空间 对应特征值 𝜆 的全部特征向量连同零向量构成齐次方程组 (𝐴 − 𝜆𝐼)𝑥 = 0 的解空间，其维数为 𝑛 − rank(𝐴 − 𝜆𝐼)"
  },
  {
    ...
    "page": 3,
    "heading": "二、求解步骤",
    "snippet": "考研数学 · Linear Algebra · Eigenvalues and Eigenvectors (特征值与特征向量) 二、求解步骤 步骤 操作 1 计算特征多项式 det(𝜆𝐼 − 𝐴) 2 解特征方程，得到全部特征值 3 对每个特征值，解 (𝐴 − 𝜆𝐼)𝑥 = 0 4 写出对应特征向量的基础解系 易错点： 特征向量必须是非零...",
    "text": "Eigenvalues and Eigenvectors (特征值与特征向量) Eigenvalues and Eigenvectors 特征值与特征向量 线性代数 二、求解步骤 考研数学 · Linear Algebra · Eigenvalues and Eigenvectors (特征值与特征向量) 二、求解步骤 步骤 操作 1 计算特征多项式 det(𝜆𝐼 − 𝐴) 2 解特征方程，得到全部特征值 3 对每个特征值，解 (𝐴 − 𝜆𝐼)𝑥 = 0 4 写出对应特征向量的基础解系 易错点： 特征向量必须是非零向量；零向量是齐次方程组的解，但不是特征向量。"
  },
  {
    ...
    "text": "Eigenvalues and Eigenvectors (特征值与特征向量) Eigenvalues and Eigenvectors 特征值与特征向量 线性代数 三、特征值性质 考研数学 · Linear Algebra · Eigenvalues and Eigenvectors (特征值与特征向量) 三、特征值性质 设 𝐴 的特征值为 𝜆1 , …, 𝜆𝑛 ，按重数计算，则 𝜆1 + 𝜆2 + … + 𝜆𝑛 = tr(𝐴) 𝜆1 𝜆2 …𝜆𝑛 = det(𝐴) 若 𝜆 是 𝐴 的特征值，则： 𝜆𝑘 是 𝐴𝑘 的特征值 若 𝐴 可逆，则： 1 是 𝐴−1 的特征值 𝜆 若 𝑓(𝑡) 是多项式，则： 𝑓(𝜆) 是 𝑓(𝐴) 的特征值"
  },
  {
    "id": "doc-2dc2609d51d3-p5",
    "docId": "doc-2dc2609d51d3",
    "title": "Eigenvalues and Eigenvectors (特征值与特征向量)",
    "category": "线性代数",
    "page": 5,
    "heading": "四、相似矩阵",
    "snippet": "考研数学 · Linear Algebra · Eigenvalues and Eigenvectors (特征值与特征向量) 四、相似矩阵 1. 定义 若存在可逆矩阵 𝑃 ，使得 𝐵 = 𝑃 −1 𝐴𝑃 则称 𝐴 与 𝐵 相似。 2. 相似不变量 相似矩阵有相同的： 1. 特征多项式。 2. 特征值。 3. 行列式。 4. 迹。 5. ...",
    "text": "Eigenvalues and Eigenvectors (特征值与特征向量) Eigenvalues and Eigenvectors 特征值与特征向量 线性代数 四、相似矩阵 考研数学 · Linear Algebra · Eigenvalues and Eigenvectors (特征值与特征向量) 四、相似矩阵 1. 定义 若存在可逆矩阵 𝑃 ，使得 𝐵 = 𝑃 −1 𝐴𝑃 则称 𝐴 与 𝐵 相似。 2. 相似不变量 相似矩阵有相同的： 1. 特征多项式。 2. 特征值。 3. 行列式。 4. 迹。 5. 秩。 但相似矩阵的具体元素和特征向量一般不同。"
  },
  {
    "id": "doc-2dc2609d51d3-p6",
    "docId": "doc-2dc2609d51d3",
    "title": "Eigenvalues and Eigenvectors (特征值与特征向量)",
    "category": "线性代数",
    "page": 6,
    "heading": "五、矩阵对角化",
    "snippet": "考研数学 · Linear Algebra · Eigenvalues and Eigenvectors (特征值与特征向量) 五、矩阵对角化 1. 对角化定义 若存在可逆矩阵 𝑃 ，使得 𝑃 −1 𝐴𝑃 = Λ 其中 Λ 是对角矩阵，则称 𝐴 可对角化。 2. 充要条件 𝑛 阶矩阵 𝐴 可对角化，当且仅当 𝐴 有 𝑛 个线性无关的特征向...",
    "text": "Eigenvalues and Eigenvectors (特征值与特征向量) Eigenvalues and Eigenvectors 特征值与特征向量 线性代数 五、矩阵对角化 考研数学 · Linear Algebra · Eigenvalues and Eigenvectors (特征值与特征向量) 五、矩阵对角化 1. 对角化定义 若存在可逆矩阵 𝑃 ，使得 𝑃 −1 𝐴𝑃 = Λ 其中 Λ 是对角矩阵，则称 𝐴 可对角化。 2. 充要条件 𝑛 阶矩阵 𝐴 可对角化，当且仅当 𝐴 有 𝑛 个线性无关的特征向量。 若 𝐴 有 𝑛 个互异特征值，则 𝐴 一定可对角化。 3. 重根情形 若某个特征值 𝜆 的代数重数为 𝑠，则其对应线性无关特征向量个数为 𝑛 − rank(𝐴 − 𝜆𝐼) 要可对角化，每个特征值的线性无关特征向量个数都必须等于它的代数重数。 易错点： 有重特征值不代表一定不能对角化；关键看对应特征向量个数是否足够。"
  },
  {
    "id": "doc-2dc2609d51d3-p7",
    "docId": "doc-2dc2609d51d3",
    "title": "Eigenvalues and Eigenvectors (特征值与特征向量)",
    "category": "线性代数",
    "page": 7,
    "heading": "六、实对称矩阵",
    "snippet": "考研数学 · Linear Algebra · Eigenvalues and Eigenvectors (特征值与特征向量) 六、实对称矩阵 1. 基本性质 若 𝐴𝑇 = 𝐴，则 𝐴 是实对称矩阵。它具有： 1. 特征值全为实数。 2. 不同特征值对应的特征向量相互正交。 3. 一定可以正交对角化。 2. 正交对角化 存在正交矩阵 𝑄，...",
    "text": "Eigenvalues and Eigenvectors (特征值与特征向量) Eigenvalues and Eigenvectors 特征值与特征向量 线性代数 六、实对称矩阵 考研数学 · Linear Algebra · Eigenvalues and Eigenvectors (特征值与特征向量) 六、实对称矩阵 1. 基本性质 若 𝐴𝑇 = 𝐴，则 𝐴 是实对称矩阵。它具有： 1. 特征值全为实数。 2. 不同特征值对应的特征向量相互正交。 3. 一定可以正交对角化。 2. 正交对角化 存在正交矩阵 𝑄，使得 𝑄𝑇 𝐴𝑄 = Λ 其中 Λ 是由特征值构成的对角矩阵。 步骤为： 1. 求全部特征值。 2. 求各特征子空间的基础解系。 3. 对同一特征值下的向量必要时正交化、单位化。 4. 把单位正交特征向量作为 𝑄 的列。"
  },
  {
    "id": "doc-2dc2609d51d3-p8",
    "docId": "doc-2dc2609d51d3",
    "title": "Eigenvalues and Eigenvectors (特征值与特征向量)",
    "category": "线性代数",
    "page": 8,
    "heading": "七、典型题型",
    "snippet": "考研数学 · Linear Algebra · Eigenvalues and Eigenvectors (特征值与特征向量) 七、典型题型 1. 求特征值和特征向量：按特征方程和齐次方程组求。 2. 判断是否可对角化：看线性无关特征向量个数。 3. 求对角化矩阵：用特征向量作 𝑃 的列。 4. 利用特征值求行列式、迹和矩阵幂。 5. 实...",
    "text": "Eigenvalues and Eigenvectors (特征值与特征向量) Eigenvalues and Eigenvectors 特征值与特征向量 线性代数 七、典型题型 考研数学 · Linear Algebra · Eigenvalues and Eigenvectors (特征值与特征向量) 七、典型题型 1. 求特征值和特征向量：按特征方程和齐次方程组求。 2. 判断是否可对角化：看线性无关特征向量个数。 3. 求对角化矩阵：用特征向量作 𝑃 的列。 4. 利用特征值求行列式、迹和矩阵幂。 5. 实对称矩阵正交对角化：特征向量必须正交单位化。 6. 与二次型结合：正交变换后的系数就是特征值。 对角化顺序 若 𝑃 = (𝑝1 , 𝑝2 , …, 𝑝𝑛 )，其中 𝑝𝑖 是 𝜆𝑖 对应的特征向量，则 𝑃 −1 𝐴𝑃 = diag(𝜆1 , 𝜆2 , …, 𝜆𝑛 )。 特征值顺序必须与 𝑃 中特征向量顺序一致。"
  },
  {
    "id": "doc-2dc2609d51d3-p9",
    "docId": "doc-2dc2609d51d3",
    "title": "Eigenvalues and Eigenvectors (特征值与特征向量)",
    "category": "线性代数",
    "page": 9,
    "heading": "八、公式速查表",
    "snippet": "考研数学 · Linear Algebra · Eigenvalues and Eigenvectors (特征值与特征向量) 八、公式速查表 内容 公式或判定 特征定义 𝐴𝑥 = 𝜆𝑥, 𝑥 ≠ 0 特征方程 det(𝜆𝐼 − 𝐴) = 0 特征向量 解 (𝐴 − 𝜆𝐼)𝑥 = 0 的非零解 特征值和 ∑ 𝜆𝑖 = tr(𝐴) 特征值积...",
    "text": "Eigenvalues and Eigenvectors (特征值与特征向量) Eigenvalues and Eigenvectors 特征值与特征向量 线性代数 八、公式速查表 考研数学 · Linear Algebra · Eigenvalues and Eigenvectors (特征值与特征向量) 八、公式速查表 内容 公式或判定 特征定义 𝐴𝑥 = 𝜆𝑥, 𝑥 ≠ 0 特征方程 det(𝜆𝐼 − 𝐴) = 0 特征向量 解 (𝐴 − 𝜆𝐼)𝑥 = 0 的非零解 特征值和 ∑ 𝜆𝑖 = tr(𝐴) 特征值积 ∏ 𝜆𝑖 = det(𝐴) 相似 𝐵 = 𝑃 −1 𝐴𝑃 对角化 𝑃 −1 𝐴𝑃 = Λ 可对角化 有 𝑛 个线性无关特征向量 正交对角化 𝑄𝑇 𝐴𝑄 = Λ，其中 𝑄𝑇 𝑄 = 𝐼 最终抓手： 特征值题的路线固定：先解特征方程，再解齐次方程组。对角化不是看特征值个数，而是看能 否凑够 𝑛 个线性无关特征向量；实对称矩阵天然适合正交对角化。"
  },
  {
    ...
    "snippet": "考研数学 · Linear Algebra · Quadratic Forms (二次型) Quadratic Forms (二次型) 矩阵表示 · 合同变换 · 标准形 · 正定判定 考研数学复习资料 · Typst PDF 首页速览 • 核心公式：𝑓(𝑥) = 𝑥𝑇 𝐴𝑥，合同变换 𝐴 → 𝐶 𝑇 𝐴𝐶 ，标准形 𝜆1 𝑦12 + …...",
    "text": "Quadratic Forms (二次型) Quadratic Forms 二次型 线性代数 考研数学 · Linear Algebra · Quadratic Forms (二次型) 考研数学 · Linear Algebra · Quadratic Forms (二次型) Quadratic Forms (二次型) 矩阵表示 · 合同变换 · 标准形 · 正定判定 考研数学复习资料 · Typst PDF 首页速览 • 核心公式：𝑓(𝑥) = 𝑥𝑇 𝐴𝑥，合同变换 𝐴 → 𝐶 𝑇 𝐴𝐶 ，标准形 𝜆1 𝑦12 + … + 𝜆𝑛 𝑦𝑛 2 。 • 关键定理：惯性定理保证正负惯性指数不变；正定等价于全部特征值为正，也等价于顺序主子式全正。 • 方法抓手：化标准形可用配方法、初等合同变换或正交变换；判正定优先看 Sylvester 判据。 复习目标： 二次型是线性代数后半部分的综合章节，主要研究二次齐次多项式如何通过可逆线性变换化为 标准形，以及如何判断正定、负定和惯性指数。"
  },
  {
    ...
    "page": 2,
    "heading": "一、二次型与矩阵表示",
    "snippet": "考研数学 · Linear Algebra · Quadratic Forms (二次型) 一、二次型与矩阵表示 1. 定义 含 𝑛 个变量的二次齐次多项式称为二次型： 𝑛 𝑛 𝑓(𝑥1 , 𝑥2 , …, 𝑥𝑛 ) = ∑ ∑ 𝑎𝑖𝑗 𝑥𝑖 𝑥𝑗 𝑖=1 𝑗=1 通常可写成矩阵形式 𝑓 = 𝑥𝑇 𝐴𝑥 其中 𝐴 可取为实对称矩阵。 2....",
    "text": "Quadratic Forms (二次型) Quadratic Forms 二次型 线性代数 一、二次型与矩阵表示 考研数学 · Linear Algebra · Quadratic Forms (二次型) 一、二次型与矩阵表示 1. 定义 含 𝑛 个变量的二次齐次多项式称为二次型： 𝑛 𝑛 𝑓(𝑥1 , 𝑥2 , …, 𝑥𝑛 ) = ∑ ∑ 𝑎𝑖𝑗 𝑥𝑖 𝑥𝑗 𝑖=1 𝑗=1 通常可写成矩阵形式 𝑓 = 𝑥𝑇 𝐴𝑥 其中 𝐴 可取为实对称矩阵。 2. 交叉项系数 若二次型中含有交叉项 2𝑎𝑖𝑗 𝑥𝑖 𝑥𝑗 ，则矩阵中 𝐴𝑖𝑗 = 𝐴𝑗𝑖 = 𝑎𝑖𝑗 例如 𝑓 = 𝑎𝑥2 + 2𝑏𝑥𝑦 + 𝑐𝑦2 对应矩阵为 𝑎 𝑏 𝐴=( ) 𝑏 𝑐 易错点： 写二次型矩阵时，交叉项系数要平均分到对称位置。若题目写的是 6𝑥𝑦，矩阵中对应元素应为 3 和 3。"
  },
  {
    ...
    "page": 3,
    "heading": "二、合同变换与标准形",
    "snippet": "考研数学 · Linear Algebra · Quadratic Forms (二次型) 二、合同变换与标准形 1. 线性变换 令 𝑥 = 𝐶𝑦 则 𝑓 = 𝑥𝑇 𝐴𝑥 = (𝐶𝑦)𝑇 𝐴(𝐶𝑦) = 𝑦𝑇 (𝐶 𝑇 𝐴𝐶)𝑦 若 𝐶 可逆，则称 𝐴 与 𝐶 𝑇 𝐴𝐶 合同。 2. 标准形 通过可逆线性变换，可以把二次型化为只含平方项的...",
    "text": "Quadratic Forms (二次型) Quadratic Forms 二次型 线性代数 二、合同变换与标准形 考研数学 · Linear Algebra · Quadratic Forms (二次型) 二、合同变换与标准形 1. 线性变换 令 𝑥 = 𝐶𝑦 则 𝑓 = 𝑥𝑇 𝐴𝑥 = (𝐶𝑦)𝑇 𝐴(𝐶𝑦) = 𝑦𝑇 (𝐶 𝑇 𝐴𝐶)𝑦 若 𝐶 可逆，则称 𝐴 与 𝐶 𝑇 𝐴𝐶 合同。 2. 标准形 通过可逆线性变换，可以把二次型化为只含平方项的形式： 𝑓 = 𝑑1 𝑦12 + 𝑑2 𝑦22 + … + 𝑑𝑛 𝑦𝑛2 这称为标准形。 3. 规范形 在实数范围内，标准形还可化为 𝑓 = 𝑧12 + … + 𝑧𝑝2 − 𝑧𝑝+1 2 2 − … − 𝑧𝑝+𝑞 其中正平方项个数 𝑝、负平方项个数 𝑞 是不变量。"
  },
  {
    ...
    "page": 4,
    "heading": "三、惯性定理",
    "snippet": "考研数学 · Linear Algebra · Quadratic Forms (二次型) 三、惯性定理 1. 正负惯性指数 二次型标准形中正系数个数称为正惯性指数，负系数个数称为负惯性指数。二者之和等于二次型矩阵的秩。 2. 惯性定理 同一个实二次型经过不同可逆线性变换得到的标准形可能不同，但正惯性指数和负惯性指数不变。 因此，判断二次...",
    "text": "Quadratic Forms (二次型) Quadratic Forms 二次型 线性代数 三、惯性定理 考研数学 · Linear Algebra · Quadratic Forms (二次型) 三、惯性定理 1. 正负惯性指数 二次型标准形中正系数个数称为正惯性指数，负系数个数称为负惯性指数。二者之和等于二次型矩阵的秩。 2. 惯性定理 同一个实二次型经过不同可逆线性变换得到的标准形可能不同，但正惯性指数和负惯性指数不变。 因此，判断二次型类型时关注正负系数个数，而不是某一个具体标准形。"
  },
  {
    "id": "doc-ccaf3c879ab3-p5",
    "docId": "doc-ccaf3c879ab3",
    "title": "Quadratic Forms (二次型)",
    "category": "线性代数",
    "page": 5,
    "heading": "四、化标准形的方法",
    "snippet": "考研数学 · Linear Algebra · Quadratic Forms (二次型) 四、化标准形的方法 方法 适用场景 特点 配方法 低维或结构明显 直接、适合手算 初等变换法 一般二次型 对称行列同时变换，保持合同 正交变换法 实对称矩阵 利用特征值，变换矩阵正交 1. 配方法 把含某变量的项配成平方，再逐步消去交叉项。适合二元...",
    "text": "Quadratic Forms (二次型) Quadratic Forms 二次型 线性代数 四、化标准形的方法 考研数学 · Linear Algebra · Quadratic Forms (二次型) 四、化标准形的方法 方法 适用场景 特点 配方法 低维或结构明显 直接、适合手算 初等变换法 一般二次型 对称行列同时变换，保持合同 正交变换法 实对称矩阵 利用特征值，变换矩阵正交 1. 配方法 把含某变量的项配成平方，再逐步消去交叉项。适合二元或三元二次型。 2. 正交变换法 实对称矩阵 𝐴 可正交对角化： 𝑄𝑇 𝐴𝑄 = Λ 令 𝑥 = 𝑄𝑦，则 𝑓 = 𝑦𝑇 Λ𝑦 = 𝜆1 𝑦12 + 𝜆2 𝑦22 + … + 𝜆𝑛 𝑦𝑛2 其中 𝜆𝑖 是 𝐴 的特征值。"
  },
  {
    "id": "doc-ccaf3c879ab3-p6",
    "docId": "doc-ccaf3c879ab3",
    "title": "Quadratic Forms (二次型)",
    "category": "线性代数",
    "page": 6,
    "heading": "五、正定二次型",
    "snippet": "考研数学 · Linear Algebra · Quadratic Forms (二次型) 五、正定二次型 1. 定义 若对任意非零向量 𝑥，都有 𝑥𝑇 𝐴𝑥 > 0 则称二次型正定，矩阵 𝐴 正定。 若对任意非零向量 𝑥，都有 𝑥𝑇 𝐴𝑥 < 0，则称负定。 2. 正定判定 对实对称矩阵 𝐴，以下条件等价： 1. 𝐴 正定。 2. 𝐴 ...",
    "text": "Quadratic Forms (二次型) Quadratic Forms 二次型 线性代数 五、正定二次型 考研数学 · Linear Algebra · Quadratic Forms (二次型) 五、正定二次型 1. 定义 若对任意非零向量 𝑥，都有 𝑥𝑇 𝐴𝑥 > 0 则称二次型正定，矩阵 𝐴 正定。 若对任意非零向量 𝑥，都有 𝑥𝑇 𝐴𝑥 < 0，则称负定。 2. 正定判定 对实对称矩阵 𝐴，以下条件等价： 1. 𝐴 正定。 2. 𝐴 的全部特征值都大于零。 3. 𝐴 的所有顺序主子式都大于零。 4. 二次型的正惯性指数为 𝑛。 其中顺序主子式为 Δ1 , Δ2 , …, Δ𝑛 正定要求 Δ1 > 0, Δ2 > 0, …, Δ𝑛 > 0 3. 负定判定 对实对称矩阵 𝐴，负定等价于 −𝐴 正定。按顺序主子式可写为： (−1)𝑘 Δ𝑘 > 0 (𝑘 = 1, 2, …, 𝑛)"
  },
  {
    "id": "doc-ccaf3c879ab3-p7",
    "docId": "doc-ccaf3c879ab3",
    "title": "Quadratic Forms (二次型)",
    "category": "线性代数",
    "page": 7,
    "heading": "六、半正定与不定",
    "snippet": "考研数学 · Linear Algebra · Quadratic Forms (二次型) 六、半正定与不定 1. 半正定 若对任意 𝑥 都有 𝑥𝑇 𝐴𝑥 ≥ 0 则称半正定。实对称矩阵半正定等价于全部特征值非负。 2. 不定 若二次型既能取正值又能取负值，则称不定。等价地，实对称矩阵既有正特征值又有负特征值。 易错点： 顺序主子式判定只...",
    "text": "Quadratic Forms (二次型) Quadratic Forms 二次型 线性代数 六、半正定与不定 考研数学 · Linear Algebra · Quadratic Forms (二次型) 六、半正定与不定 1. 半正定 若对任意 𝑥 都有 𝑥𝑇 𝐴𝑥 ≥ 0 则称半正定。实对称矩阵半正定等价于全部特征值非负。 2. 不定 若二次型既能取正值又能取负值，则称不定。等价地，实对称矩阵既有正特征值又有负特征值。 易错点： 顺序主子式判定只直接用于正定和负定。半正定不能只看顺序主子式非负，通常要看全部特征值 或全部主子式。"
  },
  {
    "id": "doc-ccaf3c879ab3-p8",
    "docId": "doc-ccaf3c879ab3",
    "title": "Quadratic Forms (二次型)",
    "category": "线性代数",
    "page": 8,
    "heading": "七、典型题型",
    "snippet": "考研数学 · Linear Algebra · Quadratic Forms (二次型) 七、典型题型 1. 写二次型矩阵：注意交叉项系数除以 2。 2. 化标准形：低维用配方法，一般题用正交变换或合同变换。 3. 求正负惯性指数：看标准形系数符号或特征值符号。 4. 判断正定：用顺序主子式或特征值。 5. 含参数正定：列出顺序主子式不...",
    "text": "Quadratic Forms (二次型) Quadratic Forms 二次型 线性代数 七、典型题型 考研数学 · Linear Algebra · Quadratic Forms (二次型) 七、典型题型 1. 写二次型矩阵：注意交叉项系数除以 2。 2. 化标准形：低维用配方法，一般题用正交变换或合同变换。 3. 求正负惯性指数：看标准形系数符号或特征值符号。 4. 判断正定：用顺序主子式或特征值。 5. 含参数正定：列出顺序主子式不等式并求参数范围。 6. 与特征值结合：实对称矩阵的特征值就是正交标准形系数。"
  },
  {
    "id": "doc-ccaf3c879ab3-p9",
    "docId": "doc-ccaf3c879ab3",
    "title": "Quadratic Forms (二次型)",
    "category": "线性代数",
    "page": 9,
    "heading": "八、公式速查表",
    "snippet": "考研数学 · Linear Algebra · Quadratic Forms (二次型) 八、公式速查表 内容 公式或判定 矩阵表示 𝑓 = 𝑥𝑇 𝐴𝑥, 𝐴𝑇 = 𝐴 𝑇 合同变换 𝑥 = 𝐶𝑦, 𝑓 = 𝑦𝑇 (𝐶 𝐴𝐶) 𝑦 标准形 𝑓 = 𝑑1 𝑦12 + … + 𝑑𝑛 𝑦𝑛2 正交标准形 𝑄𝑇 𝐴𝑄 = Λ 秩 标准形中非零系...",
